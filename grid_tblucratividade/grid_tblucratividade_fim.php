...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____grid_tblucratividade"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____grid_tblucratividade"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tblucratividade']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tblucratividade']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tblucratividade']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tblucratividade']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tblucratividade']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tblucratividade</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tblucratividade']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tblucratividade']['embutida_filho'] as $ind => $sc_init)
          {
