<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_tbclientes_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tbclientes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["idCliente"]   = "idcliente";
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["idcliente"] : "Código";
   $tab_ger_campos['nomecliente'] = "on";
   $tab_def_campos['nomecliente'] = "nomeCliente";
   $tab_converte["nomeCliente"]   = "nomecliente";
   $tab_labels["nomecliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["nomecliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["nomecliente"] : "Nome";
   $tab_ger_campos['enderecocliente'] = "on";
   $tab_def_campos['enderecocliente'] = "enderecoCliente";
   $tab_converte["enderecoCliente"]   = "enderecocliente";
   $tab_labels["enderecocliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["enderecocliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["enderecocliente"] : "Endereço";
   $tab_ger_campos['cpfcliente'] = "on";
   $tab_def_campos['cpfcliente'] = "cpfCliente";
   $tab_converte["cpfCliente"]   = "cpfcliente";
   $tab_labels["cpfcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["cpfcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["cpfcliente"] : "CPF";
   $tab_ger_campos['validadecnhcliente'] = "on";
   $tab_def_campos['validadecnhcliente'] = "validadeCnhCliente";
   $tab_converte["validadeCnhCliente"]   = "validadecnhcliente";
   $tab_labels["validadecnhcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["validadecnhcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["validadecnhcliente"] : "Validade - CNH";
   $tab_ger_campos['idfkestadocliente'] = "on";
   $tab_def_campos['idfkestadocliente'] = "idFKestadoCliente";
   $tab_converte["idFKestadoCliente"]   = "idfkestadocliente";
   $tab_labels["idfkestadocliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["idfkestadocliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["idfkestadocliente"] : "UF";
   $tab_ger_campos['idfkcidadecliente'] = "on";
   $tab_def_campos['idfkcidadecliente'] = "idFKcidadeCliente";
   $tab_converte["idFKcidadeCliente"]   = "idfkcidadecliente";
   $tab_labels["idfkcidadecliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["idfkcidadecliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["idfkcidadecliente"] : "Cidade";
   $tab_ger_campos['fonecliente'] = "on";
   $tab_def_campos['fonecliente'] = "foneCliente";
   $tab_converte["foneCliente"]   = "fonecliente";
   $tab_labels["fonecliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["fonecliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["fonecliente"] : "Fone 1";
   $tab_ger_campos['fone2cliente'] = "on";
   $tab_def_campos['fone2cliente'] = "fone2Cliente";
   $tab_converte["fone2Cliente"]   = "fone2cliente";
   $tab_labels["fone2cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["fone2cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['labels']["fone2cliente"] : "Fone 2 ";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbclientes']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tbclientes_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tbclientes']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
