...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['scriptcase']['error_icon']['app_retrieve_pswd']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['sc_outra_jan'])
   {
