...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____grid_tbcontasPagar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____grid_tbcontasPagar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbcontasPagar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbcontasPagar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbcontasPagar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbcontasPagar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbcontasPagar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbcontasPagar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbcontasPagar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbcontasPagar']['embutida_filho'] as $ind => $sc_init)
          {
