...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "datacompraveiculo";$Nm_numeric[] = "idveiculo";$Nm_numeric[] = "idfkmarcaveiculo";$Nm_numeric[] = "anoveiculo";$Nm_numeric[] = "kmatualveiculo";$Nm_numeric[] = "valordiaria";$Nm_numeric[] = "proxtrocaoleoveiculo";$Nm_numeric[] = "proxtrocafiltroveiculo";$Nm_numeric[] = "avisotrocaoleoveiculo";$Nm_numeric[] = "avisotrocafiltroveiculo";$Nm_numeric[] = "statusveiculo";
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
    ...
    <TD nowrap class="scFilterLabelOdd css_modeloveiculo_fil_label" > <?php
 $SC_Label = (isset($this->New_label['modeloveiculo'])) ? $this->New_label['modeloveiculo'] : "Modelo";
 $nmgp_tab_label .= "modeloveiculo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_modeloveiculo"  <?php echo $str_hide_modeloveiculo?>><?php
      $modeloveiculo_look = substr($this->Db->qstr($modeloveiculo), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_modeloveiculo" name="modeloveiculo_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
    ...
    <TD nowrap class="scFilterLabelEven css_statusveiculo_fil_label" > <?php
 $SC_Label = (isset($this->New_label['statusveiculo'])) ? $this->New_label['statusveiculo'] : "Status";
 $nmgp_tab_label .= "statusveiculo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_statusveiculo"  <?php echo $str_hide_statusveiculo?>> 
<?php
