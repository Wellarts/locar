<?php
//--- 
class grid_tbmultasAvarias_det
{
   var $Ini;
   var $Erro;
   var $Db;
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['sub_dir'] = array(); 
   ...
   $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
       $nmgp_select = "SELECT idMultasAvarias, idFKlocacao, dataMultaAvarias, descricaoMultasAvarias, valorMultasAvarias, pagoMultasAvarias from " . $this->Ini->nm_tabela; 
   $parms_det = explode("*PDet*", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['chave_det']) ; 
   ...
   $nmgp_select .= " where  idMultasAvarias = $parms_det[0] and idFKlocacao = $parms_det[1]" ;  
   ...
   $this->idmultasavarias = $rs->fields[0] ;  
   $this->idmultasavarias = (string)$this->idmultasavarias;
   $this->idfklocacao = $rs->fields[1] ;  
   $this->idfklocacao = (string)$this->idfklocacao;
   $this->datamultaavarias = $rs->fields[2] ;  
   $this->descricaomultasavarias = $rs->fields[3] ;  
   $this->valormultasavarias = $rs->fields[4] ;  
   $this->valormultasavarias = str_replace(",", ".", $this->valormultasavarias);
   $this->valormultasavarias = (string)$this->valormultasavarias;
   $this->pagomultasavarias = $rs->fields[5] ;  
   $this->pagomultasavarias = (string)$this->pagomultasavarias;
   $this->Lookup->lookup_pagomultasavarias($this->pagomultasavarias); 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['cmp_acum']);
...
//--- 
   ...
   $nm_saida->saida("<HEAD>\r\n");
   $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_detl_titl'] . " - tbmultasAvarias</TITLE>\r\n");
   ...
   if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
   ...
   else
   {
       ...
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_tbmultasAvarias/grid_tbmultasAvarias_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"scGridHeaderFont\"><span>" . $this->Ini->Nm_lang['lang_othr_detl_titl'] . " - tbmultasAvarias</span></td>\r\n");
   ...
   $nm_saida->saida("  </TD>\r\n");
   $nm_saida->saida(" </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['pdf_det']) 
   { 
       $nm_saida->saida("   <tr><td class=\"scGridTabelaTd\">\r\n");
       ...
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_tbmultasAvarias/grid_tbmultasAvarias_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=1&orientacao=1&largura=1200&conf_larg=S&conf_fonte=10&language=pt_br&conf_socor=S&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
       if ($this->nmgp_botoes['det_print'] == "on")
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_tbmultasAvarias/grid_tbmultasAvarias_config_print.php?nm_opc=detalhe&nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
   ...
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          ...
          $conteudo = trim(NM_encode_input(sc_strip_script($this->idmultasavarias))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_idmultasavarias_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_idmultasavarias_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['idfklocacao'])) ? $this->New_label['idfklocacao'] : "Id F Klocacao"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->idfklocacao))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_idfklocacao_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_idfklocacao_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['datamultaavarias'])) ? $this->New_label['datamultaavarias'] : "Data"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->datamultaavarias))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_datamultaavarias_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_datamultaavarias_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['descricaomultasavarias'])) ? $this->New_label['descricaomultasavarias'] : "Descrição"; 
          $conteudo = trim(sc_strip_script($this->descricaomultasavarias)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_descricaomultasavarias_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_descricaomultasavarias_det_line\"   ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['valormultasavarias'])) ? $this->New_label['valormultasavarias'] : "Valor"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->valormultasavarias))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_valormultasavarias_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_valormultasavarias_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['pagomultasavarias'])) ? $this->New_label['pagomultasavarias'] : "Pago"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->pagomultasavarias))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_pagomultasavarias_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_pagomultasavarias_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("</TABLE>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['pdf_det']) 
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"grid_tbmultasAvarias_doc.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nm_cod_doc=\" + campo1 + \"&nm_nome_doc=\" + campo2 + \"&nm_cod_apl=\" + campo3, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   $nm_saida->saida("   function nm_gp_move(x, y, z, p, g) \r\n");
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_tbmultasAvarias/index.php?nmgp_opcao=pdf_det&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p +  \"&nmgp_graf_pdf=\" + g + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "\";\r\n");
   $nm_saida->saida("   }\r\n");
