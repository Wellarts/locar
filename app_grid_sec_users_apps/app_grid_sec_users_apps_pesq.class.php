...
class app_grid_sec_users_apps_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function app_grid_sec_users_apps_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . app_grid_sec_users_apps_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . app_grid_sec_users_apps_pack_protect_string($Tipo_filter[0]) . "\">.." . app_grid_sec_users_apps_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - sec_users_apps</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>app_grid_sec_users_apps/app_grid_sec_users_apps_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="app_grid_sec_users_apps_ajax_search.js"></script>
 <script type="text/javascript" src="app_grid_sec_users_apps_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_priv_access_cond#NMF#' + search_get_sel_txt('SC_priv_access_cond') + '@NMF@';
  str_out += 'SC_priv_access#NMF#' + search_get_text('SC_priv_access') + '@NMF@';
  str_out += 'SC_priv_insert_cond#NMF#' + search_get_sel_txt('SC_priv_insert_cond') + '@NMF@';
  str_out += 'SC_priv_insert#NMF#' + search_get_text('SC_priv_insert') + '@NMF@';
  str_out += 'SC_priv_delete_cond#NMF#' + search_get_sel_txt('SC_priv_delete_cond') + '@NMF@';
  str_out += 'SC_priv_delete#NMF#' + search_get_text('SC_priv_delete') + '@NMF@';
  str_out += 'SC_priv_update_cond#NMF#' + search_get_sel_txt('SC_priv_update_cond') + '@NMF@';
  str_out += 'SC_priv_update#NMF#' + search_get_text('SC_priv_update') + '@NMF@';
  str_out += 'SC_priv_export_cond#NMF#' + search_get_sel_txt('SC_priv_export_cond') + '@NMF@';
  str_out += 'SC_priv_export#NMF#' + search_get_text('SC_priv_export') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - sec_users_apps</span></td>
...
<?php
   ...
   {
      global 
             $priv_access_cond, $priv_access,
             $priv_insert_cond, $priv_insert,
             $priv_delete_cond, $priv_delete,
             $priv_update_cond, $priv_update,
             $priv_export_cond, $priv_export,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $priv_access = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_access']; 
          $priv_access_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_access_cond']; 
          $priv_insert = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_insert']; 
          $priv_insert_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_insert_cond']; 
          $priv_delete = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_delete']; 
          $priv_delete_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_delete_cond']; 
          $priv_update = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_update']; 
          $priv_update_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_update_cond']; 
          $priv_export = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_export']; 
          $priv_export_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_export_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['NM_operador']; 
      } 
      if (!isset($priv_access_cond) || empty($priv_access_cond))
      {
         $priv_access_cond = "eq";
      }
      if (!isset($priv_insert_cond) || empty($priv_insert_cond))
      {
         $priv_insert_cond = "eq";
      }
      if (!isset($priv_delete_cond) || empty($priv_delete_cond))
      {
         $priv_delete_cond = "eq";
      }
      if (!isset($priv_update_cond) || empty($priv_update_cond))
      {
         $priv_update_cond = "eq";
      }
      if (!isset($priv_export_cond) || empty($priv_export_cond))
      {
         $priv_export_cond = "eq";
      }
      ...
      $str_hide_priv_access = (in_array($priv_access_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_priv_insert = (in_array($priv_insert_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_priv_delete = (in_array($priv_delete_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_priv_update = (in_array($priv_update_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_priv_export = (in_array($priv_export_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($priv_access) || $priv_access == "")
      {
          $priv_access = "";
      }
      if (isset($priv_access) && !empty($priv_access))
      {
         $tmp_pos = strpos($priv_access, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $priv_access = substr($priv_access, 0, $tmp_pos);
         }
      }
      if (!isset($priv_insert) || $priv_insert == "")
      {
          $priv_insert = "";
      }
      if (isset($priv_insert) && !empty($priv_insert))
      {
         $tmp_pos = strpos($priv_insert, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $priv_insert = substr($priv_insert, 0, $tmp_pos);
         }
      }
      if (!isset($priv_delete) || $priv_delete == "")
      {
          $priv_delete = "";
      }
      if (isset($priv_delete) && !empty($priv_delete))
      {
         $tmp_pos = strpos($priv_delete, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $priv_delete = substr($priv_delete, 0, $tmp_pos);
         }
      }
      if (!isset($priv_update) || $priv_update == "")
      {
          $priv_update = "";
      }
      if (isset($priv_update) && !empty($priv_update))
      {
         $tmp_pos = strpos($priv_update, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $priv_update = substr($priv_update, 0, $tmp_pos);
         }
      }
      if (!isset($priv_export) || $priv_export == "")
      {
          $priv_export = "";
      }
      if (isset($priv_export) && !empty($priv_export))
      {
         $tmp_pos = strpos($priv_export, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $priv_export = substr($priv_export, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("app_grid_sec_users_apps_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['priv_access'])) ? $this->New_label['priv_access'] : "Priv Access "; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_priv_access_cond" name="priv_access_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_access'), this, 'priv_access')">
       <OPTION value="eq" <?php if ("eq" == $priv_access_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $priv_access_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $priv_access_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $priv_access_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_priv_access" <?php echo $str_hide_priv_access?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['priv_access'])) ? $this->New_label['priv_access'] : "Priv Access ";
 $nmgp_tab_label .= "priv_access?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_priv_access" name="priv_access" value="<?php echo NM_encode_input($priv_access) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['priv_insert'])) ? $this->New_label['priv_insert'] : "Priv Insert "; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_priv_insert_cond" name="priv_insert_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_insert'), this, 'priv_insert')">
       <OPTION value="eq" <?php if ("eq" == $priv_insert_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $priv_insert_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $priv_insert_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $priv_insert_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_priv_insert" <?php echo $str_hide_priv_insert?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['priv_insert'])) ? $this->New_label['priv_insert'] : "Priv Insert ";
 $nmgp_tab_label .= "priv_insert?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_priv_insert" name="priv_insert" value="<?php echo NM_encode_input($priv_insert) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['priv_delete'])) ? $this->New_label['priv_delete'] : "Priv Delete "; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_priv_delete_cond" name="priv_delete_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_delete'), this, 'priv_delete')">
       <OPTION value="eq" <?php if ("eq" == $priv_delete_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $priv_delete_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $priv_delete_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $priv_delete_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_priv_delete" <?php echo $str_hide_priv_delete?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['priv_delete'])) ? $this->New_label['priv_delete'] : "Priv Delete ";
 $nmgp_tab_label .= "priv_delete?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_priv_delete" name="priv_delete" value="<?php echo NM_encode_input($priv_delete) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['priv_update'])) ? $this->New_label['priv_update'] : "Priv Update "; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_priv_update_cond" name="priv_update_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_update'), this, 'priv_update')">
       <OPTION value="eq" <?php if ("eq" == $priv_update_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $priv_update_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $priv_update_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $priv_update_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_priv_update" <?php echo $str_hide_priv_update?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['priv_update'])) ? $this->New_label['priv_update'] : "Priv Update ";
 $nmgp_tab_label .= "priv_update?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_priv_update" name="priv_update" value="<?php echo NM_encode_input($priv_update) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['priv_export'])) ? $this->New_label['priv_export'] : "Priv Export "; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_priv_export_cond" name="priv_export_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_export'), this, 'priv_export')">
       <OPTION value="eq" <?php if ("eq" == $priv_export_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $priv_export_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $priv_export_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $priv_export_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_priv_export" <?php echo $str_hide_priv_export?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['priv_export'])) ? $this->New_label['priv_export'] : "Priv Export ";
 $nmgp_tab_label .= "priv_export?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_priv_export" name="priv_export" value="<?php echo NM_encode_input($priv_export) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_grid_sec_users_apps']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_grid_sec_users_apps']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_priv_access'), document.F1.priv_access_cond, 'priv_access');
   document.F1.priv_access.value = "";
   nm_campos_between(document.getElementById('id_vis_priv_insert'), document.F1.priv_insert_cond, 'priv_insert');
   document.F1.priv_insert.value = "";
   nm_campos_between(document.getElementById('id_vis_priv_delete'), document.F1.priv_delete_cond, 'priv_delete');
   document.F1.priv_delete.value = "";
   nm_campos_between(document.getElementById('id_vis_priv_update'), document.F1.priv_update_cond, 'priv_update');
   document.F1.priv_update.value = "";
   nm_campos_between(document.getElementById('id_vis_priv_export'), document.F1.priv_export_cond, 'priv_export');
   document.F1.priv_export.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "LocarVeiculos/app_grid_sec_users_apps";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "app_grid_sec_users_apps/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_priv_access_cond'] = 'cond';
      $tp_fields['SC_priv_access'] = 'text';
      $tp_fields['SC_priv_insert_cond'] = 'cond';
      $tp_fields['SC_priv_insert'] = 'text';
      $tp_fields['SC_priv_delete_cond'] = 'cond';
      $tp_fields['SC_priv_delete'] = 'text';
      $tp_fields['SC_priv_update_cond'] = 'cond';
      $tp_fields['SC_priv_update'] = 'text';
      $tp_fields['SC_priv_export_cond'] = 'cond';
      $tp_fields['SC_priv_export'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $priv_access_cond, $priv_access,
             $priv_insert_cond, $priv_insert,
             $priv_delete_cond, $priv_delete,
             $priv_update_cond, $priv_update,
             $priv_export_cond, $priv_export, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $priv_access_cond_salva = $priv_access_cond; 
      if (!isset($priv_access_input_2) || $priv_access_input_2 == "")
      {
          $priv_access_input_2 = $priv_access;
      }
      $priv_insert_cond_salva = $priv_insert_cond; 
      if (!isset($priv_insert_input_2) || $priv_insert_input_2 == "")
      {
          $priv_insert_input_2 = $priv_insert;
      }
      $priv_delete_cond_salva = $priv_delete_cond; 
      if (!isset($priv_delete_input_2) || $priv_delete_input_2 == "")
      {
          $priv_delete_input_2 = $priv_delete;
      }
      $priv_update_cond_salva = $priv_update_cond; 
      if (!isset($priv_update_input_2) || $priv_update_input_2 == "")
      {
          $priv_update_input_2 = $priv_update;
      }
      $priv_export_cond_salva = $priv_export_cond; 
      if (!isset($priv_export_input_2) || $priv_export_input_2 == "")
      {
          $priv_export_input_2 = $priv_export;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_access'] = $priv_access; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_access_cond'] = $priv_access_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_insert'] = $priv_insert; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_insert_cond'] = $priv_insert_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_delete'] = $priv_delete; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_delete_cond'] = $priv_delete_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_update'] = $priv_update; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_update_cond'] = $priv_update_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_export'] = $priv_export; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['priv_export_cond'] = $priv_export_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $priv_access;
      $this->cmp_formatado['priv_access'] = $Conteudo;
      $Conteudo = $priv_insert;
      $this->cmp_formatado['priv_insert'] = $Conteudo;
      $Conteudo = $priv_delete;
      $this->cmp_formatado['priv_delete'] = $Conteudo;
      $Conteudo = $priv_update;
      $this->cmp_formatado['priv_update'] = $Conteudo;
      $Conteudo = $priv_export;
      $this->cmp_formatado['priv_export'] = $Conteudo;

      //----- $priv_access
      $this->Date_part = false;
      if (isset($priv_access) || $priv_access_cond == "nu" || $priv_access_cond == "nn" || $priv_access_cond == "ep" || $priv_access_cond == "ne")
      {
         $this->monta_condicao("priv_access", $priv_access_cond, $priv_access, "", "priv_access");
      }

      //----- $priv_insert
      $this->Date_part = false;
      if (isset($priv_insert) || $priv_insert_cond == "nu" || $priv_insert_cond == "nn" || $priv_insert_cond == "ep" || $priv_insert_cond == "ne")
      {
         $this->monta_condicao("priv_insert", $priv_insert_cond, $priv_insert, "", "priv_insert");
      }

      //----- $priv_delete
      $this->Date_part = false;
      if (isset($priv_delete) || $priv_delete_cond == "nu" || $priv_delete_cond == "nn" || $priv_delete_cond == "ep" || $priv_delete_cond == "ne")
      {
         $this->monta_condicao("priv_delete", $priv_delete_cond, $priv_delete, "", "priv_delete");
      }

      //----- $priv_update
      $this->Date_part = false;
      if (isset($priv_update) || $priv_update_cond == "nu" || $priv_update_cond == "nn" || $priv_update_cond == "ep" || $priv_update_cond == "ne")
      {
         $this->monta_condicao("priv_update", $priv_update_cond, $priv_update, "", "priv_update");
      }

      //----- $priv_export
      $this->Date_part = false;
      if (isset($priv_export) || $priv_export_cond == "nu" || $priv_export_cond == "nn" || $priv_export_cond == "ep" || $priv_export_cond == "ne")
      {
         $this->monta_condicao("priv_export", $priv_export_cond, $priv_export, "", "priv_export");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['where_pesq_ant'] = $this->comando . $this->comando_fim;
