...
class grid_tbmultasAvarias_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_tbmultasAvarias_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_tbmultasAvarias.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_tbmultasAvarias";
   ...
   function NM_export_datamultaavarias()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->datamultaavarias))
         {
             $this->datamultaavarias = sc_convert_encoding($this->datamultaavarias, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " datamultaavarias =\"" . $this->trata_dados($this->datamultaavarias) . "\"";
   }
   //----- descricaomultasavarias
   function NM_export_descricaomultasavarias()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->descricaomultasavarias))
         {
             $this->descricaomultasavarias = sc_convert_encoding($this->descricaomultasavarias, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " descricaomultasavarias =\"" . $this->trata_dados($this->descricaomultasavarias) . "\"";
   }
   //----- valormultasavarias
   function NM_export_valormultasavarias()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->valormultasavarias))
         {
             $this->valormultasavarias = sc_convert_encoding($this->valormultasavarias, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " valormultasavarias =\"" . $this->trata_dados($this->valormultasavarias) . "\"";
   }
   //----- pagomultasavarias
   function NM_export_pagomultasavarias()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_pagomultasavarias))
         {
             $this->look_pagomultasavarias = sc_convert_encoding($this->look_pagomultasavarias, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " pagomultasavarias =\"" . $this->trata_dados($this->look_pagomultasavarias) . "\"";
   }
   //----- idmultasavarias
   function NM_export_idmultasavarias()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->idmultasavarias))
         {
             $this->idmultasavarias = sc_convert_encoding($this->idmultasavarias, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " idmultasavarias =\"" . $this->trata_dados($this->idmultasavarias) . "\"";
   }
   //----- idfklocacao
   function NM_export_idfklocacao()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->idfklocacao))
         {
             $this->idfklocacao = sc_convert_encoding($this->idfklocacao, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " idfklocacao =\"" . $this->trata_dados($this->idfklocacao) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbmultasAvarias']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - tbmultasAvarias :: XML</TITLE>
