...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____grid_tbveiculos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____grid_tbveiculos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbveiculos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbveiculos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbveiculos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbveiculos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbveiculos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbveiculos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbveiculos']['embutida_filho'] as $ind => $sc_init)
          {
