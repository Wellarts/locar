<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_tbveiculos_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tbveiculos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['idveiculo'] = "on";
   $tab_def_campos['idveiculo'] = "idVeiculo";
   $tab_converte["idVeiculo"]   = "idveiculo";
   $tab_labels["idveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["idveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["idveiculo"] : "Código";
   $tab_ger_campos['idfkmarcaveiculo'] = "on";
   $tab_def_campos['idfkmarcaveiculo'] = "idFKmarcaVeiculo";
   $tab_converte["idFKmarcaVeiculo"]   = "idfkmarcaveiculo";
   $tab_labels["idfkmarcaveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["idfkmarcaveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["idfkmarcaveiculo"] : "Marca";
   $tab_ger_campos['modeloveiculo'] = "on";
   $tab_def_campos['modeloveiculo'] = "modeloVeiculo";
   $tab_converte["modeloVeiculo"]   = "modeloveiculo";
   $tab_labels["modeloveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["modeloveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["modeloveiculo"] : "Modelo";
   $tab_ger_campos['anoveiculo'] = "on";
   $tab_def_campos['anoveiculo'] = "anoVeiculo";
   $tab_converte["anoVeiculo"]   = "anoveiculo";
   $tab_labels["anoveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["anoveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["anoveiculo"] : "Ano";
   $tab_ger_campos['placaveiculo'] = "on";
   $tab_def_campos['placaveiculo'] = "placaVeiculo";
   $tab_converte["placaVeiculo"]   = "placaveiculo";
   $tab_labels["placaveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["placaveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["placaveiculo"] : "Placa";
   $tab_ger_campos['corveiculo'] = "on";
   $tab_def_campos['corveiculo'] = "corVeiculo";
   $tab_converte["corVeiculo"]   = "corveiculo";
   $tab_labels["corveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["corveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["corveiculo"] : "Cor";
   $tab_ger_campos['kmatualveiculo'] = "on";
   $tab_def_campos['kmatualveiculo'] = "kmAtualVeiculo";
   $tab_converte["kmAtualVeiculo"]   = "kmatualveiculo";
   $tab_labels["kmatualveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["kmatualveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["kmatualveiculo"] : "Km Atual";
   $tab_ger_campos['statusveiculo'] = "on";
   $tab_def_campos['statusveiculo'] = "statusVeiculo";
   $tab_converte["statusVeiculo"]   = "statusveiculo";
   $tab_labels["statusveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["statusveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['labels']["statusveiculo"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tbveiculos_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tbveiculos']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
