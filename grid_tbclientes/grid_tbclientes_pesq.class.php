 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd css_nomecliente_fil_label"><?php echo (isset($this->New_label['nomecliente'])) ? $this->New_label['nomecliente'] : "Nome"; ?></TD>
      
      <INPUT type="hidden" id="SC_nomecliente_cond" name="nomecliente_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nomecliente" <?php echo $str_hide_nomecliente?> valign="top">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nomecliente" name="nomecliente_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven css_cpfcliente_fil_label"><?php echo (isset($this->New_label['cpfcliente'])) ? $this->New_label['cpfcliente'] : "CPF"; ?></TD>
      
      <INPUT type="hidden" id="SC_cpfcliente_cond" name="cpfcliente_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cpfcliente" <?php echo $str_hide_cpfcliente?> valign="top">
