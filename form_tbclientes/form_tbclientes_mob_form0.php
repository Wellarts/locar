...
<?php
include_once("form_tbclientes_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbclientes_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['recarga'];
}
?>
...
<?php
 include_once("form_tbclientes_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" enctype="multipart/form-data" 
               action="form_tbclientes_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbclientes_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbclientes_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_idcliente_line" id="hidden_field_data_idcliente" style="<?php echo $sStyleHidden_idcliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idcliente_label"><span id="id_label_idcliente"><?php echo $this->nm_new_label['idcliente']; ?></span></span><br><span id="id_read_on_idcliente" class="css_idcliente_line" style="<?php echo $sStyleReadLab_idcliente; ?>"><?php echo $this->form_encode_input($this->idcliente); ?></span><span id="id_read_off_idcliente" style="<?php echo $sStyleReadInp_idcliente; ?>"><input type="hidden" name="idcliente" value="<?php echo $this->form_encode_input($idcliente) . "\">"?><span id="id_ajax_label_idcliente"><?php echo nl2br($idcliente); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nomecliente_line" id="hidden_field_data_nomecliente" style="<?php echo $sStyleHidden_nomecliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nomecliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nomecliente_label"><span id="id_label_nomecliente"><?php echo $this->nm_new_label['nomecliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_enderecocliente_line" id="hidden_field_data_enderecocliente" style="<?php echo $sStyleHidden_enderecocliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_enderecocliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_enderecocliente_label"><span id="id_label_enderecocliente"><?php echo $this->nm_new_label['enderecocliente']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idfkestadocliente_line" id="hidden_field_data_idfkestadocliente" style="<?php echo $sStyleHidden_idfkestadocliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idfkestadocliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idfkestadocliente_label"><span id="id_label_idfkestadocliente"><?php echo $this->nm_new_label['idfkestadocliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idfkcidadecliente_line" id="hidden_field_data_idfkcidadecliente" style="<?php echo $sStyleHidden_idfkcidadecliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idfkcidadecliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idfkcidadecliente_label"><span id="id_label_idfkcidadecliente"><?php echo $this->nm_new_label['idfkcidadecliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fonecliente_line" id="hidden_field_data_fonecliente" style="<?php echo $sStyleHidden_fonecliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fonecliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fonecliente_label"><span id="id_label_fonecliente"><?php echo $this->nm_new_label['fonecliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fone2cliente_line" id="hidden_field_data_fone2cliente" style="<?php echo $sStyleHidden_fone2cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fone2cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fone2cliente_label"><span id="id_label_fone2cliente"><?php echo $this->nm_new_label['fone2cliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_datanasc_line" id="hidden_field_data_datanasc" style="<?php echo $sStyleHidden_datanasc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datanasc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_datanasc_label"><span id="id_label_datanasc"><?php echo $this->nm_new_label['datanasc']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_redesocial_line" id="hidden_field_data_redesocial" style="<?php echo $sStyleHidden_redesocial; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_redesocial_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_redesocial_label"><span id="id_label_redesocial"><?php echo $this->nm_new_label['redesocial']; ?></span></span><br>
...
<?php $sStyleHidden_redesocial_dumb = ('' == $sStyleHidden_redesocial) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_redesocial_dumb" style="<?php echo $sStyleHidden_redesocial_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_numcnhcliente_line" id="hidden_field_data_numcnhcliente" style="<?php echo $sStyleHidden_numcnhcliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numcnhcliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_numcnhcliente_label"><span id="id_label_numcnhcliente"><?php echo $this->nm_new_label['numcnhcliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_validadecnhcliente_line" id="hidden_field_data_validadecnhcliente" style="<?php echo $sStyleHidden_validadecnhcliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_validadecnhcliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_validadecnhcliente_label"><span id="id_label_validadecnhcliente"><?php echo $this->nm_new_label['validadecnhcliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cpfcliente_line" id="hidden_field_data_cpfcliente" style="<?php echo $sStyleHidden_cpfcliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cpfcliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cpfcliente_label"><span id="id_label_cpfcliente"><?php echo $this->nm_new_label['cpfcliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rgcliente_line" id="hidden_field_data_rgcliente" style="<?php echo $sStyleHidden_rgcliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rgcliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rgcliente_label"><span id="id_label_rgcliente"><?php echo $this->nm_new_label['rgcliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_expedrg_line" id="hidden_field_data_expedrg" style="<?php echo $sStyleHidden_expedrg; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_expedrg_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_expedrg_label"><span id="id_label_expedrg"><?php echo $this->nm_new_label['expedrg']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['Lookup_expedrg'][] = 'SDS'; ?>
 <option value="SSP" <?php  if ($this->expedrg == "SSP") { echo " selected" ;} ?>>SSP</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['Lookup_expedrg'][] = 'SSP'; ?>
 <option value="OUTROS" <?php  if ($this->expedrg == "OUTROS") { echo " selected" ;} ?>>OUTROS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['Lookup_expedrg'][] = 'OUTROS'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idfkufexpedrg_line" id="hidden_field_data_idfkufexpedrg" style="<?php echo $sStyleHidden_idfkufexpedrg; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idfkufexpedrg_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idfkufexpedrg_label"><span id="id_label_idfkufexpedrg"><?php echo $this->nm_new_label['idfkufexpedrg']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_imgcnh_line" id="hidden_field_data_imgcnh" style="<?php echo $sStyleHidden_imgcnh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_imgcnh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_imgcnh_label"><span id="id_label_imgcnh"><?php echo $this->nm_new_label['imgcnh']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclientes_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbclientes_mob");
 parent.scAjaxDetailHeight("form_tbclientes_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
