...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____grid_tbclientes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____grid_tbclientes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbclientes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbclientes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbclientes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbclientes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbclientes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbclientes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbclientes']['embutida_filho'] as $ind => $sc_init)
          {
