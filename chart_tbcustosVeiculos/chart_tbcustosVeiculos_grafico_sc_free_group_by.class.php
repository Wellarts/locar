...
class chart_tbcustosVeiculos_grafico
{
   var $Db;
   var $Ini;
   var $Erro;
   ...
   //---- 
   function chart_tbcustosVeiculos_grafico()
   {
   ...
   function monta_grafico($chart_key = '', $operation = 'chart', $graf_col = false)
   {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf'];
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_opc_atual'] == 1)
       {
           $this->sc_graf_sint = true;
       }
       ...
       {
           $b_export = true;
           $chart_key = key($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts']);
       }
       elseif ('' == $chart_key)
       {
       ...
       if ($graf_field)
       {
           ...
           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field]['graf_pyram_forma'],
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos'][$field];
           $this->grafico_flash($arr_param, $this->grafico_dados($chart_data, $arr_param['export']), $mode);
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$chart_key]))
       {
           $chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$chart_key];

           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_pyram_forma'],
               'tit_datay'   => $chart_data['label_y'],
               'tit_label'   => $chart_data['label_x'],
               'tit_chart'   => $chart_data['title'],
           ...
           elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_full'])
           {
               $mode = 'full';
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_full']);
           }
           elseif (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_bot'])
           {
               $mode = 'full';
           }
           elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_first'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_first'] = false;
               $mode = array('js', 'chart');
           }
           else
           {
           ...
           elseif ((!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']) && (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_bot']))
           {
               exit;
           }
       }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- 
      $this->array_decimais = array();
      $this->NM_tit_val[1]     = "Valor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")";
      $this->NM_ind_val[1]     = 1;
      ...
      //---- 
      $this->array_total_datacustoveiculo = array();
      $this->array_total_idfkveiculocustoveiculo = array();
      $this->array_total_valorcustoveiculo = array();
      //---- 
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['datacustoveiculo'] = "Data";
      $prep_label['idfkveiculocustoveiculo'] = "Veículo";
      $prep_label['valorcustoveiculo'] = "Valor";
      $x = 0;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
   ...
   function monta_arrays()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_total']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_total'] as $label => $valor)
          {
          ...
          if (!$this->sc_graf_sint)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_linhas'] as $cada_elemento)
              {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_linhas']))
      {
          if ($this->campo > 0)
          {
              $lab_quebra    = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_linhas'][$this->campo][0], 1);
              $lab_quebra    = str_replace("&nbsp;", "", $lab_quebra);
              $this->titulo .= " - " . $this->label[$this->nivel] . " = " . $lab_quebra;
          }
          if ($this->campo > 0)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_linhas'][$this->campo] as $ind => $valor)
              {
                  if ($ind > 0)
                  {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['del_graph_col']))
      {
          ...
          {
              $tst_ind = $ind + 1;
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['del_graph_col'][$tst_ind]))
              {
   ...
   function storeCombinationTable($arr_series)
   {
       foreach ($arr_series as $serie_data)
       {
           if ($serie_data['comb'])
           {
               $this->storeCombinationTableSerie($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_table_data'], $serie_data, $serie_data['param']);
           }
       }
   }
   ...
   function storeCombinationTableSerieData(&$comb_data, $serie_data)
   {
       foreach ($serie_data['db_values'] as $index => $dbval)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_table_def']['label'][ $serie_data['summ_idx'] ] = $serie_data['name'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_table_def']['summ'][ $serie_data['summ_idx'] ]  = $serie_data['summ_idx'];
       }
   }
   ...
   function grafico_flash($arr_param, $arr_charts, $html_par = 'full')
   {
      global $nm_saida, $nm_retorno_graf;
         ...
         $this->orderCharts($arr_charts, $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_rule'], $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_field']);

       $arr_ret = array();

       foreach ($arr_charts as $idx_serie => $dat_serie)
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_order'] as $idx_order)
           {
               foreach ($dat_serie as $idx_chart => $dat_chart)
               {
                   if ($idx_order == $dat_chart['summ_idx'] + 1)
                   {
                       $dat_summ = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][$idx_order];
                       if ($dat_summ['display'])
                       {
...
<?php
   ...
   {
       $sChartTheme = 'scriptcase__NM__sc_Cromo.php';
       if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       {
   ...
   function grafico_flash_xml($arr_param, $arr_series, $newline = "\r\n")
   {
       ...
       if ($is_combinat)
       {
           if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type'], array('angulargauge', 'msstepline', 'stackedarea', 'stackedbar2d', 'stackedbar3d', 'stackedcolumn2d', 'stackedcolumn3d')))
           {
               $bDisableLinks = true;
           }
       ...
       if ('angulargauge' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type'])
       {
           $tipo = 'Gauge';
           $is_combinat = false;
       ...
       elseif ('funnel' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type'])
       {
           $tipo = 'Funnel';
           $is_combinat = false;
           if (sizeof($arr_series) > 1)
       ...
       elseif ('pyramid' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type'])
       {
           $tipo = 'Pyramid';
           $is_combinat = false;
           if (sizeof($arr_series) > 1)
       ...
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type'], array('pie2d', 'pie3d', 'doughnut2d', 'doughnut3d')))
       {
           $tipo = 'Pie';
           $is_combinat = false;
           if (sizeof($arr_series) > 1)
       ...
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type'], array('bar2d', 'bar3d', 'msbar2d', 'msbar3d', 'column2d', 'column3d', 'mscolumn2d', 'mscolumn3d')))
       {
           $tipo = 'Bar';
           $is_combinat = false;
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_display_values'][ ($arr_series[0]['summ_idx'] + 1) ]))
           {
               $sShowValues = " showvalues=\"" . (1 == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_display_values'][ ($arr_series[0]['summ_idx'] + 1) ] ? '1' : '0') . "\"";
           }
           else
           {
       ...
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type'], array('msarea', 'area2d', 'mssplinearea', 'splinearea')))
       {
           $tipo = 'Area';
           $is_combinat = false;
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_display_values'][ ($arr_series[0]['summ_idx'] + 1) ]))
       ...
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type'], array('msline', 'line', 'msspline', 'spline', 'msstepline')))
       {
           $tipo = 'Line';
           $is_combinat = false;
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_display_values'][ ($arr_series[0]['summ_idx'] + 1) ]))
       ...
       if ($chart_theme)
       {
           ...
           if ($chart_theme['css_chart_font_size'] && '' != $chart_theme['css_chart_font_size'] && empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_font']))
           {
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_font']))
       {
           $chart_attr[] = "baseFontSize=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_font'] . "\"";
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['chartpallet']) && false == $chart_theme)
       {
           $chart_attr[] = "palette=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['chartpallet'] . "\"";
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_subtitle_val']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_subtitle_val'] == 'right')
       {
           $chart_attr[] = "legendPosition=\"RIGHT\"";
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_subtitle_val']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_subtitle_val'] == 'right')
       {
           $chart_attr[] = "legendPosition=\"RIGHT\"";
       }
       ...
       {
           $s_xml .= " paletteColors=\"" . $this->getColorList($arr_series, $_SESSION["sc_session"][$this->Ini->sc_page]["chart_tbcustosVeiculos"]["parms_graf"]["paletteColors"]) . "\"";
       }
       ...
       elseif (1 < sizeof($arr_series) || 'Radar' == $tipo || 'Step' == $arr_param['linha_forma'] || $is_combinat)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_chart_data'] = array('label' => array(), 'series' => array());
           foreach ($label as $iIndex => $sLabel)
           {
               $s_xml .= "  <category Label=\"" . $this->formatFusionLabel($sLabel) . "\" />" . $newline;
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_chart_data']['label'][] = $this->formatFusionLabel($sLabel);
           }
           $s_xml .= " </categories>" . $newline;
           foreach ($arr_series as $arr_serie)
           {
               ...
               $showvalues  = '';
               $parentyaxis = '';
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_display_values'][ ($arr_serie['summ_idx'] + 1) ]))
               {
                   $showvalues = " showvalues=\"" . ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_display_values'][ ($arr_serie['summ_idx'] + 1) ] ? '1' : '0') . "\"";
               }
               if ($is_combinat)
               {
                   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_field_display_type'][ ($arr_serie['summ_idx'] + 1) ]))
                   {
                       $readeras = " renderas=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_field_display_type'][ ($arr_serie['summ_idx'] + 1) ] . "\"";
                   }
               ...
               foreach ($label as $iIndex => $sLabel)
               {
                   ...
                   {
                       $s_xml .= " link=\"" . $link_call . str_replace('__SC_PLACEHOLDER__', $dbval[$iIndex], $link) . "\"";
                   }
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_chart_data']['series'][] = $a_comb_serie_data;
           }
       }
       else
       {
...
<?php
   ...
   function grafico_combination()
   {
        ...
        $aGroupbyFields['available']['datacustoveiculo'] = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['labels']['datacustoveiculo'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['labels']['datacustoveiculo'] : "Data";
        $aGroupbyFields['available']['idfkveiculocustoveiculo'] = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['labels']['idfkveiculocustoveiculo'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['labels']['idfkveiculocustoveiculo'] : "Veículo";
        $aGroupbyFields['available']['valorcustoveiculo'] = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['labels']['valorcustoveiculo'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['labels']['valorcustoveiculo'] : "Valor";
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_cmp'] as $idx_groupby_field => $lab_groupby_field)
        {
        ...
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_control'] as $l_field => $d_field)
        {
        ...
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_order'] as $i_sum)
        {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
...
<script type="text/javascript">
 ...
 var sc_groupby_info, sc_summ_info, sc_chart_type = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type'] ?>", fc_chart_type = "<?php echo $this->getChartType($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['bmulti'], $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['bcomb']) ?>";
...
?>
 ...
 function scSaveChartChanges() {
  ...
  $.ajax({
   type: "POST",
   url: "chart_tbcustosVeiculos_sel_groupby.php",
   data: {
 ...
 function scChangeChartType(chartType) {
  ...
  if (chartType == 'line' || chartType == 'spline' || chartType == 'step') {
      tp_graf_atual = 'line';
      $('#chart_line_top').css('display', 'none');
      $('#chart_line_on_top').css('display', 'inline-block');
  } else {
      $('#chart_line_top').css('display', 'inline-block');
      $('#chart_line_on_top').css('display', 'none');
  }
  if (chartType == 'area' || chartType == 'areaspline') {
      tp_graf_atual = 'area';
      $('#chart_area_top').css('display', 'none');
      $('#chart_area_on_top').css('display', 'inline-block');
  } else {
      $('#chart_area_top').css('display', 'inline-block');
      $('#chart_area_on_top').css('display', 'none');
  }
  ...
  if (chartType == 'combination2d' || chartType == 'combination3d') {
      tp_graf_atual = 'combo';
      $('#chart_combo_top').css('display', 'none');
      $('#chart_combo_on_top').css('display', 'inline-block');
  } else {
      $('#chart_combo_top').css('display', 'inline-block');
      $('#chart_combo_on_top').css('display', 'none');
  }
  if (chartType == 'stackedbar2d' || chartType == 'stackedbar3d' || chartType == 'stackedcolumn2d' || chartType == 'stackedcolumn3d' || chartType == 'stackedarea') {
      tp_graf_atual = 'stack';
      $('#chart_stack_top').css('display', 'none');
      $('#chart_stack_on_top').css('display', 'inline-block');
  } else {
      $('#chart_stack_top').css('display', 'inline-block');
      $('#chart_stack_on_top').css('display', 'none');
  }
...
<?php
       ...
       {
           $s_test_value = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_field_display_type'][ $a_summ_fld['index'] ]) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_field_display_type'][ $a_summ_fld['index'] ] : '';
?>
   <div id="sc-id-sumcfg-box-<?php echo $a_summ_fld['index']; ?>" class="sc-ui-sumcfg">
    ...
    <br />
    <input type="radio" name="sc-name-sumcfg-val-<?php echo $a_summ_fld['index']; ?>" id="sc-id-sumcfg-val-y-<?php echo $a_summ_fld['index']; ?>" value="Y"<?php if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_display_values'][ $a_summ_fld['index'] ]) { echo ' checked'; } ?> /> <label for="sc-id-sumcfg-val-y-<?php echo $a_summ_fld['index']; ?>"><?php echo $this->Ini->Nm_lang['lang_chart_display_value_yes'] ?></label>
    &nbsp;
    <input type="radio" name="sc-name-sumcfg-val-<?php echo $a_summ_fld['index']; ?>" id="sc-id-sumcfg-val-n-<?php echo $a_summ_fld['index']; ?>" value="N"<?php if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_display_values'][ $a_summ_fld['index'] ]) { echo ' checked'; } ?> /> <label for="sc-id-sumcfg-val-n-<?php echo $a_summ_fld['index']; ?>"><?php echo $this->Ini->Nm_lang['lang_chart_display_value_no'] ?></label>
    <br />
    <br />
...
<?php
       foreach ($aSumAll as $i_summ_fld => $a_summ_fld)
       {
           ...
           if ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_rule'] && $a_summ_fld['index'] - 2 === $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_field'])
           {
               $sImgAsc = 'scSortOptionChecked';
           }
           elseif ('desc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_rule'] && $a_summ_fld['index'] - 2 === $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_field'])
           {
...
<?php
       ...
       $sImgAsc  = 'scSortOptionNotChecked';
       $sImgDesc = 'scSortOptionNotChecked';
       if ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_rule'] && 'label' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_field'])
       {
           $sImgAsc = 'scSortOptionChecked';
       }
       elseif ('desc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_rule'] && 'label' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_field'])
       {
           $sImgDesc = 'scSortOptionChecked';
       }
?>
 ...
 <div id="sc-id-chart-selection">
  ...
  <div id="sc-id-chart-options-other" class="sc-ui-chart-options" style="display: none">
   <span id="sc-id-chart-pyramid" class="sc-ui-chart-option-type"><img src="<?php echo $this->Ini->path_img_global ?>/scriptcase__NM__ct_other_pyram.png"></span>
   <span id="sc-id-chart-funnel" class="sc-ui-chart-option-type"><img src="<?php echo $this->Ini->path_img_global ?>/scriptcase__NM__ct_other_funnel.png"></span>
...
<?php
   ...
   function grafico_flash_config_js()
   {
      ...
      $sUrlConfigSave = $this->Ini->path_link . "chart_tbcustosVeiculos/chart_tbcustosVeiculos_config_graf_flash.php?nome_apl=chart_tbcustosVeiculos&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br";
      ...
      $nm_saida->saida("          nome_apl: \"chart_tbcustosVeiculos\",\r\n");
   ...
   function grafico_flash_config_div()
   {
      ...
      $aChartDisp        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_disp'])      && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_disp']))    ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_disp']      : array('Bar');
      $sChartType        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_tipo'])      && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_tipo'])      ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_tipo']      : 'Bar';
      $iSinteticAnalitic = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_opc_atual']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_opc_atual']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_opc_atual'] : '1';
      $iChartWidth       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_larg'])      && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_larg'])      ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_larg']      : '800';
      $iChartHeight      = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_alt'])       && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_alt'])       ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cfg_graf']['graf_alt']       : '600';
      $sChartOrder       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_order'])     && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_order'])     ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_order']     : '';
   ...
   function grafico_flash_chart($width, $height, $sFileLocal, $export, $arr_charts, $isPDF = 'N')
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['bmulti'] = $bMulti;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['bcomb']  = $bComb;
      ...
      if ($_SESSION['scriptcase']['phantomjs_charts'] && "Y" == $isPDF)
      {
          ...
          $sTmpId       = md5($sTmpId . 'chart_tbcustosVeiculos');
          $sImageName   = 'sc_pjs_png_' . $sTmpId . '.png';
          $sImageUrl    = $_SESSION['scriptcase']['chart_tbcustosVeiculos']['glo_nm_path_imag_temp'] . '/' . $sImageName;
          $sImageFile   = $this->Ini->root . $sImageUrl;
          $sPDFHtmlCall = "";
          $sAppDir      = getcwd();
          $aOS          = $this->Ini->getRunningOS();
          $sPhantomCmd  = 'phantomjs "' . $this->Ini->root . $_SESSION['scriptcase']['chart_tbcustosVeiculos']['glo_nm_path_imag_temp'] . '/sc_pjs_js_' . $sTmpId . '.js"';
          $iJsDelay     = 150;
          if ('win' != $aOS['os'])
          {
      ...
      {
         if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['charts_html']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['charts_html'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['charts_html'] = "  FusionCharts.setCurrentRenderer('javascript');";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['charts_html'] .= $sPDFHtmlCall;
      }
   }

   function generatePhantomJs($sTmpId, $sImageFile, $iDelay)
   {
       $fPhantomJs = @fopen($this->Ini->root . $_SESSION['scriptcase']['chart_tbcustosVeiculos']['glo_nm_path_imag_temp'] . '/sc_pjs_js_' . $sTmpId . '.js', 'w');
   ...
   {
       $fPhantomChart = @fopen($this->Ini->root . $_SESSION['scriptcase']['chart_tbcustosVeiculos']['glo_nm_path_imag_temp'] . '/sc_pjs_php_' . $sTmpId . '.php', 'w');
   ...
   function grafico_dados($cht_data, $export)
   {
       ...
       if ('Y' != $export)
       {
           if (isset($cht_data['combination']) && $cht_data['combination'])
           {
               ...
               foreach ($cht_data['charts'] as $s_comb_chart_index)
               {
                   if (empty($label))
                   {
                       $label = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['labels'];
                   }
                   if (empty($dbval))
                   {
                       $dbval = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['db_values'];
                   }
                   if (empty($lbord))
                   {
                       $lbord = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['label_order'];
                   }
                   if (empty($param))
                   {
                       $param = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['param'];
                   }
                   if ('' == $name)
                   {
                       $name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['label_x'];
                   }
                   if ('' == $subt)
                   {
                       $subt = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['subtitle'];
                   }
                   $lab_y[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['label_y'];
                   $sum_i[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['summ_idx'];
                   $sum_f[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['summ_fn'];
                   $fmt[]           = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['format'];
                   $datay['anal'][] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['values']['sint'][0];
                   $tmp_xml_links   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'][$s_comb_chart_index]['xml_links'];
       ...
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts'] as $chart_index => $chart_data)
           {
   ...
   function getChartRenderer($bMulti, $bComb)
   {
       if ($bComb)
       {
           ...
           switch ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type']) {
               case 'angulargauge':
                   $newChartType = "angulargauge";
                   break;
               case 'area';
       ...
       $sChart = '';
       $sMulti = $bMulti ? 'MS' : '';
       switch ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_tipo'])
       {
           case 'Bar':
               if ('Horizontal' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_barra_orien'])
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       $sChart .= 'StackedBar';
                       $sChart .= '3d' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_barra_dimen']  ? '3D' : '2D';
                   }
                   else
                   {
                       $sChart .= $sMulti . 'Bar';
               ...
               else
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       ...
                       $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_barra_dimen'] ? '2D' : '3D';
                   }
                   else
                   {
               ...
               break;
           case 'Pie':
               if ('Pie' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_pizza_forma'])
               {
                   $sChart .= 'Pie';
               }
               else
               ...
               $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_pizza_dimen'] ? '2D' : '3D';
               break;
           case 'Line':
               if ('Line' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_linha_forma'])
               {
                   $sChart .= $sMulti . 'Line';
               }
               elseif ('Spline' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_linha_forma'])
               {
               ...
               break;
           case 'Area':
               if ('Area' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_area_forma'])
               {
                   if ($bMulti)
                   {
                       $sChart .= $sMulti . 'Area';
   ...
   function getChartModule($sChartType = '')
   {
       if ('' == $sChartType)
       {
           $sChartType = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['parms_graf']['graf_tipo'];
       }
       switch ($sChartType)
       {
           case 'Bar':
