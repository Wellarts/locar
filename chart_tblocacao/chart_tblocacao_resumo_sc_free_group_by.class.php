...
class chart_tblocacao_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_datasaidalocacao;
   var $array_total_idfkveiculolocacao;
   var $array_total_valorliquidolocacao;
   ...
   var $sc_proc_quebra_datasaidalocacao;
   var $count_datasaidalocacao;
   var $sum_datasaidalocacao_valorliquidolocacao;
   var $sc_proc_quebra_idfkveiculolocacao;
   var $count_idfkveiculolocacao;
   var $sum_idfkveiculolocacao_valorliquidolocacao;
   var $sc_proc_quebra_valorliquidolocacao;
   var $count_valorliquidolocacao;
   var $sum_valorliquidolocacao_valorliquidolocacao;

   //---- 
   function chart_tblocacao_resumo($tipo = "")
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_tblocacao']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_tblocacao']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_tblocacao']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['where_pesq_filtro'];
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['chart_combination_type']        = 'combination3d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['chart_combination_order_field'] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_y_axys'][1] = 1;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_y_axys'][2] = 2;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['SC_Gb_Free_cmp']["datasaidalocacao"] = 'datasaidalocacao';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['SC_Gb_Free_cmp']["idfkveiculolocacao"] = 'idfkveiculolocacao';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['SC_Gb_Free_cmp']["valorliquidolocacao"] = 'valorliquidolocacao';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['SC_Gb_Free_sql']["dataSaidaLocacao"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['SC_Gb_Free_sql']["idFKveiculoLocacao"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['SC_Gb_Free_sql']["valorLiquidoLocacao"] = 'asc';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['comb_field_display_type'][2] = 'line';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['chart_display_values'][2] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_display'][2]['display'] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_order'][] = 2;
       }

      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['ajax_nav'])
      {
          $_SESSION['scriptcase']['saida_var'] = false; 
      }
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("chart_tblocacao", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['contr_total_geral'] == "OK")
      {
          $this->array_total_datasaidalocacao = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['arr_total']['datasaidalocacao'];
          $this->array_total_idfkveiculolocacao = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['arr_total']['idfkveiculolocacao'];
          $this->array_total_valorliquidolocacao = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['arr_total']['valorliquidolocacao'];
      }
      else
      {
          $this->array_total_datasaidalocacao = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['arr_total']['datasaidalocacao'] = $this->array_total_datasaidalocacao;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['arr_total']['idfkveiculolocacao'] = $this->array_total_idfkveiculolocacao;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['arr_total']['valorliquidolocacao'] = $this->array_total_valorliquidolocacao;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['datasaidalocacao'] = "Data da Saída";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['labels'][''] = "Data da Saída"; 
       $prep_field['idfkveiculolocacao'] = "Veículo";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['labels'][''] = "Veículo"; 
       $prep_field['valorliquidolocacao'] = "Valor";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['labels'][''] = "Valor"; 
       $Str_gb = "";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_control'] = array(
               'valorliquidolocacao' => array(
                   ...
                   'select' => "<select class=\"sc-ui-select-valorliquidolocacao\" onChange=\"scSummChange($(this))\"><option value=\"2\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
           );
       }
       //-----
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "valorliquidolocacao", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_valorliquidolocacao_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['idfkveiculolocacao']['alin'] = "''";
       $Arr_parms['idfkveiculolocacao']['link'] = "N";
       $Arr_parms['datasaidalocacao']['alin'] = "''";
       $Arr_parms['datasaidalocacao']['link'] = "N";
       $Arr_parms['valorliquidolocacao']['alin'] = "''";
       $Arr_parms['valorliquidolocacao']['link'] = "N";
       $Arr_parms['datasaidalocacao']['fill'] = "true";
       $Arr_parms['datasaidalocacao']['order'] = "value";
       $Arr_parms['idfkveiculolocacao']['fill'] = "true";
       $Arr_parms['idfkveiculolocacao']['order'] = "value";
       $Arr_parms['valorliquidolocacao']['fill'] = "true";
       $Arr_parms['valorliquidolocacao']['order'] = "value";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['idfkveiculolocacao'] = array(0 => 'idfkveiculolocacao', 1 => '');
       $prep_links_fl['datasaidalocacao'] = array(0 => 'datasaidalocacao', 1 => '@aspass@');
       $prep_links_fl['valorliquidolocacao'] = array(0 => 'valorliquidolocacao', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           'datasaidalocacao' => array(
           '1' => array(
               'title'    => $this->getChartText("Valor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Data da Saída"),
               'label_y'  => $this->getChartText("Valor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['summarizing_fields_order'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_tblocacao_' . session_id() . '_C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__.xml' : '',
                               'xml'         => 'sc_chart_tblocacao_' . session_id() . '_C_' . $i_index_group . '_' . $s_index_comb . '.xml',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_chart_tblocacao_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_chart_tblocacao_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_tblocacao']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_tblocacao']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_tblocacao']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_tblocacao']) . "_";
               } 
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_tblocacao_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['opcao'] = "print";
      ...
      $this->total   = new chart_tblocacao_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_datasaidalocacao, $this->array_total_idfkveiculolocacao, $this->array_total_valorliquidolocacao);
      ksort($this->array_total_datasaidalocacao);
      ksort($this->array_total_idfkveiculolocacao);
      ksort($this->array_total_valorliquidolocacao);
      $this->total->quebra_geral();
   }
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['doc_word'])
{
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Locações</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_tblocacao_ajax.js\"></script>\r\n");
      include_once($this->Ini->Apl_grafico);
      $sFusionChartModule = chart_tblocacao_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = chart_tblocacao_grafico::getChartModule('Bar');
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_tblocacao_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_tblocacao_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_tblocacao_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_tblocacao/chart_tblocacao_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['embutida'])
      {
   ...
   $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsort_on", "scShowSort('#chart_sort_on_top')", "scShowSort('#chart_sort_on_top')", "chart_sort_on_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_tblocacao/chart_tblocacao_config_print.php?nm_opc=resumo&nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
         ...
         if (is_file("chart_tblocacao_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_tblocacao_help.txt"); 
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_tblocacao_config_pivot.php?nome_apl=chart_tblocacao&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "chart_tblocacao/chart_tblocacao_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['chart_tblocacao_iframe_params'] = array(
      ...
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "chart_tblocacao/chart_tblocacao_iframe.php?scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_tblocacao_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_tblocacao/chart_tblocacao_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_charts']);
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_tblocacao_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>Locações</span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_valorliquidolocacao, $quebra_datasaidalocacao, $quebra_idfkveiculolocacao, $quebra_valorliquidolocacao, $quebra_datasaidalocacao_orig, $quebra_idfkveiculolocacao_orig, $quebra_valorliquidolocacao_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (empty($sum_valorliquidolocacao)) {$sum_valorliquidolocacao = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_valorliquidolocacao . ';
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tblocacao']['where_pesq']; 
     $temp = "";
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->idlocacao = $rs_res->fields[0] ;  
            $this->idfkclientelocacao = $rs_res->fields[1] ;  
            $this->idfkveiculolocacao = $rs_res->fields[2] ;  
            $this->datasaidalocacao = $rs_res->fields[3] ;  
            $this->horasaidalocacao = $rs_res->fields[4] ;  
            $this->kmsaidalocacao = $rs_res->fields[5] ;  
            $this->dataretornolocacao = $rs_res->fields[6] ;  
            $this->horaretornolocacao = $rs_res->fields[7] ;  
            $this->kmretornolocacao = $rs_res->fields[8] ;  
            $this->qtddiarias = $rs_res->fields[9] ;  
            $this->descontolocacao = $rs_res->fields[10] ;  
            $this->descontolocacao =  str_replace(",", ".", $this->descontolocacao);
            $this->valorliquidolocacao = $rs_res->fields[11] ;  
            $this->valorliquidolocacao =  str_replace(",", ".", $this->valorliquidolocacao);
            $this->obslocacao = $rs_res->fields[12] ;  
            $this->statuslocacao = $rs_res->fields[13] ;  
            $this->datasaidalocacao = substr($this->datasaidalocacao, 0, 7);
            $this->datasaidalocacao_orig = $this->datasaidalocacao;
            $this->idfkveiculolocacao_orig = $this->idfkveiculolocacao;
            $this->valorliquidolocacao_orig = $this->valorliquidolocacao;
            ...
            $this->idfkveiculolocacao = $this->look_idfkveiculolocacao ;
            $conteudo_x = $this->datasaidalocacao;
            nm_conv_limpa_dado($conteudo_x, "YYYY-MM");
            if (is_numeric($conteudo_x) && $conteudo_x > 0) 
            { 
                $this->nm_data->SetaData($this->datasaidalocacao, "YYYY-MM");
                $this->datasaidalocacao = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "mmaaaa"));
            } 
            nmgp_Form_Num_Val($this->valorliquidolocacao, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valorliquidolocacao, $this->datasaidalocacao, $this->idfkveiculolocacao, $this->valorliquidolocacao, $this->datasaidalocacao_orig,  $this->idfkveiculolocacao_orig,  $this->valorliquidolocacao_orig);
            }
   }
//
