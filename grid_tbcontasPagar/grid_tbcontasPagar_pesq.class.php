 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd css_idfkcredorcontaspagar_fil_label"><?php echo (isset($this->New_label['idfkcredorcontaspagar'])) ? $this->New_label['idfkcredorcontaspagar'] : "Credor"; ?></TD>
     ...
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idfkcredorcontaspagar" <?php echo $str_hide_idfkcredorcontaspagar?> valign="top">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idfkcredorcontaspagar" name="idfkcredorcontaspagar_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven css_datavencimentocontaspagar_fil_label"><?php echo (isset($this->New_label['datavencimentocontaspagar'])) ? $this->New_label['datavencimentocontaspagar'] : "Vencimento"; ?></TD>
     ...
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_datavencimentocontaspagar" <?php echo $str_hide_datavencimentocontaspagar?> valign="top">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_datavencimentocontaspagar"  <?php echo $str_display_datavencimentocontaspagar; ?> class="scFilterFieldFontEven">
