...
class pdf_ficha_locacao_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Res       = new pdf_ficha_locacao_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_ficha_locacao']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_ficha_locacao']['pivot_tabular'];
      if (1 >= sizeof($this->comp_y_axys))
      {
          $this->comp_tabular = false;
      }
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_ficha_locacao']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_ficha_locacao']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
