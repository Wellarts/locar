...
<?php
include_once("calendar_tblocacao_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('calendar_tblocacao_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['recarga'];
}
?>
...
<?php
 include_once("calendar_tblocacao_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="calendar_tblocacao_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['calendar_tblocacao_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['calendar_tblocacao_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_idlocacao_line" id="hidden_field_data_idlocacao" style="<?php echo $sStyleHidden_idlocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idlocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idlocacao_label"><span id="id_label_idlocacao"><?php echo $this->nm_new_label['idlocacao']; ?></span></span><br><span id="id_read_on_idlocacao" class="css_idlocacao_line" style="<?php echo $sStyleReadLab_idlocacao; ?>"><?php echo $this->form_encode_input($this->idlocacao); ?></span><span id="id_read_off_idlocacao" style="<?php echo $sStyleReadInp_idlocacao; ?>"><input type="hidden" name="idlocacao" value="<?php echo $this->form_encode_input($idlocacao) . "\">"?><span id="id_ajax_label_idlocacao"><?php echo nl2br($idlocacao); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idfkclientelocacao_line" id="hidden_field_data_idfkclientelocacao" style="<?php echo $sStyleHidden_idfkclientelocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idfkclientelocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idfkclientelocacao_label"><span id="id_label_idfkclientelocacao"><?php echo $this->nm_new_label['idfkclientelocacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idfkveiculolocacao_line" id="hidden_field_data_idfkveiculolocacao" style="<?php echo $sStyleHidden_idfkveiculolocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idfkveiculolocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idfkveiculolocacao_label"><span id="id_label_idfkveiculolocacao"><?php echo $this->nm_new_label['idfkveiculolocacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_datasaidalocacao_line" id="hidden_field_data_datasaidalocacao" style="<?php echo $sStyleHidden_datasaidalocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datasaidalocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_datasaidalocacao_label"><span id="id_label_datasaidalocacao"><?php echo $this->nm_new_label['datasaidalocacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_horasaidalocacao_line" id="hidden_field_data_horasaidalocacao" style="<?php echo $sStyleHidden_horasaidalocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_horasaidalocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_horasaidalocacao_label"><span id="id_label_horasaidalocacao"><?php echo $this->nm_new_label['horasaidalocacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kmsaidalocacao_line" id="hidden_field_data_kmsaidalocacao" style="<?php echo $sStyleHidden_kmsaidalocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kmsaidalocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kmsaidalocacao_label"><span id="id_label_kmsaidalocacao"><?php echo $this->nm_new_label['kmsaidalocacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dataretornolocacao_line" id="hidden_field_data_dataretornolocacao" style="<?php echo $sStyleHidden_dataretornolocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dataretornolocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dataretornolocacao_label"><span id="id_label_dataretornolocacao"><?php echo $this->nm_new_label['dataretornolocacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kmretornolocacao_line" id="hidden_field_data_kmretornolocacao" style="<?php echo $sStyleHidden_kmretornolocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kmretornolocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kmretornolocacao_label"><span id="id_label_kmretornolocacao"><?php echo $this->nm_new_label['kmretornolocacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qtddiarias_line" id="hidden_field_data_qtddiarias" style="<?php echo $sStyleHidden_qtddiarias; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qtddiarias_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qtddiarias_label"><span id="id_label_qtddiarias"><?php echo $this->nm_new_label['qtddiarias']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descontolocacao_line" id="hidden_field_data_descontolocacao" style="<?php echo $sStyleHidden_descontolocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descontolocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descontolocacao_label"><span id="id_label_descontolocacao"><?php echo $this->nm_new_label['descontolocacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valorliquidolocacao_line" id="hidden_field_data_valorliquidolocacao" style="<?php echo $sStyleHidden_valorliquidolocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valorliquidolocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valorliquidolocacao_label"><span id="id_label_valorliquidolocacao"><?php echo $this->nm_new_label['valorliquidolocacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_statuslocacao_line" id="hidden_field_data_statuslocacao" style="<?php echo $sStyleHidden_statuslocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_statuslocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_statuslocacao_label"><span id="id_label_statuslocacao"><?php echo $this->nm_new_label['statuslocacao']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['Lookup_statuslocacao'][] = '1'; ?>
 <option value="0" <?php  if ($this->statuslocacao == "0") { echo " selected" ;} ?>>NÃO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['Lookup_statuslocacao'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_obslocacao_line" id="hidden_field_data_obslocacao" style="<?php echo $sStyleHidden_obslocacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_obslocacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_obslocacao_label"><span id="id_label_obslocacao"><?php echo $this->nm_new_label['obslocacao']; ?></span></span><br>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("calendar_tblocacao_mob");
 parent.scAjaxDetailHeight("calendar_tblocacao_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
