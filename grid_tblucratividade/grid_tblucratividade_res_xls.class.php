...
class grid_tblucratividade_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_tblucratividade_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "grid_tblucratividade.xls";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xls_name']);
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Valores - Locações :: Excel</TITLE>
