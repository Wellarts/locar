<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_tbcustosVeiculos_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tbcustosVeiculos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['idcustoveiculo'] = "on";
   $tab_def_campos['idcustoveiculo'] = "idCustoVeiculo";
   $tab_converte["idCustoVeiculo"]   = "idcustoveiculo";
   $tab_labels["idcustoveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['labels']["idcustoveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['labels']["idcustoveiculo"] : "Código";
   $tab_ger_campos['idfkveiculocustoveiculo'] = "on";
   $tab_def_campos['idfkveiculocustoveiculo'] = "idFKveiculoCustoVeiculo";
   $tab_converte["idFKveiculoCustoVeiculo"]   = "idfkveiculocustoveiculo";
   $tab_labels["idfkveiculocustoveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['labels']["idfkveiculocustoveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['labels']["idfkveiculocustoveiculo"] : "Veículo";
   $tab_ger_campos['datacustoveiculo'] = "on";
   $tab_def_campos['datacustoveiculo'] = "dataCustoVeiculo";
   $tab_converte["dataCustoVeiculo"]   = "datacustoveiculo";
   $tab_labels["datacustoveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['labels']["datacustoveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['labels']["datacustoveiculo"] : "Data";
   $tab_ger_campos['descricaocustoveiculo'] = "on";
   $tab_def_campos['descricaocustoveiculo'] = "descricaoCustoVeiculo";
   $tab_converte["descricaoCustoVeiculo"]   = "descricaocustoveiculo";
   $tab_labels["descricaocustoveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['labels']["descricaocustoveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['labels']["descricaocustoveiculo"] : "Serviço/Peça";
   $tab_ger_campos['valorcustoveiculo'] = "on";
   $tab_def_campos['valorcustoveiculo'] = "valorCustoVeiculo";
   $tab_converte["valorCustoVeiculo"]   = "valorcustoveiculo";
   $tab_labels["valorcustoveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['labels']["valorcustoveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['labels']["valorcustoveiculo"] : "Valor";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tbcustosVeiculos_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tbcustosVeiculos']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
