<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_tbcontasPagar_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tbcontasPagar_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['idcontaspagar'] = "on";
   $tab_def_campos['idcontaspagar'] = "idContasPagar";
   $tab_converte["idContasPagar"]   = "idcontaspagar";
   $tab_labels["idcontaspagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["idcontaspagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["idcontaspagar"] : "Código";
   $tab_ger_campos['idfkcredorcontaspagar'] = "on";
   $tab_def_campos['idfkcredorcontaspagar'] = "idFKCredorContasPagar";
   $tab_converte["idFKCredorContasPagar"]   = "idfkcredorcontaspagar";
   $tab_labels["idfkcredorcontaspagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["idfkcredorcontaspagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["idfkcredorcontaspagar"] : "Credor";
   $tab_ger_campos['datavencimentocontaspagar'] = "on";
   $tab_def_campos['datavencimentocontaspagar'] = "dataVencimentoContasPagar";
   $tab_converte["dataVencimentoContasPagar"]   = "datavencimentocontaspagar";
   $tab_labels["datavencimentocontaspagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["datavencimentocontaspagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["datavencimentocontaspagar"] : "Vencimento";
   $tab_ger_campos['datapagamentocontaspagar'] = "on";
   $tab_def_campos['datapagamentocontaspagar'] = "dataPagamentoContasPagar";
   $tab_converte["dataPagamentoContasPagar"]   = "datapagamentocontaspagar";
   $tab_labels["datapagamentocontaspagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["datapagamentocontaspagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["datapagamentocontaspagar"] : "Pagamento";
   $tab_ger_campos['ordemparcelacontaspagar'] = "on";
   $tab_def_campos['ordemparcelacontaspagar'] = "ordemParcelaContasPagar";
   $tab_converte["ordemParcelaContasPagar"]   = "ordemparcelacontaspagar";
   $tab_labels["ordemparcelacontaspagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["ordemparcelacontaspagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["ordemparcelacontaspagar"] : "Parcela";
   $tab_ger_campos['valorcontaspagar'] = "on";
   $tab_def_campos['valorcontaspagar'] = "valorContasPagar";
   $tab_converte["valorContasPagar"]   = "valorcontaspagar";
   $tab_labels["valorcontaspagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["valorcontaspagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["valorcontaspagar"] : "Valor da Parcela";
   $tab_ger_campos['quitadocontaspagar'] = "on";
   $tab_def_campos['quitadocontaspagar'] = "quitadoContasPagar";
   $tab_converte["quitadoContasPagar"]   = "quitadocontaspagar";
   $tab_labels["quitadocontaspagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["quitadocontaspagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["quitadocontaspagar"] : "Pago?";
   $tab_ger_campos['valorpagocontaspagar'] = "on";
   $tab_def_campos['valorpagocontaspagar'] = "valorPagoContasPagar";
   $tab_converte["valorPagoContasPagar"]   = "valorpagocontaspagar";
   $tab_labels["valorpagocontaspagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["valorpagocontaspagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["valorpagocontaspagar"] : "Valor Pago";
   $tab_ger_campos['obscontaspagar'] = "on";
   $tab_def_campos['obscontaspagar'] = "obsContasPagar";
   $tab_converte["obsContasPagar"]   = "obscontaspagar";
   $tab_labels["obscontaspagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["obscontaspagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['labels']["obscontaspagar"] : "Observações";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tbcontasPagar_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tbcontasPagar']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
