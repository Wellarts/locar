<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_tblocacao_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tblocacao_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['idlocacao'] = "on";
   $tab_def_campos['idlocacao'] = "idLocacao";
   $tab_converte["idLocacao"]   = "idlocacao";
   $tab_labels["idlocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["idlocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["idlocacao"] : "Código";
   $tab_ger_campos['idfkclientelocacao'] = "on";
   $tab_def_campos['idfkclientelocacao'] = "idFKclienteLocacao";
   $tab_converte["idFKclienteLocacao"]   = "idfkclientelocacao";
   $tab_labels["idfkclientelocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["idfkclientelocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["idfkclientelocacao"] : "Cliente";
   $tab_ger_campos['idfkveiculolocacao'] = "on";
   $tab_def_campos['idfkveiculolocacao'] = "idFKveiculoLocacao";
   $tab_converte["idFKveiculoLocacao"]   = "idfkveiculolocacao";
   $tab_labels["idfkveiculolocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["idfkveiculolocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["idfkveiculolocacao"] : "Veículo";
   $tab_ger_campos['datasaidalocacao'] = "on";
   $tab_def_campos['datasaidalocacao'] = "dataSaidaLocacao";
   $tab_converte["dataSaidaLocacao"]   = "datasaidalocacao";
   $tab_labels["datasaidalocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["datasaidalocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["datasaidalocacao"] : "Data da Saída";
   $tab_ger_campos['horasaidalocacao'] = "on";
   $tab_def_campos['horasaidalocacao'] = "horaSaidaLocacao";
   $tab_converte["horaSaidaLocacao"]   = "horasaidalocacao";
   $tab_labels["horasaidalocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["horasaidalocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["horasaidalocacao"] : "Hora da Saída";
   $tab_ger_campos['dataretornolocacao'] = "on";
   $tab_def_campos['dataretornolocacao'] = "dataRetornoLocacao";
   $tab_converte["dataRetornoLocacao"]   = "dataretornolocacao";
   $tab_labels["dataretornolocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["dataretornolocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["dataretornolocacao"] : "Data do Retorno";
   $tab_ger_campos['horaretornolocacao'] = "on";
   $tab_def_campos['horaretornolocacao'] = "horaRetornoLocacao";
   $tab_converte["horaRetornoLocacao"]   = "horaretornolocacao";
   $tab_labels["horaretornolocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["horaretornolocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["horaretornolocacao"] : "Hora do Retorno";
   $tab_ger_campos['kmtotal'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['kmtotal'] = "kmTotal";
       $tab_converte["kmTotal"]   = "kmtotal";
   }
   else
   {
       $tab_def_campos['kmtotal'] = "";
       $tab_converte[""]   = "kmtotal";
   }
   $tab_labels["kmtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["kmtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["kmtotal"] : "Km Total";
   $tab_ger_campos['qtddiarias'] = "on";
   $tab_def_campos['qtddiarias'] = "qtdDiarias";
   $tab_converte["qtdDiarias"]   = "qtddiarias";
   $tab_labels["qtddiarias"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["qtddiarias"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["qtddiarias"] : "Qtd Diárias";
   $tab_ger_campos['valorliquidolocacao'] = "on";
   $tab_def_campos['valorliquidolocacao'] = "valorLiquidoLocacao";
   $tab_converte["valorLiquidoLocacao"]   = "valorliquidolocacao";
   $tab_labels["valorliquidolocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["valorliquidolocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["valorliquidolocacao"] : "Valor Total";
   $tab_ger_campos['fichalocacao'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fichalocacao'] = "fichaLocacao";
       $tab_converte["fichaLocacao"]   = "fichalocacao";
   }
   else
   {
       $tab_def_campos['fichalocacao'] = "";
       $tab_converte[""]   = "fichalocacao";
   }
   $tab_labels["fichalocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["fichalocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["fichalocacao"] : "Ficha de Locação";
   $tab_ger_campos['statuslocacao'] = "on";
   $tab_def_campos['statuslocacao'] = "statusLocacao";
   $tab_converte["statusLocacao"]   = "statuslocacao";
   $tab_labels["statuslocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["statuslocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['labels']["statuslocacao"] : "Situação";
   $tab_ger_campos['kmtotal'] = "none";
   $tab_ger_campos['fichalocacao'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tblocacao']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tblocacao_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tblocacao']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
