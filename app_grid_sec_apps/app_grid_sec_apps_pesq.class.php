...
class app_grid_sec_apps_pesq
{
    ...
    * @access  public
    */
   function app_grid_sec_apps_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . app_grid_sec_apps_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . app_grid_sec_apps_pack_protect_string($Tipo_filter[0]) . "\">.." . app_grid_sec_apps_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - sec_apps</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>app_grid_sec_apps/app_grid_sec_apps_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="app_grid_sec_apps_ajax_search.js"></script>
 <script type="text/javascript" src="app_grid_sec_apps_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_app_name_cond#NMF#' + search_get_sel_txt('SC_app_name_cond') + '@NMF@';
  str_out += 'SC_app_name#NMF#' + search_get_text('SC_app_name') + '@NMF@';
  str_out += 'SC_app_type_cond#NMF#' + search_get_sel_txt('SC_app_type_cond') + '@NMF@';
  str_out += 'SC_app_type#NMF#' + search_get_text('SC_app_type') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - sec_apps</span></td>
...
<?php
   ...
   {
      global 
             $app_name_cond, $app_name,
             $app_type_cond, $app_type,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $app_name = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']['app_name']; 
          $app_name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']['app_name_cond']; 
          $app_type = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']['app_type']; 
          $app_type_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']['app_type_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']['NM_operador']; 
      } 
      if (!isset($app_name_cond) || empty($app_name_cond))
      {
         $app_name_cond = "eq";
      }
      ...
      $str_hide_app_name = (in_array($app_name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_app_type = (in_array($app_type_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($app_name, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $app_name = substr($app_name, 0, $tmp_pos);
         }
      }
      ...
      if (isset($app_type) && !empty($app_type))
      {
         $tmp_pos = strpos($app_type, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $app_type = substr($app_type, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("app_grid_sec_apps_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['app_name'])) ? $this->New_label['app_name'] : "App Name "; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_app_name_cond" name="app_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_app_name'), this, 'app_name')">
       <OPTION value="eq" <?php if ("eq" == $app_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $app_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $app_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $app_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_app_name" <?php echo $str_hide_app_name?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['app_name'])) ? $this->New_label['app_name'] : "App Name ";
 $nmgp_tab_label .= "app_name?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_app_name" name="app_name" value="<?php echo NM_encode_input($app_name) ?>" size=50 alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['app_type'])) ? $this->New_label['app_type'] : "App Type"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_app_type_cond" name="app_type_cond" onChange="nm_campos_between(document.getElementById('id_vis_app_type'), this, 'app_type')">
       <OPTION value="eq"><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_app_type" <?php echo $str_hide_app_type?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['app_type'])) ? $this->New_label['app_type'] : "App Type";
 $nmgp_tab_label .= "app_type?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_app_type" name="app_type" value="<?php echo NM_encode_input($app_type) ?>" size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_grid_sec_apps']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_grid_sec_apps']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_app_name'), document.F1.app_name_cond, 'app_name');
   document.F1.app_name.value = "";
   nm_campos_between(document.getElementById('id_vis_app_type'), document.F1.app_type_cond, 'app_type');
   document.F1.app_type.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "LocarVeiculos/app_grid_sec_apps";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_app_name_cond'] = 'cond';
      $tp_fields['SC_app_name'] = 'text';
      $tp_fields['SC_app_type_cond'] = 'cond';
      $tp_fields['SC_app_type'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $app_name_cond, $app_name,
             $app_type_cond, $app_type, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $app_name_cond_salva = $app_name_cond; 
      if (!isset($app_name_input_2) || $app_name_input_2 == "")
      {
          $app_name_input_2 = $app_name;
      }
      $app_type_cond_salva = $app_type_cond; 
      if (!isset($app_type_input_2) || $app_type_input_2 == "")
      {
          $app_type_input_2 = $app_type;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']['app_name'] = $app_name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']['app_name_cond'] = $app_name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']['app_type'] = $app_type; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']['app_type_cond'] = $app_type_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $app_name;
      $this->cmp_formatado['app_name'] = $Conteudo;
      $Conteudo = $app_type;
      $this->cmp_formatado['app_type'] = $Conteudo;

      //----- $app_name
      $this->Date_part = false;
      if (isset($app_name) || $app_name_cond == "nu" || $app_name_cond == "nn" || $app_name_cond == "ep" || $app_name_cond == "ne")
      {
         $this->monta_condicao("app_name", $app_name_cond, $app_name, "", "app_name");
      }

      //----- $app_type
      $this->Date_part = false;
      if (isset($app_type) || $app_type_cond == "nu" || $app_type_cond == "nn" || $app_type_cond == "ep" || $app_type_cond == "ne")
      {
         $this->monta_condicao("app_type", $app_type_cond, $app_type, "", "app_type");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['where_pesq_ant'] = $this->comando . $this->comando_fim;
