<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_tblucratividade_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tblucratividade_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['idfklocacao'] = "idFKLocacao";
   $tab_converte["idFKLocacao"]   = "idfklocacao";
   $tab_labels["idfklocacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['labels']["idfklocacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['labels']["idfklocacao"] : "Locação";
   $tab_ger_campos['idfkveiculo'] = "on";
   $tab_def_campos['idfkveiculo'] = "idFKveiculo";
   $tab_converte["idFKveiculo"]   = "idfkveiculo";
   $tab_labels["idfkveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['labels']["idfkveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['labels']["idfkveiculo"] : "Veículo";
   $tab_ger_campos['datadiaria'] = "on";
   $tab_def_campos['datadiaria'] = "dataDiaria";
   $tab_converte["dataDiaria"]   = "datadiaria";
   $tab_labels["datadiaria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['labels']["datadiaria"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['labels']["datadiaria"] : "Data da Saída";
   $tab_ger_campos['valordiaria'] = "on";
   $tab_def_campos['valordiaria'] = "valorDiaria";
   $tab_converte["valorDiaria"]   = "valordiaria";
   $tab_labels["valordiaria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['labels']["valordiaria"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['labels']["valordiaria"] : "Valor por Dia";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tblucratividade_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tblucratividade']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
