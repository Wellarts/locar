...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "datacustoveiculo";$Nm_numeric[] = "idcustoveiculo";$Nm_numeric[] = "idfkveiculocustoveiculo";$Nm_numeric[] = "valorcustoveiculo";
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_datacustoveiculo"  <?php echo $str_hide_datacustoveiculo?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_datacustoveiculo"  <?php echo $str_display_datacustoveiculo; ?> class="scFilterFieldFontOdd">
