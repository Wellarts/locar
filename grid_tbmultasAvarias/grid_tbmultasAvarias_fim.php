...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____grid_tbmultasAvarias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____grid_tbmultasAvarias"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbmultasAvarias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbmultasAvarias']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbmultasAvarias']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbmultasAvarias']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbmultasAvarias']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbmultasAvarias</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbmultasAvarias']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbmultasAvarias']['embutida_filho'] as $ind => $sc_init)
          {
