...
class grid_tbclientes_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbclientes_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbclientes_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbclientes_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nomecliente')
      {
          $nomecliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nomecliente($nomecliente);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cpfcliente')
      {
          $cpfcliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cpfcliente($cpfcliente);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_nomecliente($nomecliente)
   {
      $nomecliente = substr($this->Db->qstr($nomecliente), 1, -1);
            $nomecliente_look = substr($this->Db->qstr($nomecliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select nomeCliente from tbclientes where  nomeCliente like '%" . $nomecliente . "%' order by nomeCliente"; 
   ...
   function lookup_ajax_cpfcliente($cpfcliente)
   {
      $cpfcliente = substr($this->Db->qstr($cpfcliente), 1, -1);
            $cpfcliente_look = substr($this->Db->qstr($cpfcliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cpfCliente from " . $this->Ini->nm_tabela . " where  cpfCliente like '%" . $cpfcliente . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "validadecnhcliente";$Nm_numeric[] = "idcliente";$Nm_numeric[] = "idfkcidadecliente";$Nm_numeric[] = "idfkestadocliente";$Nm_numeric[] = "idfkufexpedrg";
      ...
      $Nm_datas[] = "validadecnhcliente";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_datas))
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbclientes/grid_tbclientes_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbclientes_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbclientes_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_nomecliente_cond#NMF#' + search_get_sel_txt('SC_nomecliente_cond') + '@NMF@';
  str_out += 'SC_nomecliente#NMF#' + search_get_text('SC_nomecliente') + '@NMF@';
  str_out += 'id_ac_nomecliente#NMF#' + search_get_text('id_ac_nomecliente') + '@NMF@';
  str_out += 'SC_cpfcliente_cond#NMF#' + search_get_sel_txt('SC_cpfcliente_cond') + '@NMF@';
  str_out += 'SC_cpfcliente#NMF#' + search_get_text('SC_cpfcliente') + '@NMF@';
  str_out += 'id_ac_cpfcliente#NMF#' + search_get_text('id_ac_cpfcliente') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_nomecliente").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nomecliente",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nomecliente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nomecliente").val( $(this).val() );
       }
     }
   });
   $("#id_ac_cpfcliente").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cpfcliente",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_cpfcliente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cpfcliente").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Consultas de Clientes</span></td>
...
<?php
   ...
   {
      global 
             $nomecliente_cond, $nomecliente, $nomecliente_autocomp,
             $cpfcliente_cond, $cpfcliente, $cpfcliente_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $nomecliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']['nomecliente']; 
          $nomecliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']['nomecliente_cond']; 
          $cpfcliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']['cpfcliente']; 
          $cpfcliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']['cpfcliente_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']['NM_operador']; 
      } 
      if (!isset($nomecliente_cond) || empty($nomecliente_cond))
      {
         $nomecliente_cond = "eq";
      }
      if (!isset($cpfcliente_cond) || empty($cpfcliente_cond))
      {
         $cpfcliente_cond = "eq";
      }
      ...
      $str_hide_nomecliente = (in_array($nomecliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cpfcliente = (in_array($cpfcliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($nomecliente) || $nomecliente == "")
      {
          $nomecliente = "";
      }
      if (isset($nomecliente) && !empty($nomecliente))
      {
         $tmp_pos = strpos($nomecliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nomecliente = substr($nomecliente, 0, $tmp_pos);
         }
      }
      ...
      if (isset($cpfcliente) && !empty($cpfcliente))
      {
         $tmp_pos = strpos($cpfcliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cpfcliente = substr($cpfcliente, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_tbclientes_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_nomecliente_cond" name="nomecliente_cond" value="eq">

    <TD nowrap class="scFilterLabelOdd css_nomecliente_fil_label" > <?php
 $SC_Label = (isset($this->New_label['nomecliente'])) ? $this->New_label['nomecliente'] : "Nome";
 $nmgp_tab_label .= "nomecliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_nomecliente"  <?php echo $str_hide_nomecliente?>><?php
      $nomecliente_look = substr($this->Db->qstr($nomecliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select nomeCliente from tbclientes where nomeCliente = '$nomecliente_look' order by nomeCliente"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$nomecliente]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nomecliente];
      }
      else
      {
          $sAutocompValue = $nomecliente;
      }
?>
<INPUT  type="text" id="SC_nomecliente" name="nomecliente" value="<?php echo NM_encode_input($nomecliente) ?>" size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nomecliente" name="nomecliente_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_cpfcliente_cond" name="cpfcliente_cond" value="eq">

    <TD nowrap class="scFilterLabelEven css_cpfcliente_fil_label" > <?php
 $SC_Label = (isset($this->New_label['cpfcliente'])) ? $this->New_label['cpfcliente'] : "CPF";
 $nmgp_tab_label .= "cpfcliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_cpfcliente"  <?php echo $str_hide_cpfcliente?>><?php
      $cpfcliente_look = substr($this->Db->qstr($cpfcliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cpfCliente from " . $this->Ini->nm_tabela . " where cpfCliente = '$cpfcliente_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$cpfcliente]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$cpfcliente];
      }
      else
      {
          $sAutocompValue = $cpfcliente;
      }
?>
<INPUT  type="text" id="SC_cpfcliente" name="cpfcliente" value="<?php echo NM_encode_input($cpfcliente) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cpfcliente" name="cpfcliente_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbclientes']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbclientes']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_nomecliente'), document.F1.nomecliente_cond, 'nomecliente');
   document.F1.nomecliente.value = "";
   document.F1.nomecliente_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_cpfcliente'), document.F1.cpfcliente_cond, 'cpfcliente');
   document.F1.cpfcliente.value = "";
   document.F1.cpfcliente_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "LocarVeiculos/grid_tbclientes";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_nomecliente_cond'] = 'cond';
      $tp_fields['SC_nomecliente'] = 'text_aut';
      $tp_fields['id_ac_nomecliente'] = 'text_aut';
      $tp_fields['SC_cpfcliente_cond'] = 'cond';
      $tp_fields['SC_cpfcliente'] = 'text_aut';
      $tp_fields['id_ac_cpfcliente'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $nomecliente_cond, $nomecliente, $nomecliente_autocomp,
             $cpfcliente_cond, $cpfcliente, $cpfcliente_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($nomecliente_autocomp) && empty($nomecliente))
      {
          $nomecliente = $nomecliente_autocomp;
      }
      if (!empty($cpfcliente_autocomp) && empty($cpfcliente))
      {
          $cpfcliente = $cpfcliente_autocomp;
      }
      $nomecliente_cond_salva = $nomecliente_cond; 
      if (!isset($nomecliente_input_2) || $nomecliente_input_2 == "")
      {
          $nomecliente_input_2 = $nomecliente;
      }
      $cpfcliente_cond_salva = $cpfcliente_cond; 
      if (!isset($cpfcliente_input_2) || $cpfcliente_input_2 == "")
      {
          $cpfcliente_input_2 = $cpfcliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']['nomecliente'] = $nomecliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']['nomecliente_cond'] = $nomecliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']['cpfcliente'] = $cpfcliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']['cpfcliente_cond'] = $cpfcliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nomecliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nomecliente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nomecliente'] = $nomecliente;
      }
      $cpfcliente_look = substr($this->Db->qstr($cpfcliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cpfCliente from " . $this->Ini->nm_tabela . " where cpfCliente = '$cpfcliente_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cpfcliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cpfcliente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cpfcliente'] = $cpfcliente;
      }

      //----- $nomecliente
      $this->Date_part = false;
      if (isset($nomecliente) || $nomecliente_cond == "nu" || $nomecliente_cond == "nn" || $nomecliente_cond == "ep" || $nomecliente_cond == "ne")
      {
         $this->monta_condicao("nomeCliente", $nomecliente_cond, $nomecliente, "", "nomecliente");
      }

      //----- $cpfcliente
      $this->Date_part = false;
      if (isset($cpfcliente) || $cpfcliente_cond == "nu" || $cpfcliente_cond == "nn" || $cpfcliente_cond == "ep" || $cpfcliente_cond == "ne")
      {
         $this->monta_condicao("cpfCliente", $cpfcliente_cond, $cpfcliente, "", "cpfcliente");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['where_pesq_ant'] = $this->comando . $this->comando_fim;
