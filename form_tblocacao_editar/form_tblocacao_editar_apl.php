<?php
//
class form_tblocacao_editar_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['total']))
          {
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_tblocacao_editar_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['initialize'])
          {
              $_SESSION['scriptcase']['form_tblocacao_editar']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_tblocacao_editar']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['form_tblocacao_editar']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tblocacao_editar']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tblocacao_editar'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tblocacao_editar']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tblocacao_editar']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_tblocacao_editar') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tblocacao_editar']['label'] = "Locação de Veículo";
      ...
      $_SESSION['scriptcase']['error_icon']['form_tblocacao_editar']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_tblocacao_editar'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblocacao_editar']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_tblocacao_editar/form_tblocacao_editar_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_tblocacao_editar_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_tblocacao_editar_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_tblocacao_editar_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_tblocacao_editar/form_tblocacao_editar_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_tblocacao_editar_erro.class.php"); 
      }
      $this->Erro      = new form_tblocacao_editar_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opcao']))
         { 
             if ($this->idlocacao != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_tblocacao_editar']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['finalizaLocacao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['botoes']['finalizaLocacao'];
          $this->nmgp_botoes['fichaLocacao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['botoes']['fichaLocacao'];
          $this->nmgp_botoes['locacaoFinalizada'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['botoes']['locacaoFinalizada'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['Gera_log_access'] = false;
      }
...
//
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_tblocacao_editar_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_tblocacao_editar_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['sc_redir_atualiz'] == "ok")
          {
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_tblocacao_editar', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_tblocacao_editar', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opc_ant'] == "incluir")
      {
      ...
      $_SESSION['scriptcase']['form_tblocacao_editar']['contr_erro'] = 'on';
                              $this->statusLocacao();
$_SESSION['scriptcase']['form_tblocacao_editar']['contr_erro'] = 'off'; 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['total']);
?>
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_tblocacao_editar']) || !is_array($this->NM_ajax_info['errList']['geral_form_tblocacao_editar']))
              {
                  $this->NM_ajax_info['errList']['geral_form_tblocacao_editar'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_tblocacao_editar'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idlocacao']['keyVal'] = form_tblocacao_editar_pack_protect_string($this->nmgp_dados_form['idlocacao']);
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_tblocacao_editar_pack_protect_string(NM_charset_to_utf8($this->idfkclientelocacao))]) ? $aLookup[0][form_tblocacao_editar_pack_protect_string(NM_charset_to_utf8($this->idfkclientelocacao))] : "";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_tblocacao_editar_pack_protect_string(NM_charset_to_utf8($this->idfkveiculolocacao))]) ? $aLookup[0][form_tblocacao_editar_pack_protect_string(NM_charset_to_utf8($this->idfkveiculolocacao))] : "";
   ...
   function ajax_return_values_obslocacao($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idlocacao)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->multasavarias = $this->multasavarias_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_tblocacao_editar']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['parms'] = "idlocacao?#?$this->idlocacao?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_filter_form'];
      }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_tblocacao_editar = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['total'] = $qt_geral_reg_form_tblocacao_editar;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idlocacao))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_tblocacao_editar = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] > $qt_geral_reg_form_tblocacao_editar)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] = $qt_geral_reg_form_tblocacao_editar; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_tblocacao_editar) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] < $qt_geral_reg_form_tblocacao_editar;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opcao']   = '';
          }
      } 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_tblocacao_editar_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_tblocacao_editar_pack_ajax_response();
      ...
      $Nm_datas['datasaidalocacao'] = "date";$Nm_datas['horasaidalocacao'] = "time";$Nm_datas['dataretornolocacao'] = "date";$Nm_datas['horaretornolocacao'] = "time";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_tblocacao_editar_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_tblocacao_editar_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['masterValue']))
{
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao_editar']['retorno_edit'] = "";
   }
