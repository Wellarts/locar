...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_app_name"  <?php echo $str_hide_app_name?>><INPUT  type="text" id="SC_app_name" name="app_name" value="<?php echo NM_encode_input($app_name) ?>" size=50 alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_app_type"  <?php echo $str_hide_app_type?>><INPUT  type="text" id="SC_app_type" name="app_type" value="<?php echo NM_encode_input($app_type) ?>" size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
