...
class grid_tbcustosVeiculos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_tbcustosVeiculos_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbcustosVeiculos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbcustosVeiculos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbcustosVeiculos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "tbcustosVeiculos.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Custos com Veículos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbcustosVeiculos/grid_tbcustosVeiculos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbcustosVeiculos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbcustosVeiculos_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_datacustoveiculo_cond#NMF#' + search_get_sel_txt('SC_datacustoveiculo_cond') + '@NMF@';
  str_out += 'SC_datacustoveiculo_dia#NMF#' + search_get_sel_txt('SC_datacustoveiculo_dia') + '@NMF@';
  str_out += 'SC_datacustoveiculo_mes#NMF#' + search_get_sel_txt('SC_datacustoveiculo_mes') + '@NMF@';
  str_out += 'SC_datacustoveiculo_ano#NMF#' + search_get_sel_txt('SC_datacustoveiculo_ano') + '@NMF@';
  str_out += 'SC_datacustoveiculo_input_2_dia#NMF#' + search_get_sel_txt('SC_datacustoveiculo_input_2_dia') + '@NMF@';
  str_out += 'SC_datacustoveiculo_input_2_mes#NMF#' + search_get_sel_txt('SC_datacustoveiculo_input_2_mes') + '@NMF@';
  str_out += 'SC_datacustoveiculo_input_2_ano#NMF#' + search_get_sel_txt('SC_datacustoveiculo_input_2_ano') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Custos com Veículos</span></td>
...
<?php
   ...
   {
      global 
             $datacustoveiculo_cond, $datacustoveiculo, $datacustoveiculo_dia, $datacustoveiculo_mes, $datacustoveiculo_ano, $datacustoveiculo_input_2_dia, $datacustoveiculo_input_2_mes, $datacustoveiculo_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $datacustoveiculo_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_dia']; 
          $datacustoveiculo_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_mes']; 
          $datacustoveiculo_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_ano']; 
          $datacustoveiculo_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_input_2_dia']; 
          $datacustoveiculo_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_input_2_mes']; 
          $datacustoveiculo_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_input_2_ano']; 
          $datacustoveiculo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['NM_operador']; 
      } 
      if (!isset($datacustoveiculo_cond) || empty($datacustoveiculo_cond))
      {
         $datacustoveiculo_cond = "bw";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_datacustoveiculo = (in_array($datacustoveiculo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_datacustoveiculo = ('bw' == $datacustoveiculo_cond) ? $display_aberto : $display_fechado;

      if (!isset($datacustoveiculo) || $datacustoveiculo == "")
      {
          $datacustoveiculo = "";
      }
      if (isset($datacustoveiculo) && !empty($datacustoveiculo))
      {
         $tmp_pos = strpos($datacustoveiculo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $datacustoveiculo = substr($datacustoveiculo, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_tbcustosVeiculos_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['datacustoveiculo'])) ? $this->New_label['datacustoveiculo'] : "Data"; ?></TD>
      
      <INPUT type="hidden" id="SC_datacustoveiculo_cond" name="datacustoveiculo_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_datacustoveiculo" <?php echo $str_hide_datacustoveiculo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['datacustoveiculo'])) ? $this->New_label['datacustoveiculo'] : "Data";
 $nmgp_tab_label .= "datacustoveiculo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datacustoveiculo_dia" name="datacustoveiculo_dia" value="<?php echo NM_encode_input($datacustoveiculo_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datacustoveiculo_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datacustoveiculo_mes" name="datacustoveiculo_mes" value="<?php echo NM_encode_input($datacustoveiculo_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datacustoveiculo_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datacustoveiculo_ano" name="datacustoveiculo_ano" value="<?php echo NM_encode_input($datacustoveiculo_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
        <SPAN id="id_css_datacustoveiculo"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_datacustoveiculo"  <?php echo $str_display_datacustoveiculo; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datacustoveiculo_input_2_dia" name="datacustoveiculo_input_2_dia" value="<?php echo NM_encode_input($datacustoveiculo_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datacustoveiculo_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datacustoveiculo_input_2_mes" name="datacustoveiculo_input_2_mes" value="<?php echo NM_encode_input($datacustoveiculo_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datacustoveiculo_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datacustoveiculo_input_2_ano" name="datacustoveiculo_input_2_ano" value="<?php echo NM_encode_input($datacustoveiculo_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbcustosVeiculos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbcustosVeiculos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_datacustoveiculo'), document.F1.datacustoveiculo_cond, 'datacustoveiculo');
   document.F1.datacustoveiculo_dia.value = "";
   document.F1.datacustoveiculo_mes.value = "";
   document.F1.datacustoveiculo_ano.value = "";
   document.F1.datacustoveiculo_input_2_dia.value = "";
   document.F1.datacustoveiculo_input_2_mes.value = "";
   document.F1.datacustoveiculo_input_2_ano.value = "";
 }
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_datacustoveiculo_dia').bind('change', function() {sc_grid_tbcustosVeiculos_valida_dia(this)});
    $('#SC_datacustoveiculo_input_2_dia').bind('change', function() {sc_grid_tbcustosVeiculos_valida_dia(this)});
    $('#SC_datacustoveiculo_input_2_mes').bind('change', function() {sc_grid_tbcustosVeiculos_valida_mes(this)});
    $('#SC_datacustoveiculo_mes').bind('change', function() {sc_grid_tbcustosVeiculos_valida_mes(this)});
 }
 function sc_grid_tbcustosVeiculos_valida_dia(obj)
 {
 ...
 function sc_grid_tbcustosVeiculos_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "LocarVeiculos/grid_tbcustosVeiculos";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_tbcustosVeiculos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_datacustoveiculo_cond'] = 'cond';
      $tp_fields['SC_datacustoveiculo_dia'] = 'text';
      $tp_fields['SC_datacustoveiculo_mes'] = 'text';
      $tp_fields['SC_datacustoveiculo_ano'] = 'text';
      $tp_fields['SC_datacustoveiculo_input_2_dia'] = 'text';
      $tp_fields['SC_datacustoveiculo_input_2_mes'] = 'text';
      $tp_fields['SC_datacustoveiculo_input_2_ano'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $datacustoveiculo_cond, $datacustoveiculo, $datacustoveiculo_dia, $datacustoveiculo_mes, $datacustoveiculo_ano, $datacustoveiculo_input_2_dia, $datacustoveiculo_input_2_mes, $datacustoveiculo_input_2_ano, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $datacustoveiculo_cond_salva = $datacustoveiculo_cond; 
      if (!isset($datacustoveiculo_input_2_dia) || $datacustoveiculo_input_2_dia == "")
      {
          $datacustoveiculo_input_2_dia = $datacustoveiculo_dia;
      }
      if (!isset($datacustoveiculo_input_2_mes) || $datacustoveiculo_input_2_mes == "")
      {
          $datacustoveiculo_input_2_mes = $datacustoveiculo_mes;
      }
      if (!isset($datacustoveiculo_input_2_ano) || $datacustoveiculo_input_2_ano == "")
      {
          $datacustoveiculo_input_2_ano = $datacustoveiculo_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_dia'] = $datacustoveiculo_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_mes'] = $datacustoveiculo_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_ano'] = $datacustoveiculo_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_input_2_dia'] = $datacustoveiculo_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_input_2_mes'] = $datacustoveiculo_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_input_2_ano'] = $datacustoveiculo_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_cond'] = $datacustoveiculo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if ($datacustoveiculo_cond != "TP")
      {
          $datacustoveiculo_cond = strtoupper($datacustoveiculo_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $datacustoveiculo_ano;
          $Dtxt .= $datacustoveiculo_mes;
          $Dtxt .= $datacustoveiculo_dia;
          $val[0]['ano'] = $datacustoveiculo_ano;
          $val[0]['mes'] = $datacustoveiculo_mes;
          $val[0]['dia'] = $datacustoveiculo_dia;
          if ($datacustoveiculo_cond == "BW")
          {
              $val[1]['ano'] = $datacustoveiculo_input_2_ano;
              $val[1]['mes'] = $datacustoveiculo_input_2_mes;
              $val[1]['dia'] = $datacustoveiculo_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $datacustoveiculo_cond , "");
          $datacustoveiculo = $val[0];
          $this->cmp_formatado['datacustoveiculo'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['datacustoveiculo'], "YYYY-MM-DD");
          $this->cmp_formatado['datacustoveiculo'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($datacustoveiculo_cond == "BW")
          {
              $datacustoveiculo_input_2     = $val[1];
              $this->cmp_formatado['datacustoveiculo_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']['datacustoveiculo_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['datacustoveiculo_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['datacustoveiculo_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $datacustoveiculo_cond == "NU" || $datacustoveiculo_cond == "NN"|| $datacustoveiculo_cond == "EP"|| $datacustoveiculo_cond == "NE")
          {
              $this->monta_condicao("dataCustoVeiculo", $datacustoveiculo_cond, $datacustoveiculo, $datacustoveiculo_input_2, 'datacustoveiculo', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustosVeiculos']['where_pesq_ant'] = $this->comando . $this->comando_fim;
