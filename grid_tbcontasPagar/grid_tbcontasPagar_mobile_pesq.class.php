...
class grid_tbcontasPagar_pesq
{
    ...
    * @access  public
    */
   function grid_tbcontasPagar_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbcontasPagar_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbcontasPagar_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbcontasPagar_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idfkcredorcontaspagar')
      {
          $idfkcredorcontaspagar = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idfkcredorcontaspagar($idfkcredorcontaspagar);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_idfkcredorcontaspagar($idfkcredorcontaspagar)
   {
      $idfkcredorcontaspagar = substr($this->Db->qstr($idfkcredorcontaspagar), 1, -1);
            $idfkcredorcontaspagar_look = substr($this->Db->qstr($idfkcredorcontaspagar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select idCredor, nomeCredor from tbcredores where  nomeCredor like '%" . $idfkcredorcontaspagar . "%' order by nomeCredor"; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "datavencimentocontaspagar";$Nm_datas[] = "datapagamentocontaspagar";$Nm_numeric[] = "idcontaspagar";$Nm_numeric[] = "idfkcredorcontaspagar";$Nm_numeric[] = "valorcontaspagar";$Nm_numeric[] = "valorpagocontaspagar";$Nm_numeric[] = "qtdparcelascontaspagar";$Nm_numeric[] = "ordemparcelacontaspagar";$Nm_numeric[] = "quitadocontaspagar";$Nm_numeric[] = "diasaviso";
      ...
      $Nm_datas[] = "datavencimentocontaspagar";$Nm_datas[] = "datapagamentocontaspagar";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Contas à Pagar/Pagas</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbcontasPagar/grid_tbcontasPagar_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbcontasPagar_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbcontasPagar_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idfkcredorcontaspagar_cond#NMF#' + search_get_sel_txt('SC_idfkcredorcontaspagar_cond') + '@NMF@';
  str_out += 'SC_idfkcredorcontaspagar#NMF#' + search_get_text('SC_idfkcredorcontaspagar') + '@NMF@';
  str_out += 'id_ac_idfkcredorcontaspagar#NMF#' + search_get_text('id_ac_idfkcredorcontaspagar') + '@NMF@';
  str_out += 'SC_datavencimentocontaspagar_cond#NMF#' + search_get_sel_txt('SC_datavencimentocontaspagar_cond') + '@NMF@';
  str_out += 'SC_datavencimentocontaspagar_dia#NMF#' + search_get_sel_txt('SC_datavencimentocontaspagar_dia') + '@NMF@';
  str_out += 'SC_datavencimentocontaspagar_mes#NMF#' + search_get_sel_txt('SC_datavencimentocontaspagar_mes') + '@NMF@';
  str_out += 'SC_datavencimentocontaspagar_ano#NMF#' + search_get_sel_txt('SC_datavencimentocontaspagar_ano') + '@NMF@';
  str_out += 'SC_datavencimentocontaspagar_input_2_dia#NMF#' + search_get_sel_txt('SC_datavencimentocontaspagar_input_2_dia') + '@NMF@';
  str_out += 'SC_datavencimentocontaspagar_input_2_mes#NMF#' + search_get_sel_txt('SC_datavencimentocontaspagar_input_2_mes') + '@NMF@';
  str_out += 'SC_datavencimentocontaspagar_input_2_ano#NMF#' + search_get_sel_txt('SC_datavencimentocontaspagar_input_2_ano') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_idfkcredorcontaspagar").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_idfkcredorcontaspagar",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_idfkcredorcontaspagar").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_idfkcredorcontaspagar").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Contas à Pagar/Pagas</span></td>
...
<?php
   ...
   {
      global 
             $idfkcredorcontaspagar_cond, $idfkcredorcontaspagar, $idfkcredorcontaspagar_autocomp,
             $datavencimentocontaspagar_cond, $datavencimentocontaspagar, $datavencimentocontaspagar_dia, $datavencimentocontaspagar_mes, $datavencimentocontaspagar_ano, $datavencimentocontaspagar_input_2_dia, $datavencimentocontaspagar_input_2_mes, $datavencimentocontaspagar_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idfkcredorcontaspagar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['idfkcredorcontaspagar']; 
          $idfkcredorcontaspagar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['idfkcredorcontaspagar_cond']; 
          $datavencimentocontaspagar_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_dia']; 
          $datavencimentocontaspagar_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_mes']; 
          $datavencimentocontaspagar_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_ano']; 
          $datavencimentocontaspagar_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_input_2_dia']; 
          $datavencimentocontaspagar_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_input_2_mes']; 
          $datavencimentocontaspagar_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_input_2_ano']; 
          $datavencimentocontaspagar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idfkcredorcontaspagar_cond) || empty($idfkcredorcontaspagar_cond))
      {
         $idfkcredorcontaspagar_cond = "eq";
      }
      if (!isset($datavencimentocontaspagar_cond) || empty($datavencimentocontaspagar_cond))
      {
         $datavencimentocontaspagar_cond = "bw";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_idfkcredorcontaspagar = (in_array($idfkcredorcontaspagar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_datavencimentocontaspagar = (in_array($datavencimentocontaspagar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_datavencimentocontaspagar = ('bw' == $datavencimentocontaspagar_cond) ? $display_aberto : $display_fechado;

      if (!isset($idfkcredorcontaspagar) || $idfkcredorcontaspagar == "")
      {
          $idfkcredorcontaspagar = "";
      }
      if (isset($idfkcredorcontaspagar) && !empty($idfkcredorcontaspagar))
      {
         $tmp_pos = strpos($idfkcredorcontaspagar, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idfkcredorcontaspagar = substr($idfkcredorcontaspagar, 0, $tmp_pos);
         }
      }
      if (!isset($datavencimentocontaspagar) || $datavencimentocontaspagar == "")
      {
          $datavencimentocontaspagar = "";
      }
      if (isset($datavencimentocontaspagar) && !empty($datavencimentocontaspagar))
      {
         $tmp_pos = strpos($datavencimentocontaspagar, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $datavencimentocontaspagar = substr($datavencimentocontaspagar, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_tbcontasPagar_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_idfkcredorcontaspagar_cond" name="idfkcredorcontaspagar_cond" value="eq">

    <TD nowrap class="scFilterLabelOdd css_idfkcredorcontaspagar_fil_label" > <?php
 $SC_Label = (isset($this->New_label['idfkcredorcontaspagar'])) ? $this->New_label['idfkcredorcontaspagar'] : "Credor";
 $nmgp_tab_label .= "idfkcredorcontaspagar?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_idfkcredorcontaspagar"  <?php echo $str_hide_idfkcredorcontaspagar?>><?php
      $idfkcredorcontaspagar_look = substr($this->Db->qstr($idfkcredorcontaspagar), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idfkcredorcontaspagar))
   { 
      $nm_comando = "select idCredor, nomeCredor from tbcredores where idCredor = $idfkcredorcontaspagar_look order by nomeCredor"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$idfkcredorcontaspagar]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idfkcredorcontaspagar];
      }
      else
      {
          $sAutocompValue = $idfkcredorcontaspagar;
      }
?>
<INPUT  type="text" id="SC_idfkcredorcontaspagar" name="idfkcredorcontaspagar" value="<?php echo NM_encode_input($idfkcredorcontaspagar) ?>" size=11 alt="{datatype: 'text', maxLength: 11, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idfkcredorcontaspagar" name="idfkcredorcontaspagar_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_datavencimentocontaspagar_cond" name="datavencimentocontaspagar_cond" value="bw">

    <TD nowrap class="scFilterLabelEven css_datavencimentocontaspagar_fil_label" > <?php
 $SC_Label = (isset($this->New_label['datavencimentocontaspagar'])) ? $this->New_label['datavencimentocontaspagar'] : "Vencimento";
 $nmgp_tab_label .= "datavencimentocontaspagar?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_datavencimentocontaspagar"  <?php echo $str_hide_datavencimentocontaspagar?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_datavencimentocontaspagar_dia" name="datavencimentocontaspagar_dia" value="<?php echo NM_encode_input($datavencimentocontaspagar_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datavencimentocontaspagar_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_datavencimentocontaspagar_mes" name="datavencimentocontaspagar_mes" value="<?php echo NM_encode_input($datavencimentocontaspagar_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datavencimentocontaspagar_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_datavencimentocontaspagar_ano" name="datavencimentocontaspagar_ano" value="<?php echo NM_encode_input($datavencimentocontaspagar_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
        <SPAN id="id_css_datavencimentocontaspagar"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_datavencimentocontaspagar"  <?php echo $str_display_datavencimentocontaspagar; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_datavencimentocontaspagar_input_2_dia" name="datavencimentocontaspagar_input_2_dia" value="<?php echo NM_encode_input($datavencimentocontaspagar_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datavencimentocontaspagar_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_datavencimentocontaspagar_input_2_mes" name="datavencimentocontaspagar_input_2_mes" value="<?php echo NM_encode_input($datavencimentocontaspagar_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datavencimentocontaspagar_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_datavencimentocontaspagar_input_2_ano" name="datavencimentocontaspagar_input_2_ano" value="<?php echo NM_encode_input($datavencimentocontaspagar_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbcontasPagar']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbcontasPagar']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_idfkcredorcontaspagar'), document.F1.idfkcredorcontaspagar_cond, 'idfkcredorcontaspagar');
   document.F1.idfkcredorcontaspagar.value = "";
   document.F1.idfkcredorcontaspagar_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_datavencimentocontaspagar'), document.F1.datavencimentocontaspagar_cond, 'datavencimentocontaspagar');
   document.F1.datavencimentocontaspagar_dia.value = "";
   document.F1.datavencimentocontaspagar_mes.value = "";
   document.F1.datavencimentocontaspagar_ano.value = "";
   document.F1.datavencimentocontaspagar_input_2_dia.value = "";
   document.F1.datavencimentocontaspagar_input_2_mes.value = "";
   document.F1.datavencimentocontaspagar_input_2_ano.value = "";
 }
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_datavencimentocontaspagar_dia').bind('change', function() {sc_grid_tbcontasPagar_valida_dia(this)});
    $('#SC_datavencimentocontaspagar_input_2_dia').bind('change', function() {sc_grid_tbcontasPagar_valida_dia(this)});
    $('#SC_datavencimentocontaspagar_input_2_mes').bind('change', function() {sc_grid_tbcontasPagar_valida_mes(this)});
    $('#SC_datavencimentocontaspagar_mes').bind('change', function() {sc_grid_tbcontasPagar_valida_mes(this)});
 }
 function sc_grid_tbcontasPagar_valida_dia(obj)
 {
 ...
 function sc_grid_tbcontasPagar_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "LocarVeiculos/grid_tbcontasPagar";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_idfkcredorcontaspagar_cond'] = 'cond';
      $tp_fields['SC_idfkcredorcontaspagar'] = 'text_aut';
      $tp_fields['id_ac_idfkcredorcontaspagar'] = 'text_aut';
      $tp_fields['SC_datavencimentocontaspagar_cond'] = 'cond';
      $tp_fields['SC_datavencimentocontaspagar_dia'] = 'text';
      $tp_fields['SC_datavencimentocontaspagar_mes'] = 'text';
      $tp_fields['SC_datavencimentocontaspagar_ano'] = 'text';
      $tp_fields['SC_datavencimentocontaspagar_input_2_dia'] = 'text';
      $tp_fields['SC_datavencimentocontaspagar_input_2_mes'] = 'text';
      $tp_fields['SC_datavencimentocontaspagar_input_2_ano'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $idfkcredorcontaspagar_cond, $idfkcredorcontaspagar, $idfkcredorcontaspagar_autocomp,
             $datavencimentocontaspagar_cond, $datavencimentocontaspagar, $datavencimentocontaspagar_dia, $datavencimentocontaspagar_mes, $datavencimentocontaspagar_ano, $datavencimentocontaspagar_input_2_dia, $datavencimentocontaspagar_input_2_mes, $datavencimentocontaspagar_input_2_ano, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($idfkcredorcontaspagar_autocomp) && empty($idfkcredorcontaspagar))
      {
          $idfkcredorcontaspagar = $idfkcredorcontaspagar_autocomp;
      }
      $idfkcredorcontaspagar_cond_salva = $idfkcredorcontaspagar_cond; 
      if (!isset($idfkcredorcontaspagar_input_2) || $idfkcredorcontaspagar_input_2 == "")
      {
          $idfkcredorcontaspagar_input_2 = $idfkcredorcontaspagar;
      }
      $datavencimentocontaspagar_cond_salva = $datavencimentocontaspagar_cond; 
      if (!isset($datavencimentocontaspagar_input_2_dia) || $datavencimentocontaspagar_input_2_dia == "")
      {
          $datavencimentocontaspagar_input_2_dia = $datavencimentocontaspagar_dia;
      }
      if (!isset($datavencimentocontaspagar_input_2_mes) || $datavencimentocontaspagar_input_2_mes == "")
      {
          $datavencimentocontaspagar_input_2_mes = $datavencimentocontaspagar_mes;
      }
      if (!isset($datavencimentocontaspagar_input_2_ano) || $datavencimentocontaspagar_input_2_ano == "")
      {
          $datavencimentocontaspagar_input_2_ano = $datavencimentocontaspagar_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['idfkcredorcontaspagar'] = $idfkcredorcontaspagar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['idfkcredorcontaspagar_cond'] = $idfkcredorcontaspagar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_dia'] = $datavencimentocontaspagar_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_mes'] = $datavencimentocontaspagar_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_ano'] = $datavencimentocontaspagar_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_input_2_dia'] = $datavencimentocontaspagar_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_input_2_mes'] = $datavencimentocontaspagar_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_input_2_ano'] = $datavencimentocontaspagar_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_cond'] = $datavencimentocontaspagar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($idfkcredorcontaspagar_cond != "in" && $idfkcredorcontaspagar_cond != "bw" && !empty($idfkcredorcontaspagar) && !is_numeric($idfkcredorcontaspagar))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Credor";
      }
      if ($idfkcredorcontaspagar_cond == "bw" && ((!empty($idfkcredorcontaspagar) && !is_numeric($idfkcredorcontaspagar)) || (!empty($idfkcredorcontaspagar_input_2) && !is_numeric($idfkcredorcontaspagar_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Credor";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idfkcredorcontaspagar'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idfkcredorcontaspagar'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['idfkcredorcontaspagar'] = $idfkcredorcontaspagar;
      }

      //----- $idfkcredorcontaspagar
      $this->Date_part = false;
      if (isset($idfkcredorcontaspagar) || $idfkcredorcontaspagar_cond == "nu" || $idfkcredorcontaspagar_cond == "nn" || $idfkcredorcontaspagar_cond == "ep" || $idfkcredorcontaspagar_cond == "ne")
      {
         $this->monta_condicao("idFKCredorContasPagar", $idfkcredorcontaspagar_cond, $idfkcredorcontaspagar, "", "idfkcredorcontaspagar");
      }

      //----- $datavencimentocontaspagar
      $this->Date_part = false;
      if ($datavencimentocontaspagar_cond != "TP")
      {
          $datavencimentocontaspagar_cond = strtoupper($datavencimentocontaspagar_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $datavencimentocontaspagar_ano;
          $Dtxt .= $datavencimentocontaspagar_mes;
          $Dtxt .= $datavencimentocontaspagar_dia;
          $val[0]['ano'] = $datavencimentocontaspagar_ano;
          $val[0]['mes'] = $datavencimentocontaspagar_mes;
          $val[0]['dia'] = $datavencimentocontaspagar_dia;
          if ($datavencimentocontaspagar_cond == "BW")
          {
              $val[1]['ano'] = $datavencimentocontaspagar_input_2_ano;
              $val[1]['mes'] = $datavencimentocontaspagar_input_2_mes;
              $val[1]['dia'] = $datavencimentocontaspagar_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $datavencimentocontaspagar_cond , "");
          $datavencimentocontaspagar = $val[0];
          $this->cmp_formatado['datavencimentocontaspagar'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['datavencimentocontaspagar'], "YYYY-MM-DD");
          $this->cmp_formatado['datavencimentocontaspagar'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($datavencimentocontaspagar_cond == "BW")
          {
              $datavencimentocontaspagar_input_2     = $val[1];
              $this->cmp_formatado['datavencimentocontaspagar_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']['datavencimentocontaspagar_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['datavencimentocontaspagar_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['datavencimentocontaspagar_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $datavencimentocontaspagar_cond == "NU" || $datavencimentocontaspagar_cond == "NN"|| $datavencimentocontaspagar_cond == "EP"|| $datavencimentocontaspagar_cond == "NE")
          {
              $this->monta_condicao("dataVencimentoContasPagar", $datavencimentocontaspagar_cond, $datavencimentocontaspagar, $datavencimentocontaspagar_input_2, 'datavencimentocontaspagar', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['where_pesq_ant'] = $this->comando . $this->comando_fim;
...
{
    global $datavencimentocontaspagar, $idfkcredorcontaspagar;
$_SESSION['scriptcase']['grid_tbcontasPagar']['contr_erro'] = 'on';
     


$current_date = date('Y-m-d');
$amount_days  = $this->nm_data->Dif_Datas($datavencimentocontaspagar , 'aaaa-mm-dd', $current_date, 'aaaa-mm-dd');

if($amount_days  < 2 && $quitadocontaspagar  == 0)
{
...
elseif($amount_days  == 2 && $quitadocontaspagar  == 0)
{
...
$vencimento = $this->nm_conv_data_db($datavencimentocontaspagar ,"aaaa-mm-dd","ddmmaaaa");
$hoje = date('dmY');
$diasAviso = $diasaviso ;
$numeroParcela = $ordemparcelacontaspagar ;
$idCredor = $idfkcredorcontaspagar ;
$valorParcela = $valorcontaspagar ;
...
if($diasRestante <= $diasAviso &&$quitadocontaspagar  == 0)
	{
