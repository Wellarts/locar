...
<?php
include_once("form_tblocacao_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tblocacao_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-idfkclientelocacao", elem).focus(function() {
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'idfkclientelocacao' != sId ? sId.substr(18) : '';
    if ("" == $(this).val()) {
     do_ajax_form_tblocacao_event_idfkclientelocacao_onchange(sRow);
    }
   },
  ...
  $(".sc-ui-autocomp-idfkveiculolocacao", elem).focus(function() {
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'idfkveiculolocacao' != sId ? sId.substr(18) : '';
    if ("" == $(this).val()) {
     do_ajax_form_tblocacao_event_idfkveiculolocacao_onchange(sRow);
    }
   },
   select: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'idfkveiculolocacao' != sId ? sId.substr(18) : '';
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['recarga'];
}
?>
...
<?php
 include_once("form_tblocacao_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tblocacao'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tblocacao'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tblocacao_empty.htm' : $this->Ini->link_form_tbmultasAvarias_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y');
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblocacao']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_tblocacao");
 parent.scAjaxDetailHeight("form_tblocacao", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
