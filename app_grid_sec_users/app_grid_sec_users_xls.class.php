...
class app_grid_sec_users_xls
{
   ...
   var $Tit_doc;
   //---- 
   function app_grid_sec_users_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "app_grid_sec_users.xls";
   ...
   function NM_export_priv_admin()
   {
         ...
         if (!NM_is_utf8($this->look_priv_admin))
         {
             $this->look_priv_admin = sc_convert_encoding($this->look_priv_admin, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->look_priv_admin, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
