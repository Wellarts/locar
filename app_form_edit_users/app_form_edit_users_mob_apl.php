...
//----- 
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
      ...
      $_SESSION['scriptcase']['error_icon']['app_form_edit_users_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'app_form_edit_users_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'app_form_edit_users_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['reg_start'] = $rsc->fields[0];
      $rsc->Close();
   }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_login = $this->login;
               ...
               /* sec_users_apps */
      $sc_cmd_dependency = "DELETE FROM sec_users_apps WHERE login = '" . $this->login  . "'";
...
$_SESSION['scriptcase']['app_form_edit_users_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->priv_admin = $this->priv_admin_before_qstr;
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'pswd', 'confirm_pswd', 'name', 'email', 'active'), $aDoNotUpdate);
              $this->ajax_return_values();
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
   ...
   $sql = "INSERT INTO sec_users_apps(login, app_name)
	     SELECT '". $this->login ."', app_name FROM sec_apps ";
...
$mail_smtp_server = '';        
$mail_smtp_user = 'wellington';                   
$mail_smtp_pass = 'well287082';			
$mail_from = '';          
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan'])
   {
