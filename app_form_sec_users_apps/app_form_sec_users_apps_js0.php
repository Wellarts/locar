<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="login_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['login_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="app_form_sec_users_apps"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_app_form_sec_users_apps_submit_form(y, z); 
} 
<?php
}
?>
