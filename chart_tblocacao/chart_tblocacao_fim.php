...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____chart_tblocacao"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LocarVeiculos_____chart_tblocacao"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_tblocacao']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_tblocacao']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_tblocacao']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_tblocacao']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_tblocacao']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_tblocacao']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_tblocacao']['embutida_filho'] as $ind => $sc_init)
          {
