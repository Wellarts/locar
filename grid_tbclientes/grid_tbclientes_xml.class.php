...
class grid_tbclientes_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_tbclientes.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_tbclientes";
   ...
   function NM_export_idcliente()
   {
         ...
         $this->xml_registro .= " idcliente =\"" . $this->trata_dados($this->idcliente) . "\"";
   }
   //----- nomecliente
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->enderecocliente))
         {
             $this->enderecocliente = sc_convert_encoding($this->enderecocliente, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " enderecocliente =\"" . $this->trata_dados($this->enderecocliente) . "\"";
   }
   //----- cpfcliente
   ...
   function NM_export_idfkestadocliente()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_idfkestadocliente))
         {
             $this->look_idfkestadocliente = sc_convert_encoding($this->look_idfkestadocliente, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " idfkestadocliente =\"" . $this->trata_dados($this->look_idfkestadocliente) . "\"";
   }
   //----- idfkcidadecliente
   function NM_export_idfkcidadecliente()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_idfkcidadecliente))
         {
             $this->look_idfkcidadecliente = sc_convert_encoding($this->look_idfkcidadecliente, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " idfkcidadecliente =\"" . $this->trata_dados($this->look_idfkcidadecliente) . "\"";
   }
   //----- fonecliente
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbclientes']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Consultas de Clientes :: XML</TITLE>
