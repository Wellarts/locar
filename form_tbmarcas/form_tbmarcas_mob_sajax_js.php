  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbmarcas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idmarca
  function do_ajax_form_tbmarcas_mob_validate_idmarca()
  {
    var nomeCampo_idmarca = "idmarca";
    var var_idmarca = scAjaxGetFieldHidden(nomeCampo_idmarca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbmarcas_mob_validate_idmarca(var_idmarca, var_script_case_init, do_ajax_form_tbmarcas_mob_validate_idmarca_cb);
  } // do_ajax_form_tbmarcas_mob_validate_idmarca

  function do_ajax_form_tbmarcas_mob_validate_idmarca_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbmarcas_mob_validate_idmarca_cb

  // ---------- Validate nomemarca
  function do_ajax_form_tbmarcas_mob_validate_nomemarca()
  {
    var nomeCampo_nomemarca = "nomemarca";
    var var_nomemarca = scAjaxGetFieldText(nomeCampo_nomemarca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbmarcas_mob_validate_nomemarca(var_nomemarca, var_script_case_init, do_ajax_form_tbmarcas_mob_validate_nomemarca_cb);
  } // do_ajax_form_tbmarcas_mob_validate_nomemarca

  function do_ajax_form_tbmarcas_mob_validate_nomemarca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nomemarca";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbmarcas_mob_validate_nomemarca_cb
  // ---------- Form
  function do_ajax_form_tbmarcas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbmarcas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idmarca = scAjaxGetFieldHidden("idmarca");
    var var_nomemarca = scAjaxGetFieldText("nomemarca");
    ...
    scAjaxProcOn();
    x_ajax_form_tbmarcas_mob_submit_form(var_idmarca, var_nomemarca, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbmarcas_mob_submit_form_cb);
  } // do_ajax_form_tbmarcas_mob_submit_form

  function do_ajax_form_tbmarcas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idmarca");
      scAjaxHideErrorDisplay("nomemarca");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_tbmarcas_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbmarcas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idmarca");
    scAjaxHideErrorDisplay("nomemarca");
    var var_idmarca = document.F2.idmarca.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbmarcas_mob_navigate_form(var_idmarca, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbmarcas_mob_navigate_form_cb);
  } // do_ajax_form_tbmarcas_mob_navigate_form

  function do_ajax_form_tbmarcas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tbmarcas_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idmarca.value = scAjaxGetKeyValue("idmarca");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tbmarcas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbmarcas_mob_navigate_form_cb
  function sc_hide_form_tbmarcas_mob_form()
  {
  ...
  ajax_field_list[0] = "idmarca";
  ajax_field_list[1] = "nomemarca";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idmarca": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nomemarca": {"label": "Marca", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["idmarca"][1] = "idmarca";
  ajax_field_mult["nomemarca"][1] = "nomemarca";

  var ajax_field_id = {
    "idmarca": new Array("hidden_field_label_idmarca", "hidden_field_data_idmarca"),
    "nomemarca": new Array("hidden_field_label_nomemarca", "hidden_field_data_nomemarca")
  };
