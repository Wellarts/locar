  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbcredores_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idcredor
  function do_ajax_form_tbcredores_mob_validate_idcredor()
  {
    var nomeCampo_idcredor = "idcredor";
    var var_idcredor = scAjaxGetFieldHidden(nomeCampo_idcredor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbcredores_mob_validate_idcredor(var_idcredor, var_script_case_init, do_ajax_form_tbcredores_mob_validate_idcredor_cb);
  } // do_ajax_form_tbcredores_mob_validate_idcredor

  function do_ajax_form_tbcredores_mob_validate_idcredor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idcredor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbcredores_mob_validate_idcredor_cb

  // ---------- Validate nomecredor
  function do_ajax_form_tbcredores_mob_validate_nomecredor()
  {
    var nomeCampo_nomecredor = "nomecredor";
    var var_nomecredor = scAjaxGetFieldText(nomeCampo_nomecredor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbcredores_mob_validate_nomecredor(var_nomecredor, var_script_case_init, do_ajax_form_tbcredores_mob_validate_nomecredor_cb);
  } // do_ajax_form_tbcredores_mob_validate_nomecredor

  function do_ajax_form_tbcredores_mob_validate_nomecredor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nomecredor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbcredores_mob_validate_nomecredor_cb
  // ---------- Form
  function do_ajax_form_tbcredores_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbcredores_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcredor = scAjaxGetFieldHidden("idcredor");
    var var_nomecredor = scAjaxGetFieldText("nomecredor");
    ...
    scAjaxProcOn();
    x_ajax_form_tbcredores_mob_submit_form(var_idcredor, var_nomecredor, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbcredores_mob_submit_form_cb);
  } // do_ajax_form_tbcredores_mob_submit_form

  function do_ajax_form_tbcredores_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcredor");
      scAjaxHideErrorDisplay("nomecredor");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_tbcredores_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbcredores_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idcredor");
    scAjaxHideErrorDisplay("nomecredor");
    var var_idcredor = document.F2.idcredor.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbcredores_mob_navigate_form(var_idcredor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbcredores_mob_navigate_form_cb);
  } // do_ajax_form_tbcredores_mob_navigate_form

  function do_ajax_form_tbcredores_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tbcredores_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idcredor.value = scAjaxGetKeyValue("idcredor");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tbcredores_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbcredores_mob_navigate_form_cb
  function sc_hide_form_tbcredores_mob_form()
  {
  ...
  ajax_field_list[0] = "idcredor";
  ajax_field_list[1] = "nomecredor";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idcredor": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nomecredor": {"label": "Nome", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idcredor": new Array(),
    "nomecredor": new Array()
  };
  ajax_field_mult["idcredor"][1] = "idcredor";
  ajax_field_mult["nomecredor"][1] = "nomecredor";

  var ajax_field_id = {
    "idcredor": new Array("hidden_field_label_idcredor", "hidden_field_data_idcredor"),
    "nomecredor": new Array("hidden_field_label_nomecredor", "hidden_field_data_nomecredor")
  };
