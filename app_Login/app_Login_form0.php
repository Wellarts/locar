...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<table style="border-collapse: collapse; border-width: 0px">
 ...
 ?>
<img id="id_captcha_img" src="app_Login_captcha_show.php?sid=<?php echo md5(uniqid(time())); ?>" /></td>
