...
$old_error_handler = set_error_handler("app_form_sec_users_apps_scriptcase_error_handler");

function app_form_sec_users_apps_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['app_form_sec_users_apps']['contr_erro']) && $_SESSION['scriptcase']['app_form_sec_users_apps']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_app_form_sec_users_apps->contr_app_form_sec_users_apps->Apl_com_erro = true;
            if ($inicial_app_form_sec_users_apps->contr_app_form_sec_users_apps->NM_ajax_flag)
            {
                $inicial_app_form_sec_users_apps->contr_app_form_sec_users_apps->NM_ajax_info['errList']['geral_app_form_sec_users_apps'][] = $msg;
                return;
            }
            app_form_sec_users_apps_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function app_form_sec_users_apps_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['app_form_sec_users_apps'])  && '' != $_SESSION['scriptcase']['error_icon']['app_form_sec_users_apps'])  ? $_SESSION['scriptcase']['error_icon']['app_form_sec_users_apps']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['app_form_sec_users_apps']) && '' != $_SESSION['scriptcase']['error_span_title']['app_form_sec_users_apps']) ? $_SESSION['scriptcase']['error_span_title']['app_form_sec_users_apps'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['app_form_sec_users_apps']) && '' != $_SESSION['scriptcase']['error_icon_title']['app_form_sec_users_apps']) ? $_SESSION['scriptcase']['error_icon_title']['app_form_sec_users_apps'] : '';
?>
