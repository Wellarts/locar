...
class grid_tblucratividade_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_tblucratividade_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_tblucratividade.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_tblucratividade";
   ...
   function NM_export_idfkveiculo()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_idfkveiculo))
         {
             $this->look_idfkveiculo = sc_convert_encoding($this->look_idfkveiculo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " idfkveiculo =\"" . $this->trata_dados($this->look_idfkveiculo) . "\"";
   }
   //----- datadiaria
   function NM_export_datadiaria()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->datadiaria))
         {
             $this->datadiaria = sc_convert_encoding($this->datadiaria, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " datadiaria =\"" . $this->trata_dados($this->datadiaria) . "\"";
   }
   //----- valordiaria
   function NM_export_valordiaria()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->valordiaria))
         {
             $this->valordiaria = sc_convert_encoding($this->valordiaria, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " valordiaria =\"" . $this->trata_dados($this->valordiaria) . "\"";
   }
   //----- idlucratividade
   function NM_export_idlucratividade()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->idlucratividade))
         {
             $this->idlucratividade = sc_convert_encoding($this->idlucratividade, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " idlucratividade =\"" . $this->trata_dados($this->idlucratividade) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblucratividade']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Valores - Locações :: XML</TITLE>
