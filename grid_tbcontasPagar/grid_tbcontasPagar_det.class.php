...
class grid_tbcontasPagar_det
{
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['sub_dir'] = array(); 
   ...
   $parms_det = explode("*PDet*", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['chave_det']) ; 
   ...
   $nmgp_select .= " where  idContasPagar = $parms_det[0]" ;  
   ...
   $this->Lookup->lookup_quitadocontaspagar($this->quitadocontaspagar); 
...
$_SESSION['scriptcase']['grid_tbcontasPagar']['contr_erro'] = 'off'; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['cmp_acum']);
...
//--- 
   ...
   if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
   ...
   else
   {
       ...
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_tbcontasPagar/grid_tbcontasPagar_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"scGridHeaderFont\"><span>Contas à Pagar/Pagas</span></td>\r\n");
   ...
   $nm_saida->saida("  </TD>\r\n");
   $nm_saida->saida(" </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['pdf_det']) 
   { 
       $nm_saida->saida("   <tr><td class=\"scGridTabelaTd\">\r\n");
       ...
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_tbcontasPagar/grid_tbcontasPagar_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=1&orientacao=1&largura=1200&conf_larg=S&conf_fonte=10&language=pt_br&conf_socor=S&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
       if ($this->nmgp_botoes['det_print'] == "on")
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_tbcontasPagar/grid_tbcontasPagar_config_print.php?nm_opc=detalhe&nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
   ...
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          ...
          $conteudo = trim(NM_encode_input(sc_strip_script($this->idcontaspagar))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_idcontaspagar_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_idcontaspagar_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['idfkcredorcontaspagar'])) ? $this->New_label['idfkcredorcontaspagar'] : "Credor"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->idfkcredorcontaspagar))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
          $this->Lookup->lookup_idfkcredorcontaspagar($conteudo , $this->idfkcredorcontaspagar) ; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_idfkcredorcontaspagar_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_idfkcredorcontaspagar_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['datavencimentocontaspagar'])) ? $this->New_label['datavencimentocontaspagar'] : "Vencimento"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->datavencimentocontaspagar))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_datavencimentocontaspagar_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_datavencimentocontaspagar_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['datapagamentocontaspagar'])) ? $this->New_label['datapagamentocontaspagar'] : "Pagamento"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->datapagamentocontaspagar))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_datapagamentocontaspagar_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_datapagamentocontaspagar_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['valorcontaspagar'])) ? $this->New_label['valorcontaspagar'] : "Valor da Parcela"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->valorcontaspagar))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_valorcontaspagar_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_valorcontaspagar_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['valorpagocontaspagar'])) ? $this->New_label['valorpagocontaspagar'] : "Valor Pago"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->valorpagocontaspagar))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_valorpagocontaspagar_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_valorpagocontaspagar_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['qtdparcelascontaspagar'])) ? $this->New_label['qtdparcelascontaspagar'] : "Qtd de Parcelas"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->qtdparcelascontaspagar))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_qtdparcelascontaspagar_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_qtdparcelascontaspagar_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['ordemparcelacontaspagar'])) ? $this->New_label['ordemparcelacontaspagar'] : "Parcela"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->ordemparcelacontaspagar))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_ordemparcelacontaspagar_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_ordemparcelacontaspagar_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['quitadocontaspagar'])) ? $this->New_label['quitadocontaspagar'] : "Pago?"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->quitadocontaspagar))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_quitadocontaspagar_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_quitadocontaspagar_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['obscontaspagar'])) ? $this->New_label['obscontaspagar'] : "Observações"; 
          $conteudo = trim(sc_strip_script($this->obscontaspagar)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_obscontaspagar_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_obscontaspagar_det_line\"   ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['diasaviso'])) ? $this->New_label['diasaviso'] : "Dias Aviso"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->diasaviso))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_diasaviso_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_diasaviso_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("</TABLE>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['pdf_det']) 
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"grid_tbcontasPagar_doc.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nm_cod_doc=\" + campo1 + \"&nm_nome_doc=\" + campo2 + \"&nm_cod_apl=\" + campo3, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   $nm_saida->saida("   function nm_gp_move(x, y, z, p, g) \r\n");
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_tbcontasPagar/index.php?nmgp_opcao=pdf_det&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p +  \"&nmgp_graf_pdf=\" + g + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "\";\r\n");
   $nm_saida->saida("   }\r\n");
