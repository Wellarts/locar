<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_tbmultasAvarias_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tbmultasAvarias_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['datamultaavarias'] = "on";
   $tab_def_campos['datamultaavarias'] = "dataMultaAvarias";
   $tab_converte["dataMultaAvarias"]   = "datamultaavarias";
   $tab_labels["datamultaavarias"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['labels']["datamultaavarias"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['labels']["datamultaavarias"] : "Data";
   $tab_ger_campos['descricaomultasavarias'] = "on";
   $tab_def_campos['descricaomultasavarias'] = "descricaoMultasAvarias";
   $tab_converte["descricaoMultasAvarias"]   = "descricaomultasavarias";
   $tab_labels["descricaomultasavarias"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['labels']["descricaomultasavarias"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['labels']["descricaomultasavarias"] : "Descrição";
   $tab_ger_campos['valormultasavarias'] = "on";
   $tab_def_campos['valormultasavarias'] = "valorMultasAvarias";
   $tab_converte["valorMultasAvarias"]   = "valormultasavarias";
   $tab_labels["valormultasavarias"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['labels']["valormultasavarias"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['labels']["valormultasavarias"] : "Valor";
   $tab_ger_campos['pagomultasavarias'] = "on";
   $tab_def_campos['pagomultasavarias'] = "pagoMultasAvarias";
   $tab_converte["pagoMultasAvarias"]   = "pagomultasavarias";
   $tab_labels["pagomultasavarias"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['labels']["pagomultasavarias"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['labels']["pagomultasavarias"] : "Pago";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - tbmultasAvarias</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tbmultasAvarias_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tbmultasAvarias']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
