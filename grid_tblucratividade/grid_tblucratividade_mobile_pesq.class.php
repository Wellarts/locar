...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "datadiaria";$Nm_numeric[] = "idlucratividade";$Nm_numeric[] = "idfklocacao";$Nm_numeric[] = "valordiaria";$Nm_numeric[] = "idfkveiculo";
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
    ...
    <TD nowrap class="scFilterLabelOdd css_idfklocacao_fil_label" > <?php
 $SC_Label = (isset($this->New_label['idfklocacao'])) ? $this->New_label['idfklocacao'] : "Locação";
 $nmgp_tab_label .= "idfklocacao?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_idfklocacao"  <?php echo $str_hide_idfklocacao?>><INPUT  type="text" id="SC_idfklocacao" name="idfklocacao" value="<?php echo NM_encode_input($idfklocacao) ?>" size=11 alt="{datatype: 'text', maxLength: 11, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
