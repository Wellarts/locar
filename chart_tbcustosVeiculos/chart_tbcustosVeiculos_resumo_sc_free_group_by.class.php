...
class chart_tbcustosVeiculos_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_datacustoveiculo;
   var $array_total_idfkveiculocustoveiculo;
   var $array_total_valorcustoveiculo;
   ...
   var $sc_proc_quebra_datacustoveiculo;
   var $count_datacustoveiculo;
   var $sum_datacustoveiculo_valorcustoveiculo;
   var $sc_proc_quebra_idfkveiculocustoveiculo;
   var $count_idfkveiculocustoveiculo;
   var $sum_idfkveiculocustoveiculo_valorcustoveiculo;
   var $sc_proc_quebra_valorcustoveiculo;
   var $count_valorcustoveiculo;
   var $sum_valorcustoveiculo_valorcustoveiculo;

   //---- 
   function chart_tbcustosVeiculos_resumo($tipo = "")
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_tbcustosVeiculos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_tbcustosVeiculos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_tbcustosVeiculos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['where_pesq_filtro'];
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_type']        = 'combination3d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_combination_order_field'] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_y_axys'][1] = 1;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_y_axys'][2] = 2;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_cmp']["datacustoveiculo"] = 'datacustoveiculo';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_cmp']["idfkveiculocustoveiculo"] = 'idfkveiculocustoveiculo';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_cmp']["valorcustoveiculo"] = 'valorcustoveiculo';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_sql']["dataCustoVeiculo"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_sql']["idFKveiculoCustoVeiculo"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_sql']["valorCustoVeiculo"] = 'asc';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_field_display_type'][2] = 'line';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_display_values'][2] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][2]['display'] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_order'][] = 2;
       }

      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['ajax_nav'])
      {
          $_SESSION['scriptcase']['saida_var'] = false; 
      }
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("chart_tbcustosVeiculos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['contr_total_geral'] == "OK")
      {
          $this->array_total_datacustoveiculo = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['arr_total']['datacustoveiculo'];
          $this->array_total_idfkveiculocustoveiculo = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['arr_total']['idfkveiculocustoveiculo'];
          $this->array_total_valorcustoveiculo = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['arr_total']['valorcustoveiculo'];
      }
      else
      {
          $this->array_total_datacustoveiculo = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['arr_total']['datacustoveiculo'] = $this->array_total_datacustoveiculo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['arr_total']['idfkveiculocustoveiculo'] = $this->array_total_idfkveiculocustoveiculo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['arr_total']['valorcustoveiculo'] = $this->array_total_valorcustoveiculo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['datacustoveiculo'] = "Data";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['labels'][''] = "Data"; 
       $prep_field['idfkveiculocustoveiculo'] = "Veículo";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['labels'][''] = "Veículo"; 
       $prep_field['valorcustoveiculo'] = "Valor";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['labels'][''] = "Valor"; 
       $Str_gb = "";
       ...
       //-----
       $this->comp_sum = array(
           2 => "Valor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_control'] = array(
               'valorcustoveiculo' => array(
                   'label' => "Valor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
                   'label_field' => "Valor",
                   'options' => array(
                       array('op' => 'S', 'index' => '2', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "", 'abbrev' => "Sum"),
                   ),
                   'select' => "<select class=\"sc-ui-select-valorcustoveiculo\" onChange=\"scSummChange($(this))\"><option value=\"2\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
           );
       }
       //-----
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "valorcustoveiculo", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_valorcustoveiculo_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['idfkveiculocustoveiculo']['alin'] = "''";
       $Arr_parms['idfkveiculocustoveiculo']['link'] = "N";
       $Arr_parms['datacustoveiculo']['alin'] = "''";
       $Arr_parms['datacustoveiculo']['link'] = "N";
       $Arr_parms['valorcustoveiculo']['alin'] = "''";
       $Arr_parms['valorcustoveiculo']['link'] = "N";
       $Arr_parms['datacustoveiculo']['fill'] = "true";
       $Arr_parms['datacustoveiculo']['order'] = "value";
       $Arr_parms['idfkveiculocustoveiculo']['fill'] = "true";
       $Arr_parms['idfkveiculocustoveiculo']['order'] = "value";
       $Arr_parms['valorcustoveiculo']['fill'] = "true";
       $Arr_parms['valorcustoveiculo']['order'] = "value";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['idfkveiculocustoveiculo'] = array(0 => 'idfkveiculocustoveiculo', 1 => '');
       $prep_links_fl['datacustoveiculo'] = array(0 => 'datacustoveiculo', 1 => '@aspass@');
       $prep_links_fl['valorcustoveiculo'] = array(0 => 'valorcustoveiculo', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'idfkveiculocustoveiculo' => array(
           '1' => array(
               'title'    => $this->getChartText("Valor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Veículo"),
               'label_y'  => $this->getChartText("Valor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           'datacustoveiculo' => array(
           '1' => array(
               'title'    => $this->getChartText("Valor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Data"),
               'label_y'  => $this->getChartText("Valor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Valor"),
               'label_y'  => $this->getChartText("Valor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['summarizing_fields_order'] as $i_summ_order)
       {
       ...
       foreach ($this->comp_chart_data as $s_chart_index => $a_chart_data)
       {
           ...
           $i_index_group = $a_index_parts[0];
           $i_index_summ  = $a_index_parts[1];
           $s_index_param = str_replace('|', '-', substr($s_chart_index, 4));
           $s_index_comb  = str_replace('|', '_', substr($s_chart_index, 4));
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_tbcustosVeiculos_' . session_id() . '_C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__.xml' : '',
                               'xml'         => 'sc_chart_tbcustosVeiculos_' . session_id() . '_C_' . $i_index_group . '_' . $s_index_comb . '.xml',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_chart_tbcustosVeiculos_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_chart_tbcustosVeiculos_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_tbcustosVeiculos']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_tbcustosVeiculos']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_tbcustosVeiculos']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_tbcustosVeiculos']) . "_";
               } 
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_tbcustosVeiculos_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] = "print";
      ...
      $this->total   = new chart_tbcustosVeiculos_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_datacustoveiculo, $this->array_total_idfkveiculocustoveiculo, $this->array_total_valorcustoveiculo);
      ksort($this->array_total_datacustoveiculo);
      ksort($this->array_total_idfkveiculocustoveiculo);
      ksort($this->array_total_valorcustoveiculo);
      $this->total->quebra_geral();
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_tbcustosVeiculos_ajax.js\"></script>\r\n");
      include_once($this->Ini->Apl_grafico);
      $sFusionChartModule = chart_tbcustosVeiculos_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = chart_tbcustosVeiculos_grafico::getChartModule('Bar');
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_tbcustosVeiculos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_tbcustosVeiculos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_tbcustosVeiculos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_tbcustosVeiculos/chart_tbcustosVeiculos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['embutida'])
      {
   ...
   $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsort_on", "scShowSort('#chart_sort_on_top')", "scShowSort('#chart_sort_on_top')", "chart_sort_on_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid) && !$this->NM_res_sem_reg)
      {
            ...
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_pizza", "scChangeChartTypeButton('pie2d')", "scChangeChartTypeButton('pie2d')", "chart_pizza_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_pizza_top').css('display', 'none');\$('#chart_pizza_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_pizza_on", "scChangeChartTypeButton('pie2d')", "scChangeChartTypeButton('pie2d')", "chart_pizza_on_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'pie'){\$('#chart_pizza_on_top').css('display', 'none');\$('#chart_pizza_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
            ...
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_combo", "scChangeChartTypeButton('combination3d')", "scChangeChartTypeButton('combination3d')", "chart_combo_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_combo_top').css('display', 'none');\$('#chart_combo_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_combo_on", "scChangeChartTypeButton('combination3d')", "scChangeChartTypeButton('combination3d')", "chart_combo_on_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'combo'){\$('#chart_combo_on_top').css('display', 'none');\$('#chart_combo_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_tbcustosVeiculos/chart_tbcustosVeiculos_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=pt_br&conf_socor=S&is_chart_app=Y&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_tbcustosVeiculos/chart_tbcustosVeiculos_config_print.php?nm_opc=resumo&nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
         ...
         if (is_file("chart_tbcustosVeiculos_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_tbcustosVeiculos_help.txt"); 
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_tbcustosVeiculos_config_pivot.php?nome_apl=chart_tbcustosVeiculos&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_tbcustosVeiculos_iframe_params'] = array(
      ...
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "chart_tbcustosVeiculos/chart_tbcustosVeiculos_iframe.php?scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_tbcustosVeiculos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_tbcustosVeiculos/chart_tbcustosVeiculos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts']);
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_tbcustosVeiculos_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_valorcustoveiculo, $quebra_datacustoveiculo, $quebra_idfkveiculocustoveiculo, $quebra_valorcustoveiculo, $quebra_datacustoveiculo_orig, $quebra_idfkveiculocustoveiculo_orig, $quebra_valorcustoveiculo_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (empty($sum_valorcustoveiculo)) {$sum_valorcustoveiculo = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_valorcustoveiculo . ';
              $this->' . $arr_name . '[2] = "' . $$cmp_look . '";
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_tbcustosVeiculos']['where_pesq']; 
     $temp = "";
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->idcustoveiculo = $rs_res->fields[0] ;  
            $this->idfkveiculocustoveiculo = $rs_res->fields[1] ;  
            $this->datacustoveiculo = $rs_res->fields[2] ;  
            $this->descricaocustoveiculo = $rs_res->fields[3] ;  
            $this->valorcustoveiculo = $rs_res->fields[4] ;  
            $this->valorcustoveiculo =  str_replace(",", ".", $this->valorcustoveiculo);
            $this->datacustoveiculo = substr($this->datacustoveiculo, 0, 7);
            $this->datacustoveiculo_orig = $this->datacustoveiculo;
            $this->idfkveiculocustoveiculo_orig = $this->idfkveiculocustoveiculo;
            $this->valorcustoveiculo_orig = $this->valorcustoveiculo;
            $this->look_idfkveiculocustoveiculo = $this->idfkveiculocustoveiculo; 
            $this->Lookup->lookup_idfkveiculocustoveiculo($this->look_idfkveiculocustoveiculo, $this->idfkveiculocustoveiculo) ; 
            $this->idfkveiculocustoveiculo = $this->look_idfkveiculocustoveiculo ;
            $conteudo_x = $this->datacustoveiculo;
            nm_conv_limpa_dado($conteudo_x, "YYYY-MM");
            if (is_numeric($conteudo_x) && $conteudo_x > 0) 
            { 
                $this->nm_data->SetaData($this->datacustoveiculo, "YYYY-MM");
                $this->datacustoveiculo = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "mmaaaa"));
            } 
            nmgp_Form_Num_Val($this->valorcustoveiculo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valorcustoveiculo, $this->datacustoveiculo, $this->idfkveiculocustoveiculo, $this->valorcustoveiculo, $this->datacustoveiculo_orig,  $this->idfkveiculocustoveiculo_orig,  $this->valorcustoveiculo_orig);
            }
   }
//
