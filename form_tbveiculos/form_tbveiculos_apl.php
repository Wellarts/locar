...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_tbveiculos_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_tbveiculos']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tbveiculos']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tbveiculos'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tbveiculos']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tbveiculos']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_tbveiculos') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tbveiculos']['label'] = "Cadastro de Veículos";
      ...
      $_SESSION['scriptcase']['error_icon']['form_tbveiculos']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_tbveiculos'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbveiculos']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_tbveiculos/form_tbveiculos_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_tbveiculos_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_tbveiculos_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_tbveiculos_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_tbveiculos/form_tbveiculos_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_tbveiculos_erro.class.php"); 
      }
      $this->Erro      = new form_tbveiculos_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opcao']))
         { 
             if ($this->idveiculo != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_tbveiculos']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_redir_atualiz'] == "ok")
          {
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_tbveiculos', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_tbveiculos', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_tbveiculos']) || !is_array($this->NM_ajax_info['errList']['geral_form_tbveiculos']))
              {
                  $this->NM_ajax_info['errList']['geral_form_tbveiculos'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_tbveiculos'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    {
        global $teste_validade;
               if (!empty($this->idfkmarcaveiculo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Lookup_idfkmarcaveiculo']) && !in_array($this->idfkmarcaveiculo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Lookup_idfkmarcaveiculo']))
               {
    ...
    function ValidateField_anoveiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->anoveiculo, 5, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Ano; " ; 
                  if (!isset($Campos_Erros['anoveiculo']))
                  {
    ...
    function ValidateField_valordiaria(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->valordiaria, 8, 2, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_kmatualveiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->kmatualveiculo, 10, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_proxtrocaoleoveiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->proxtrocaoleoveiculo, 10, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_proxtrocafiltroveiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->proxtrocafiltroveiculo, 10, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_avisotrocaoleoveiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->avisotrocaoleoveiculo, 10, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_avisotrocafiltroveiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->avisotrocafiltroveiculo, 10, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_proxtrocacorreiaveiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->proxtrocacorreiaveiculo, 10, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_proxtrocapastilhaveiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->proxtrocapastilhaveiculo, 10, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_avisotrocacorreiaveiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->avisotrocacorreiaveiculo, 10, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_avisotrocapastilhaveiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->avisotrocapastilhaveiculo, 10, 0, 0, 0, "N") == false)  
              { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idveiculo']['keyVal'] = form_tbveiculos_pack_protect_string($this->nmgp_dados_form['idveiculo']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Lookup_idfkmarcaveiculo']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Lookup_idfkmarcaveiculo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Lookup_idfkmarcaveiculo']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Lookup_idfkmarcaveiculo'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY nomeMarca";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_tbveiculos_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_tbveiculos_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Lookup_idfkmarcaveiculo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idfkmarcaveiculo']['valList'][$i] = form_tbveiculos_pack_protect_string($v);
          }
...
$aLookup[] = array(form_tbveiculos_pack_protect_string('1') => form_tbveiculos_pack_protect_string(""));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Lookup_statusveiculo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['statusveiculo']['valList'][$i] = form_tbveiculos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_tbveiculos']['contr_erro'] = 'on';
             /* tbcustosVeiculos */
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_tbveiculos' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_tbveiculos']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->chassiveiculo = $this->chassiveiculo_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['parms'] = "idveiculo?#?$this->idveiculo?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_filter_form'];
      }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_tbveiculos = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['total'] = $qt_geral_reg_form_tbveiculos;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idveiculo))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_tbveiculos = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] > $qt_geral_reg_form_tbveiculos)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] = $qt_geral_reg_form_tbveiculos; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_tbveiculos) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start']) ;  
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] < $qt_geral_reg_form_tbveiculos;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opcao']   = '';
          }
      } 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_tbveiculos_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_tbveiculos_pack_ajax_response();
      ...
      $Nm_datas['datacompraveiculo'] = "date";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_tbveiculos_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_tbveiculos_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['masterValue'] as $cmp_master => $val_master)
{
?>
