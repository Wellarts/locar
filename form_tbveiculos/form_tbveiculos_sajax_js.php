  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbveiculos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idveiculo
  function do_ajax_form_tbveiculos_validate_idveiculo()
  {
    var nomeCampo_idveiculo = "idveiculo";
    var var_idveiculo = scAjaxGetFieldHidden(nomeCampo_idveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_idveiculo(var_idveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_idveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_idveiculo

  function do_ajax_form_tbveiculos_validate_idveiculo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_idveiculo_cb

  // ---------- Validate idfkmarcaveiculo
  function do_ajax_form_tbveiculos_validate_idfkmarcaveiculo()
  {
    var nomeCampo_idfkmarcaveiculo = "idfkmarcaveiculo";
    var var_idfkmarcaveiculo = scAjaxGetFieldSelect(nomeCampo_idfkmarcaveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_idfkmarcaveiculo(var_idfkmarcaveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_idfkmarcaveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_idfkmarcaveiculo

  function do_ajax_form_tbveiculos_validate_idfkmarcaveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_idfkmarcaveiculo_cb

  // ---------- Validate modeloveiculo
  function do_ajax_form_tbveiculos_validate_modeloveiculo()
  {
    var nomeCampo_modeloveiculo = "modeloveiculo";
    var var_modeloveiculo = scAjaxGetFieldText(nomeCampo_modeloveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_modeloveiculo(var_modeloveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_modeloveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_modeloveiculo

  function do_ajax_form_tbveiculos_validate_modeloveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_modeloveiculo_cb

  // ---------- Validate anoveiculo
  function do_ajax_form_tbveiculos_validate_anoveiculo()
  {
    var nomeCampo_anoveiculo = "anoveiculo";
    var var_anoveiculo = scAjaxGetFieldText(nomeCampo_anoveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_anoveiculo(var_anoveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_anoveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_anoveiculo

  function do_ajax_form_tbveiculos_validate_anoveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_anoveiculo_cb

  // ---------- Validate placaveiculo
  function do_ajax_form_tbveiculos_validate_placaveiculo()
  {
    var nomeCampo_placaveiculo = "placaveiculo";
    var var_placaveiculo = scAjaxGetFieldText(nomeCampo_placaveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_placaveiculo(var_placaveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_placaveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_placaveiculo

  function do_ajax_form_tbveiculos_validate_placaveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_placaveiculo_cb

  // ---------- Validate corveiculo
  function do_ajax_form_tbveiculos_validate_corveiculo()
  {
    var nomeCampo_corveiculo = "corveiculo";
    var var_corveiculo = scAjaxGetFieldText(nomeCampo_corveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_corveiculo(var_corveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_corveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_corveiculo

  function do_ajax_form_tbveiculos_validate_corveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_corveiculo_cb

  // ---------- Validate valordiaria
  function do_ajax_form_tbveiculos_validate_valordiaria()
  {
    var nomeCampo_valordiaria = "valordiaria";
    var var_valordiaria = scAjaxGetFieldText(nomeCampo_valordiaria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_valordiaria(var_valordiaria, var_script_case_init, do_ajax_form_tbveiculos_validate_valordiaria_cb);
  } // do_ajax_form_tbveiculos_validate_valordiaria

  function do_ajax_form_tbveiculos_validate_valordiaria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_valordiaria_cb

  // ---------- Validate datacompraveiculo
  function do_ajax_form_tbveiculos_validate_datacompraveiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_datacompraveiculo(var_datacompraveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_datacompraveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_datacompraveiculo

  function do_ajax_form_tbveiculos_validate_datacompraveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_datacompraveiculo_cb

  // ---------- Validate kmatualveiculo
  function do_ajax_form_tbveiculos_validate_kmatualveiculo()
  {
    var nomeCampo_kmatualveiculo = "kmatualveiculo";
    var var_kmatualveiculo = scAjaxGetFieldText(nomeCampo_kmatualveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_kmatualveiculo(var_kmatualveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_kmatualveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_kmatualveiculo

  function do_ajax_form_tbveiculos_validate_kmatualveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_kmatualveiculo_cb

  // ---------- Validate chassiveiculo
  function do_ajax_form_tbveiculos_validate_chassiveiculo()
  {
    var nomeCampo_chassiveiculo = "chassiveiculo";
    var var_chassiveiculo = scAjaxGetFieldText(nomeCampo_chassiveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_chassiveiculo(var_chassiveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_chassiveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_chassiveiculo

  function do_ajax_form_tbveiculos_validate_chassiveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_chassiveiculo_cb

  // ---------- Validate proxtrocaoleoveiculo
  function do_ajax_form_tbveiculos_validate_proxtrocaoleoveiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_proxtrocaoleoveiculo(var_proxtrocaoleoveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_proxtrocaoleoveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_proxtrocaoleoveiculo

  function do_ajax_form_tbveiculos_validate_proxtrocaoleoveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_proxtrocaoleoveiculo_cb

  // ---------- Validate proxtrocafiltroveiculo
  function do_ajax_form_tbveiculos_validate_proxtrocafiltroveiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_proxtrocafiltroveiculo(var_proxtrocafiltroveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_proxtrocafiltroveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_proxtrocafiltroveiculo

  function do_ajax_form_tbveiculos_validate_proxtrocafiltroveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_proxtrocafiltroveiculo_cb

  // ---------- Validate avisotrocaoleoveiculo
  function do_ajax_form_tbveiculos_validate_avisotrocaoleoveiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_avisotrocaoleoveiculo(var_avisotrocaoleoveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_avisotrocaoleoveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_avisotrocaoleoveiculo

  function do_ajax_form_tbveiculos_validate_avisotrocaoleoveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_avisotrocaoleoveiculo_cb

  // ---------- Validate avisotrocafiltroveiculo
  function do_ajax_form_tbveiculos_validate_avisotrocafiltroveiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_avisotrocafiltroveiculo(var_avisotrocafiltroveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_avisotrocafiltroveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_avisotrocafiltroveiculo

  function do_ajax_form_tbveiculos_validate_avisotrocafiltroveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_avisotrocafiltroveiculo_cb

  // ---------- Validate proxtrocacorreiaveiculo
  function do_ajax_form_tbveiculos_validate_proxtrocacorreiaveiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_proxtrocacorreiaveiculo(var_proxtrocacorreiaveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_proxtrocacorreiaveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_proxtrocacorreiaveiculo

  function do_ajax_form_tbveiculos_validate_proxtrocacorreiaveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_proxtrocacorreiaveiculo_cb

  // ---------- Validate proxtrocapastilhaveiculo
  function do_ajax_form_tbveiculos_validate_proxtrocapastilhaveiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_proxtrocapastilhaveiculo(var_proxtrocapastilhaveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_proxtrocapastilhaveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_proxtrocapastilhaveiculo

  function do_ajax_form_tbveiculos_validate_proxtrocapastilhaveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_proxtrocapastilhaveiculo_cb

  // ---------- Validate avisotrocacorreiaveiculo
  function do_ajax_form_tbveiculos_validate_avisotrocacorreiaveiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_avisotrocacorreiaveiculo(var_avisotrocacorreiaveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_avisotrocacorreiaveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_avisotrocacorreiaveiculo

  function do_ajax_form_tbveiculos_validate_avisotrocacorreiaveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_avisotrocacorreiaveiculo_cb

  // ---------- Validate avisotrocapastilhaveiculo
  function do_ajax_form_tbveiculos_validate_avisotrocapastilhaveiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_avisotrocapastilhaveiculo(var_avisotrocapastilhaveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_avisotrocapastilhaveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_avisotrocapastilhaveiculo

  function do_ajax_form_tbveiculos_validate_avisotrocapastilhaveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_avisotrocapastilhaveiculo_cb

  // ---------- Validate statusveiculo
  function do_ajax_form_tbveiculos_validate_statusveiculo()
  {
    var nomeCampo_statusveiculo = "statusveiculo";
    var var_statusveiculo = scAjaxGetFieldCheckbox(nomeCampo_statusveiculo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbveiculos_validate_statusveiculo(var_statusveiculo, var_script_case_init, do_ajax_form_tbveiculos_validate_statusveiculo_cb);
  } // do_ajax_form_tbveiculos_validate_statusveiculo

  function do_ajax_form_tbveiculos_validate_statusveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbveiculos_validate_statusveiculo_cb
  // ---------- Form
  function do_ajax_form_tbveiculos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbveiculos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
  ...
  } // do_ajax_form_tbveiculos_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbveiculos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbveiculos_navigate_form(var_idveiculo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbveiculos_navigate_form_cb);
  } // do_ajax_form_tbveiculos_navigate_form

  function do_ajax_form_tbveiculos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_tbveiculos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbveiculos_navigate_form_cb
  function sc_hide_form_tbveiculos_form()
  {
