...
class app_grid_sec_users_pesq
{
    ...
    * @access  public
    */
   function app_grid_sec_users_pesq()
   {
   }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['login'])) ? $this->New_label['login'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_login'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<INPUT  type="text" id="SC_login" name="login" value="<?php echo NM_encode_input($login) ?>" size=23 alt="{datatype: 'text', maxLength: 23, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['name'])) ? $this->New_label['name'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_name'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<INPUT  type="text" id="SC_name" name="name" value="<?php echo NM_encode_input($name) ?>" size=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['email'])) ? $this->New_label['email'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_email'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<INPUT  type="text" id="SC_email" name="email" value="<?php echo NM_encode_input($email) ?>" size=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['active'])) ? $this->New_label['active'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_active'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<INPUT  type="text" id="SC_active" name="active" value="<?php echo NM_encode_input($active) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['priv_admin'])) ? $this->New_label['priv_admin'] : "" . $this->Ini->Nm_lang['lang_sec_users_fild_priv_admin'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "LocarVeiculos/app_grid_sec_users";
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_pesq_ant'] = $this->comando . $this->comando_fim;
