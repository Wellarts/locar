...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_priv_access"  <?php echo $str_hide_priv_access?>><INPUT  type="text" id="SC_priv_access" name="priv_access" value="<?php echo NM_encode_input($priv_access) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_priv_insert"  <?php echo $str_hide_priv_insert?>><INPUT  type="text" id="SC_priv_insert" name="priv_insert" value="<?php echo NM_encode_input($priv_insert) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_priv_delete"  <?php echo $str_hide_priv_delete?>><INPUT  type="text" id="SC_priv_delete" name="priv_delete" value="<?php echo NM_encode_input($priv_delete) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_priv_update"  <?php echo $str_hide_priv_update?>><INPUT  type="text" id="SC_priv_update" name="priv_update" value="<?php echo NM_encode_input($priv_update) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_priv_export"  <?php echo $str_hide_priv_export?>><INPUT  type="text" id="SC_priv_export" name="priv_export" value="<?php echo NM_encode_input($priv_export) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
