...
<?php
include_once("form_tbcontasPagar_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbcontasPagar_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['recarga'];
}
?>
...
<?php
 include_once("form_tbcontasPagar_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="form_tbcontasPagar_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbcontasPagar_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbcontasPagar_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_idcontaspagar_line" id="hidden_field_data_idcontaspagar" style="<?php echo $sStyleHidden_idcontaspagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcontaspagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idcontaspagar_label"><span id="id_label_idcontaspagar"><?php echo $this->nm_new_label['idcontaspagar']; ?></span></span><br><span id="id_read_on_idcontaspagar" class="css_idcontaspagar_line" style="<?php echo $sStyleReadLab_idcontaspagar; ?>"><?php echo $this->form_encode_input($this->idcontaspagar); ?></span><span id="id_read_off_idcontaspagar" style="<?php echo $sStyleReadInp_idcontaspagar; ?>"><input type="hidden" name="idcontaspagar" value="<?php echo $this->form_encode_input($idcontaspagar) . "\">"?><span id="id_ajax_label_idcontaspagar"><?php echo nl2br($idcontaspagar); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idfkcredorcontaspagar_line" id="hidden_field_data_idfkcredorcontaspagar" style="<?php echo $sStyleHidden_idfkcredorcontaspagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idfkcredorcontaspagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idfkcredorcontaspagar_label"><span id="id_label_idfkcredorcontaspagar"><?php echo $this->nm_new_label['idfkcredorcontaspagar']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qtdparcelascontaspagar_line" id="hidden_field_data_qtdparcelascontaspagar" style="<?php echo $sStyleHidden_qtdparcelascontaspagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qtdparcelascontaspagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qtdparcelascontaspagar_label"><span id="id_label_qtdparcelascontaspagar"><?php echo $this->nm_new_label['qtdparcelascontaspagar']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_datavencimentocontaspagar_line" id="hidden_field_data_datavencimentocontaspagar" style="<?php echo $sStyleHidden_datavencimentocontaspagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datavencimentocontaspagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_datavencimentocontaspagar_label"><span id="id_label_datavencimentocontaspagar"><?php echo $this->nm_new_label['datavencimentocontaspagar']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_diasaviso_line" id="hidden_field_data_diasaviso" style="<?php echo $sStyleHidden_diasaviso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_diasaviso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_diasaviso_label"><span id="id_label_diasaviso"><?php echo $this->nm_new_label['diasaviso']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valorcontaspagar_line" id="hidden_field_data_valorcontaspagar" style="<?php echo $sStyleHidden_valorcontaspagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valorcontaspagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valorcontaspagar_label"><span id="id_label_valorcontaspagar"><?php echo $this->nm_new_label['valorcontaspagar']; ?></span></span><br>
...
<?php $sStyleHidden_valorcontaspagar_dumb = ('' == $sStyleHidden_valorcontaspagar) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_valorcontaspagar_dumb" style="<?php echo $sStyleHidden_valorcontaspagar_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ordemparcelacontaspagar_line" id="hidden_field_data_ordemparcelacontaspagar" style="<?php echo $sStyleHidden_ordemparcelacontaspagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ordemparcelacontaspagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ordemparcelacontaspagar_label"><span id="id_label_ordemparcelacontaspagar"><?php echo $this->nm_new_label['ordemparcelacontaspagar']; ?></span></span><br><input type="hidden" name="ordemparcelacontaspagar" value="<?php echo $this->form_encode_input($ordemparcelacontaspagar); ?>"><span id="id_ajax_label_ordemparcelacontaspagar"><?php echo nl2br($ordemparcelacontaspagar); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_datapagamentocontaspagar_line" id="hidden_field_data_datapagamentocontaspagar" style="<?php echo $sStyleHidden_datapagamentocontaspagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datapagamentocontaspagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_datapagamentocontaspagar_label"><span id="id_label_datapagamentocontaspagar"><?php echo $this->nm_new_label['datapagamentocontaspagar']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valorpagocontaspagar_line" id="hidden_field_data_valorpagocontaspagar" style="<?php echo $sStyleHidden_valorpagocontaspagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valorpagocontaspagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valorpagocontaspagar_label"><span id="id_label_valorpagocontaspagar"><?php echo $this->nm_new_label['valorpagocontaspagar']; ?></span></span><br>
...
?> 
    ...
    <TD class="scFormDataOdd css_quitadocontaspagar_line" id="hidden_field_data_quitadocontaspagar" style="<?php echo $sStyleHidden_quitadocontaspagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_quitadocontaspagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_quitadocontaspagar_label"><span id="id_label_quitadocontaspagar"><?php echo $this->nm_new_label['quitadocontaspagar']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['Lookup_quitadocontaspagar'][] = '1'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_obscontaspagar_line" id="hidden_field_data_obscontaspagar" style="<?php echo $sStyleHidden_obscontaspagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_obscontaspagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_obscontaspagar_label"><span id="id_label_obscontaspagar"><?php echo $this->nm_new_label['obscontaspagar']; ?></span></span><br>
<?php
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcontasPagar_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbcontasPagar_mob");
 parent.scAjaxDetailHeight("form_tbcontasPagar_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
