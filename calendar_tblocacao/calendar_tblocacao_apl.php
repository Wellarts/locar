...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_tblocacao_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['calendar_tblocacao']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_tblocacao']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_tblocacao'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_tblocacao']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_tblocacao']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_tblocacao') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_tblocacao']['label'] = "Locação de Veículo";
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_tblocacao']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_tblocacao'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tblocacao']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'calendar_tblocacao/calendar_tblocacao_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'calendar_tblocacao_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'calendar_tblocacao_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_tblocacao_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'calendar_tblocacao/calendar_tblocacao_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_tblocacao_erro.class.php"); 
      }
      $this->Erro      = new calendar_tblocacao_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tblocacao']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['sc_redir_atualiz'] == "ok")
          {
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'calendar_tblocacao', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'calendar_tblocacao', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_tblocacao']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_tblocacao']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_tblocacao'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_tblocacao'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['bypass_required_time']['horasaidalocacao'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['bypass_required_time']['horaretornolocacao'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['bypass_required_time']['horasaidalocacao'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['bypass_required_time']['horaretornolocacao'] = false;
...
//---
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->idfkclientelocacao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['Lookup_idfkclientelocacao']) && !in_array($this->idfkclientelocacao, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['Lookup_idfkclientelocacao']))
               {
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->idfkveiculolocacao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['Lookup_idfkveiculolocacao']) && !in_array($this->idfkveiculolocacao, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['Lookup_idfkveiculolocacao']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idlocacao']['keyVal'] = calendar_tblocacao_pack_protect_string($this->nmgp_dados_form['idlocacao']);
          }
   } // ajax_return_values
...
ORDER BY nomeCliente";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(calendar_tblocacao_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => calendar_tblocacao_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idfkclientelocacao']['valList'][$i] = calendar_tblocacao_pack_protect_string($v);
          }
...
ORDER BY modeloVeiculo";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idfkveiculolocacao']['valList'][$i] = calendar_tblocacao_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(calendar_tblocacao_pack_protect_string('1') => calendar_tblocacao_pack_protect_string("SIM"));
$aLookup[] = array(calendar_tblocacao_pack_protect_string('0') => calendar_tblocacao_pack_protect_string("NÃO"));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['Lookup_statuslocacao'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['Lookup_statuslocacao'][] = '0';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['statuslocacao']['valList'][$i] = calendar_tblocacao_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_obslocacao($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idlocacao)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opcao'] = '';
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['calendar_tblocacao']['contr_erro'] = 'on';
             /* tbmultasAvarias */
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_calendar_tblocacao' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['calendar_tblocacao']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->obslocacao = $this->obslocacao_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['parms'] = "idlocacao?#?$this->idlocacao?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_filter_form'];
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['dados_select'] = $this->nmgp_dados_select;
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("calendar_tblocacao_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['table_refresh'])
        {
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#calendar').fullCalendar({
      ...
      printUrl: "calendar_tblocacao.php",
      editable: <?php echo ($this->calendarConfigValues['update'] ? 'true' : 'false'); ?>,
      events: 'calendar_tblocacao.php?nmgp_opcao=calendar_fetch',
...
{
?>
        tb_show('', 'calendar_tblocacao.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
{
?>
        tb_show('', 'calendar_tblocacao.php?nmgp_opcao=igual&idlocacao=' + calEvent.id + '&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
<?php
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_calendar_tblocacao = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['total'] = $qt_geral_reg_calendar_tblocacao;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          calendar_tblocacao_pack_ajax_response();
      ...
      $Nm_datas['datasaidalocacao'] = "date";$Nm_datas['horasaidalocacao'] = "time";$Nm_datas['dataretornolocacao'] = "date";$Nm_datas['horaretornolocacao'] = "time";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['sc_outra_jan'])
   {
       $nmgp_saida_form = "calendar_tblocacao_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_tblocacao_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tblocacao']['masterValue']))
{
?>
