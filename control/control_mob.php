...
//
   ...
   $_SESSION['scriptcase']['control_mob']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['control_mob']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['control_mob']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['control_mob']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['control_mob']['glo_nm_path_doc']        = "";
//
...
//
   function init()
   {
      ...
      $this->nm_hr_criacao   = "162001"; 
      $this->nm_autor_alt    = "wellington"; 
      $this->nm_dt_ult_alt   = "20161122"; 
      $this->nm_hr_ult_alt   = "163654"; 
...
// 
      ...
      if ((isset($inicial_control_mob->contr_control_mob->NM_ajax_flag) && $inicial_control_mob->contr_control_mob->NM_ajax_flag) || (isset($_SESSION['sc_session'][$this->sc_page]['control']['embutida_call']) && $_SESSION['sc_session'][$this->sc_page]['control']['embutida_call']) || $NM_run_iframe == 1)
      {
           $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['control_mob']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['control_mob']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['control_mob']['Gera_log_access'] = true;
      } 
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['control_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'LocarVeiculos'); 
      } 
      else 
      { 
...
//
    ...
    {
        if ('ajax_control_mob_validate_veiculo' == $_POST['rs'])
        {
            $veiculo = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_control_mob_validate_datainicio' == $_POST['rs'])
        {
            $datainicio = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_control_mob_validate_datafim' == $_POST['rs'])
        {
            $datafim = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_control_mob_validate_custos' == $_POST['rs'])
        {
            $custos = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_control_mob_validate_aluguel' == $_POST['rs'])
        {
            $aluguel = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_control_mob_validate_lucro' == $_POST['rs'])
        {
            $lucro = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_control_mob_event_datafim_onchange' == $_POST['rs'])
        {
            $veiculo = NM_utf8_urldecode($_POST['rsargs'][0]);
            $datainicio = NM_utf8_urldecode($_POST['rsargs'][1]);
            $datafim = NM_utf8_urldecode($_POST['rsargs'][2]);
            $lucro = NM_utf8_urldecode($_POST['rsargs'][3]);
            $aluguel = NM_utf8_urldecode($_POST['rsargs'][4]);
            $custos = NM_utf8_urldecode($_POST['rsargs'][5]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][6]);
        }
        if ('ajax_control_mob_event_datainicio_onchange' == $_POST['rs'])
        {
            $veiculo = NM_utf8_urldecode($_POST['rsargs'][0]);
            $datainicio = NM_utf8_urldecode($_POST['rsargs'][1]);
            $datafim = NM_utf8_urldecode($_POST['rsargs'][2]);
        ...
        if ('ajax_control_mob_event_veiculo_onchange' == $_POST['rs'])
        {
            $veiculo = NM_utf8_urldecode($_POST['rsargs'][0]);
            $datainicio = NM_utf8_urldecode($_POST['rsargs'][1]);
            $datafim = NM_utf8_urldecode($_POST['rsargs'][2]);
        ...
        if ('ajax_control_mob_submit_form' == $_POST['rs'])
        {
            ...
            $datainicio = NM_utf8_urldecode($_POST['rsargs'][1]);
            $datafim = NM_utf8_urldecode($_POST['rsargs'][2]);
            $custos = NM_utf8_urldecode($_POST['rsargs'][3]);
            $aluguel = NM_utf8_urldecode($_POST['rsargs'][4]);
            $lucro = NM_utf8_urldecode($_POST['rsargs'][5]);
    ...
    else
    {
        ...
        elseif ($_SESSION['sc_session'][$script_case_init]['control_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['control_mob']['run_iframe'] != "R")
        {
           ...
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            ...
            if ($_SESSION['sc_session'][$script_case_init]['control_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['control_mob']['run_iframe'] != "R" && (!isset($_SESSION['sc_session'][$script_case_init]['control']['embutida_call']) || !$_SESSION['sc_session'][$script_case_init]['control']['embutida_call']))
            { 
...
<?php
    ...
    $inicial_control_mob->contr_control_mob->NM_ajax_info['select_html'] = array();
    $inicial_control_mob->contr_control_mob->NM_ajax_info['select_html']['veiculo'] = "class=\"sc-js-input scFormObjectOdd css_veiculo_obj\" style=\"\" id=\"id_sc_field_veiculo\" name=\"veiculo\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_control_mob_validate_veiculo");
    sajax_export("ajax_control_mob_validate_datainicio");
    sajax_export("ajax_control_mob_validate_datafim");
    sajax_export("ajax_control_mob_validate_custos");
    sajax_export("ajax_control_mob_validate_aluguel");
    sajax_export("ajax_control_mob_validate_lucro");
    sajax_export("ajax_control_mob_event_datafim_onchange");
    sajax_export("ajax_control_mob_event_datainicio_onchange");
    sajax_export("ajax_control_mob_event_veiculo_onchange");
...
//
    ...
    function ajax_control_mob_validate_veiculo($veiculo, $script_case_init)
    {
        ...
        $inicial_control_mob->contr_control_mob->controle();
        exit;
    } // ajax_validate_veiculo

    function ajax_control_mob_validate_datainicio($datainicio, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_datainicio';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'datainicio' => NM_utf8_urldecode($datainicio),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_control_mob->contr_control_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_control_mob->contr_control_mob->controle();
        exit;
    } // ajax_validate_datainicio

    function ajax_control_mob_validate_datafim($datafim, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_datafim';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'datafim' => NM_utf8_urldecode($datafim),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_control_mob->contr_control_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_control_mob->contr_control_mob->controle();
        exit;
    } // ajax_validate_datafim

    function ajax_control_mob_validate_custos($custos, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_custos';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'custos' => NM_utf8_urldecode($custos),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_control_mob->contr_control_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_control_mob->contr_control_mob->controle();
        exit;
    } // ajax_validate_custos

    function ajax_control_mob_validate_aluguel($aluguel, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_aluguel';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'aluguel' => NM_utf8_urldecode($aluguel),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_control_mob->contr_control_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_control_mob->contr_control_mob->controle();
        exit;
    } // ajax_validate_aluguel

    function ajax_control_mob_validate_lucro($lucro, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_lucro';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'lucro' => NM_utf8_urldecode($lucro),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_control_mob->contr_control_mob->NM_ajax_info['param']['buffer_output'])
    ...
    function ajax_control_mob_event_datafim_onchange($veiculo, $datainicio, $datafim, $lucro, $aluguel, $custos, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'event_datafim_onchange';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'veiculo' => NM_utf8_urldecode($veiculo),
                  'datainicio' => NM_utf8_urldecode($datainicio),
                  'datafim' => NM_utf8_urldecode($datafim),
        ...
        $inicial_control_mob->contr_control_mob->controle();
        exit;
    } // ajax_event_datafim_onchange

    function ajax_control_mob_event_datainicio_onchange($veiculo, $datainicio, $datafim, $lucro, $aluguel, $custos, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'event_datainicio_onchange';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'veiculo' => NM_utf8_urldecode($veiculo),
                  'datainicio' => NM_utf8_urldecode($datainicio),
                  'datafim' => NM_utf8_urldecode($datafim),
        ...
        $inicial_control_mob->contr_control_mob->controle();
        exit;
    } // ajax_event_datainicio_onchange

    function ajax_control_mob_event_veiculo_onchange($veiculo, $datainicio, $datafim, $lucro, $aluguel, $custos, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'event_veiculo_onchange';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'veiculo' => NM_utf8_urldecode($veiculo),
                  'datainicio' => NM_utf8_urldecode($datainicio),
                  'datafim' => NM_utf8_urldecode($datafim),
        ...
        $inicial_control_mob->contr_control_mob->controle();
        exit;
    } // ajax_event_veiculo_onchange

    function ajax_control_mob_submit_form($veiculo, $datainicio, $datafim, $custos, $aluguel, $lucro, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
