...
class grid_tbveiculos_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbveiculos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbveiculos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbveiculos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_modeloveiculo')
      {
          $modeloveiculo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_modeloveiculo($modeloveiculo);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_modeloveiculo($modeloveiculo)
   {
      $modeloveiculo = substr($this->Db->qstr($modeloveiculo), 1, -1);
            $modeloveiculo_look = substr($this->Db->qstr($modeloveiculo), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "select modeloVeiculo, concat(modeloVeiculo,\" - \" , placaVeiculo) from tbveiculos where  concat(modeloVeiculo,\" - \" , placaVeiculo) like '%" . $modeloveiculo . "%' order by modeloVeiculo, placaVeiculo" ; 
      } 
      else 
      { 
          $nm_comando = "select modeloVeiculo, modeloVeiculo||\" - \"||placaVeiculo from tbveiculos where  modeloVeiculo||\" - \"||placaVeiculo like '%" . $modeloveiculo . "%' order by modeloVeiculo, placaVeiculo" ; 
      } 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbveiculos/grid_tbveiculos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbveiculos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbveiculos_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_modeloveiculo_cond#NMF#' + search_get_sel_txt('SC_modeloveiculo_cond') + '@NMF@';
  str_out += 'SC_modeloveiculo#NMF#' + search_get_text('SC_modeloveiculo') + '@NMF@';
  str_out += 'id_ac_modeloveiculo#NMF#' + search_get_text('id_ac_modeloveiculo') + '@NMF@';
  str_out += 'SC_statusveiculo_cond#NMF#' + search_get_sel_txt('SC_statusveiculo_cond') + '@NMF@';
  str_out += 'SC_statusveiculo#NMF#' + search_get_radio('SC_statusveiculo') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_modeloveiculo").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_modeloveiculo",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_modeloveiculo").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_modeloveiculo").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Consulta de Veículos</span></td>
...
<?php
   ...
   {
      global 
             $modeloveiculo_cond, $modeloveiculo, $modeloveiculo_autocomp,
             $statusveiculo_cond, $statusveiculo,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $modeloveiculo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']['modeloveiculo']; 
          $modeloveiculo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']['modeloveiculo_cond']; 
          $statusveiculo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']['statusveiculo']; 
          $statusveiculo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']['statusveiculo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']['NM_operador']; 
      } 
      if (!isset($modeloveiculo_cond) || empty($modeloveiculo_cond))
      {
         $modeloveiculo_cond = "eq";
      }
      if (!isset($statusveiculo_cond) || empty($statusveiculo_cond))
      {
         $statusveiculo_cond = "eq";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_modeloveiculo = (in_array($modeloveiculo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_statusveiculo = (in_array($statusveiculo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($modeloveiculo) || $modeloveiculo == "")
      {
          $modeloveiculo = "";
      }
      if (isset($modeloveiculo) && !empty($modeloveiculo))
      {
         $tmp_pos = strpos($modeloveiculo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $modeloveiculo = substr($modeloveiculo, 0, $tmp_pos);
         }
      }
      if (!isset($statusveiculo) || $statusveiculo == "")
      {
          $statusveiculo = "";
      }
      if (isset($statusveiculo) && !empty($statusveiculo))
      {
         $tmp_pos = strpos($statusveiculo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $statusveiculo = substr($statusveiculo, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_tbveiculos_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd css_modeloveiculo_fil_label"><?php echo (isset($this->New_label['modeloveiculo'])) ? $this->New_label['modeloveiculo'] : "Modelo"; ?></TD>
      
      <INPUT type="hidden" id="SC_modeloveiculo_cond" name="modeloveiculo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_modeloveiculo" <?php echo $str_hide_modeloveiculo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['modeloveiculo'])) ? $this->New_label['modeloveiculo'] : "Modelo";
 $nmgp_tab_label .= "modeloveiculo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $modeloveiculo_look = substr($this->Db->qstr($modeloveiculo), 1, -1); 
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "select modeloVeiculo, concat(modeloVeiculo,\" - \" , placaVeiculo) from tbveiculos where modeloVeiculo = '$modeloveiculo_look' order by modeloVeiculo, placaVeiculo" ; 
      } 
      else 
      { 
          $nm_comando = "select modeloVeiculo, modeloVeiculo||\" - \"||placaVeiculo from tbveiculos where modeloVeiculo = '$modeloveiculo_look' order by modeloVeiculo, placaVeiculo" ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$modeloveiculo]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$modeloveiculo];
      }
      else
      {
          $sAutocompValue = $modeloveiculo;
      }
?>
<INPUT  type="text" id="SC_modeloveiculo" name="modeloveiculo" value="<?php echo NM_encode_input($modeloveiculo) ?>" size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_modeloveiculo" name="modeloveiculo_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven css_statusveiculo_fil_label"><?php echo (isset($this->New_label['statusveiculo'])) ? $this->New_label['statusveiculo'] : "Status"; ?></TD>
      
      <INPUT type="hidden" id="SC_statusveiculo_cond" name="statusveiculo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_statusveiculo" <?php echo $str_hide_statusveiculo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['statusveiculo'])) ? $this->New_label['statusveiculo'] : "Status";
 $nmgp_tab_label .= "statusveiculo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  if (!isset($statusveiculo)) {$statusveiculo = $statusveiculo;}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['psq_check_ret']['statusveiculo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['psq_check_ret']['statusveiculo'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['psq_check_ret']['statusveiculo'][] = "0";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><input class="scFilterObjectEven" type=radio id="SC_statusveiculo" name="statusveiculo" value="1##@@SIM"  <?php if ("1" == $statusveiculo)  { echo " checked" ;} ?><?php  if (empty($statusveiculo)) { echo " checked" ;} ?>>SIM</TD>
</TR>
<TR>
  <TD class="scFilterFieldFontEven"><input class="scFilterObjectEven" type=radio id="SC_statusveiculo" name="statusveiculo" value="0##@@NÃO"  <?php if ("0" == $statusveiculo)  { echo " checked" ;} ?>>NÃO</TD>
</TR></TABLE>
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbveiculos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbveiculos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_modeloveiculo'), document.F1.modeloveiculo_cond, 'modeloveiculo');
   document.F1.modeloveiculo.value = "";
   document.F1.modeloveiculo_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_statusveiculo'), document.F1.statusveiculo_cond, 'statusveiculo');
   for (i = 0; i < document.F1.statusveiculo.length; i++)
   {
      if (document.F1.statusveiculo[i].checked)
      {
          document.F1.statusveiculo[i].checked = false;
      }
   }
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "LocarVeiculos/grid_tbveiculos";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_modeloveiculo_cond'] = 'cond';
      $tp_fields['SC_modeloveiculo'] = 'text_aut';
      $tp_fields['id_ac_modeloveiculo'] = 'text_aut';
      $tp_fields['SC_statusveiculo_cond'] = 'cond';
      $tp_fields['SC_statusveiculo'] = 'radio';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $modeloveiculo_cond, $modeloveiculo, $modeloveiculo_autocomp,
             $statusveiculo_cond, $statusveiculo, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($modeloveiculo_autocomp) && empty($modeloveiculo))
      {
          $modeloveiculo = $modeloveiculo_autocomp;
      }
      $modeloveiculo_cond_salva = $modeloveiculo_cond; 
      if (!isset($modeloveiculo_input_2) || $modeloveiculo_input_2 == "")
      {
          $modeloveiculo_input_2 = $modeloveiculo;
      }
      $statusveiculo_cond_salva = $statusveiculo_cond; 
      if (!isset($statusveiculo_input_2) || $statusveiculo_input_2 == "")
      {
          $statusveiculo_input_2 = $statusveiculo;
      }
      $tmp_pos = strpos($statusveiculo, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $statusveiculo;
      }
      else {
          $L_lookup = substr($statusveiculo, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['psq_check_ret']['statusveiculo'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']['modeloveiculo'] = $modeloveiculo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']['modeloveiculo_cond'] = $modeloveiculo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']['statusveiculo'] = $statusveiculo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']['statusveiculo_cond'] = $statusveiculo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['modeloveiculo'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['modeloveiculo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['modeloveiculo'] = $modeloveiculo;
      }
      $this->cmp_formatado['statusveiculo'] = $statusveiculo;
      if (strpos($this->cmp_formatado['statusveiculo'], "##@@") !== false)
      {
          $this->cmp_formatado['statusveiculo'] = substr($this->cmp_formatado['statusveiculo'], strpos($this->cmp_formatado['statusveiculo'], "##@@") + 4);
      }
      $this->cmp_formatado['statusveiculo_input_2'] = $statusveiculo_input_2;

      //----- $modeloveiculo
      $this->Date_part = false;
      if (isset($modeloveiculo) || $modeloveiculo_cond == "nu" || $modeloveiculo_cond == "nn" || $modeloveiculo_cond == "ep" || $modeloveiculo_cond == "ne")
      {
         $this->monta_condicao("modeloVeiculo", $modeloveiculo_cond, $modeloveiculo, "", "modeloveiculo");
      }

      //----- $statusveiculo
      $this->Date_part = false;
      $statusveiculo = $statusveiculo; 
      if (isset($statusveiculo))
      {
         $this->monta_condicao("statusVeiculo", $statusveiculo_cond, $statusveiculo, "", "statusveiculo");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbveiculos']['where_pesq_ant'] = $this->comando . $this->comando_fim;
