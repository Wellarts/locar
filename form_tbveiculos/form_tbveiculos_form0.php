...
<?php
include_once("form_tbveiculos_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbveiculos_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['recarga'];
}
?>
...
<?php
 include_once("form_tbveiculos_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbveiculos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbveiculos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idveiculo_label" id="hidden_field_label_idveiculo" style="<?php echo $sStyleHidden_idveiculo; ?>"><span id="id_label_idveiculo"><?php echo $this->nm_new_label['idveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_idveiculo_line" id="hidden_field_data_idveiculo" style="<?php echo $sStyleHidden_idveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idveiculo_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_idveiculo" class="css_idveiculo_line" style="<?php echo $sStyleReadLab_idveiculo; ?>"><?php echo $this->form_encode_input($this->idveiculo); ?></span><span id="id_read_off_idveiculo" style="<?php echo $sStyleReadInp_idveiculo; ?>"><input type="hidden" name="idveiculo" value="<?php echo $this->form_encode_input($idveiculo) . "\">"?><span id="id_ajax_label_idveiculo"><?php echo nl2br($idveiculo); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idfkmarcaveiculo_label" id="hidden_field_label_idfkmarcaveiculo" style="<?php echo $sStyleHidden_idfkmarcaveiculo; ?>"><span id="id_label_idfkmarcaveiculo"><?php echo $this->nm_new_label['idfkmarcaveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_idfkmarcaveiculo_line" id="hidden_field_data_idfkmarcaveiculo" style="<?php echo $sStyleHidden_idfkmarcaveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idfkmarcaveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_modeloveiculo_label" id="hidden_field_label_modeloveiculo" style="<?php echo $sStyleHidden_modeloveiculo; ?>"><span id="id_label_modeloveiculo"><?php echo $this->nm_new_label['modeloveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_modeloveiculo_line" id="hidden_field_data_modeloveiculo" style="<?php echo $sStyleHidden_modeloveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_modeloveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_anoveiculo_label" id="hidden_field_label_anoveiculo" style="<?php echo $sStyleHidden_anoveiculo; ?>"><span id="id_label_anoveiculo"><?php echo $this->nm_new_label['anoveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_anoveiculo_line" id="hidden_field_data_anoveiculo" style="<?php echo $sStyleHidden_anoveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anoveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_placaveiculo_label" id="hidden_field_label_placaveiculo" style="<?php echo $sStyleHidden_placaveiculo; ?>"><span id="id_label_placaveiculo"><?php echo $this->nm_new_label['placaveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_placaveiculo_line" id="hidden_field_data_placaveiculo" style="<?php echo $sStyleHidden_placaveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_placaveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_corveiculo_label" id="hidden_field_label_corveiculo" style="<?php echo $sStyleHidden_corveiculo; ?>"><span id="id_label_corveiculo"><?php echo $this->nm_new_label['corveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_corveiculo_line" id="hidden_field_data_corveiculo" style="<?php echo $sStyleHidden_corveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_corveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_valordiaria_label" id="hidden_field_label_valordiaria" style="<?php echo $sStyleHidden_valordiaria; ?>"><span id="id_label_valordiaria"><?php echo $this->nm_new_label['valordiaria']; ?></span></TD>
    <TD class="scFormDataOdd css_valordiaria_line" id="hidden_field_data_valordiaria" style="<?php echo $sStyleHidden_valordiaria; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valordiaria_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_datacompraveiculo_label" id="hidden_field_label_datacompraveiculo" style="<?php echo $sStyleHidden_datacompraveiculo; ?>"><span id="id_label_datacompraveiculo"><?php echo $this->nm_new_label['datacompraveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_datacompraveiculo_line" id="hidden_field_data_datacompraveiculo" style="<?php echo $sStyleHidden_datacompraveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datacompraveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_kmatualveiculo_label" id="hidden_field_label_kmatualveiculo" style="<?php echo $sStyleHidden_kmatualveiculo; ?>"><span id="id_label_kmatualveiculo"><?php echo $this->nm_new_label['kmatualveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_kmatualveiculo_line" id="hidden_field_data_kmatualveiculo" style="<?php echo $sStyleHidden_kmatualveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kmatualveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_chassiveiculo_label" id="hidden_field_label_chassiveiculo" style="<?php echo $sStyleHidden_chassiveiculo; ?>"><span id="id_label_chassiveiculo"><?php echo $this->nm_new_label['chassiveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_chassiveiculo_line" id="hidden_field_data_chassiveiculo" style="<?php echo $sStyleHidden_chassiveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_chassiveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_proxtrocaoleoveiculo_label" id="hidden_field_label_proxtrocaoleoveiculo" style="<?php echo $sStyleHidden_proxtrocaoleoveiculo; ?>"><span id="id_label_proxtrocaoleoveiculo"><?php echo $this->nm_new_label['proxtrocaoleoveiculo']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_proxtrocafiltroveiculo_label" id="hidden_field_label_proxtrocafiltroveiculo" style="<?php echo $sStyleHidden_proxtrocafiltroveiculo; ?>"><span id="id_label_proxtrocafiltroveiculo"><?php echo $this->nm_new_label['proxtrocafiltroveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_proxtrocafiltroveiculo_line" id="hidden_field_data_proxtrocafiltroveiculo" style="<?php echo $sStyleHidden_proxtrocafiltroveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_proxtrocafiltroveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_avisotrocaoleoveiculo_label" id="hidden_field_label_avisotrocaoleoveiculo" style="<?php echo $sStyleHidden_avisotrocaoleoveiculo; ?>"><span id="id_label_avisotrocaoleoveiculo"><?php echo $this->nm_new_label['avisotrocaoleoveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_avisotrocaoleoveiculo_line" id="hidden_field_data_avisotrocaoleoveiculo" style="<?php echo $sStyleHidden_avisotrocaoleoveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_avisotrocaoleoveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_avisotrocafiltroveiculo_label" id="hidden_field_label_avisotrocafiltroveiculo" style="<?php echo $sStyleHidden_avisotrocafiltroveiculo; ?>"><span id="id_label_avisotrocafiltroveiculo"><?php echo $this->nm_new_label['avisotrocafiltroveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_avisotrocafiltroveiculo_line" id="hidden_field_data_avisotrocafiltroveiculo" style="<?php echo $sStyleHidden_avisotrocafiltroveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_avisotrocafiltroveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_proxtrocacorreiaveiculo_label" id="hidden_field_label_proxtrocacorreiaveiculo" style="<?php echo $sStyleHidden_proxtrocacorreiaveiculo; ?>"><span id="id_label_proxtrocacorreiaveiculo"><?php echo $this->nm_new_label['proxtrocacorreiaveiculo']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_proxtrocapastilhaveiculo_label" id="hidden_field_label_proxtrocapastilhaveiculo" style="<?php echo $sStyleHidden_proxtrocapastilhaveiculo; ?>"><span id="id_label_proxtrocapastilhaveiculo"><?php echo $this->nm_new_label['proxtrocapastilhaveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_proxtrocapastilhaveiculo_line" id="hidden_field_data_proxtrocapastilhaveiculo" style="<?php echo $sStyleHidden_proxtrocapastilhaveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_proxtrocapastilhaveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_avisotrocacorreiaveiculo_label" id="hidden_field_label_avisotrocacorreiaveiculo" style="<?php echo $sStyleHidden_avisotrocacorreiaveiculo; ?>"><span id="id_label_avisotrocacorreiaveiculo"><?php echo $this->nm_new_label['avisotrocacorreiaveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_avisotrocacorreiaveiculo_line" id="hidden_field_data_avisotrocacorreiaveiculo" style="<?php echo $sStyleHidden_avisotrocacorreiaveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_avisotrocacorreiaveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_avisotrocapastilhaveiculo_label" id="hidden_field_label_avisotrocapastilhaveiculo" style="<?php echo $sStyleHidden_avisotrocapastilhaveiculo; ?>"><span id="id_label_avisotrocapastilhaveiculo"><?php echo $this->nm_new_label['avisotrocapastilhaveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_avisotrocapastilhaveiculo_line" id="hidden_field_data_avisotrocapastilhaveiculo" style="<?php echo $sStyleHidden_avisotrocapastilhaveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_avisotrocapastilhaveiculo_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_statusveiculo_label" id="hidden_field_label_statusveiculo" style="<?php echo $sStyleHidden_statusveiculo; ?>"><span id="id_label_statusveiculo"><?php echo $this->nm_new_label['statusveiculo']; ?></span></TD>
    <TD class="scFormDataOdd css_statusveiculo_line" id="hidden_field_data_statusveiculo" style="<?php echo $sStyleHidden_statusveiculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_statusveiculo_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['Lookup_statusveiculo'][] = '1'; ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbveiculos']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbveiculos");
 parent.scAjaxDetailHeight("form_tbveiculos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
