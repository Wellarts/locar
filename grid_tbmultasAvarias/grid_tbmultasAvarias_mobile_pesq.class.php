...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "datamultaavarias";$Nm_numeric[] = "idmultasavarias";$Nm_numeric[] = "idfklocacao";$Nm_numeric[] = "valormultasavarias";$Nm_numeric[] = "pagomultasavarias";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_idmultasavarias"  <?php echo $str_hide_idmultasavarias?>><?php
      $idmultasavarias_look = substr($this->Db->qstr($idmultasavarias), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idmultasavarias" name="idmultasavarias_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_idmultasavarias"  <?php echo $str_display_idmultasavarias; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idmultasavarias_input_2" name="idmultasavarias_input_2" value="<?php echo NM_encode_input($idmultasavarias_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_idfklocacao"  <?php echo $str_hide_idfklocacao?>><?php
      $idfklocacao_look = substr($this->Db->qstr($idfklocacao), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_idfklocacao" name="idfklocacao_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_idfklocacao"  <?php echo $str_display_idfklocacao; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idfklocacao_input_2" name="idfklocacao_input_2" value="<?php echo NM_encode_input($idfklocacao_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_datamultaavarias"  <?php echo $str_hide_datamultaavarias?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_datamultaavarias"  <?php echo $str_display_datamultaavarias; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?> 
         <BR>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_descricaomultasavarias"  <?php echo $str_hide_descricaomultasavarias?>><?php
      $descricaomultasavarias_look = substr($this->Db->qstr($descricaomultasavarias), 1, -1); 
      $nmgp_def_dados = array(); 
