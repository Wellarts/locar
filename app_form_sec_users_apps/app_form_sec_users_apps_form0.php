<?php
class app_form_sec_users_apps_form extends app_form_sec_users_apps_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_list_apps_x_users'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_list_apps_x_users'] . ""); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>app_form_sec_users_apps/app_form_sec_users_apps_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("app_form_sec_users_apps_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('app_form_sec_users_apps_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['recarga'];
}
...
<?php
 include_once("app_form_sec_users_apps_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['app_form_sec_users_apps'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['app_form_sec_users_apps'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<TR align="center">
 <TD colspan="3">
     <table  style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%" cellpadding="0" cellspacing="0">
       <tr valign="middle">
         <td align="left" ><span class="scFormHeaderFont"> <?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_list_apps_x_users'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_list_apps_x_users'] . ""; } ?> </span></td>
         <td style="font-size: 5px">&nbsp; &nbsp; </td>
         <td align="center" ><span class="scFormHeaderFont"> <?php echo "" . $_SESSION['login'] . "" ?> </span></td>
         <td style="font-size: 5px">&nbsp; &nbsp; </td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php 
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['fast_search'][2] : "";
?> 
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['app_name_']) && $this->nmgp_cmp_hidden['app_name_'] == 'off') { $sStyleHidden_app_name_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['app_name_'])) {
          $this->nm_new_label['app_name_'] = "App Name"; } ?>

    <TD class="scFormLabelOddMult css_app_name__label" id="hidden_field_label_app_name_" style="<?php echo $sStyleHidden_app_name_; ?>" > <?php echo $this->nm_new_label['app_name_'] ?> <span class="scFormRequiredOddMult">*</span> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_access_']) && $this->nmgp_cmp_hidden['priv_access_'] == 'off') { $sStyleHidden_priv_access_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['priv_access_'])) {
          $this->nm_new_label['priv_access_'] = "Priv Access"; } ?>

    <TD class="scFormLabelOddMult css_priv_access__label" id="hidden_field_label_priv_access_" style="<?php echo $sStyleHidden_priv_access_; ?>" > <?php echo $this->nm_new_label['priv_access_'] ?><br /><input type="checkbox" id="sc-ui-checkbox-priv_access_-control" /> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_insert_']) && $this->nmgp_cmp_hidden['priv_insert_'] == 'off') { $sStyleHidden_priv_insert_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['priv_insert_'])) {
          $this->nm_new_label['priv_insert_'] = "Priv Insert"; } ?>

    <TD class="scFormLabelOddMult css_priv_insert__label" id="hidden_field_label_priv_insert_" style="<?php echo $sStyleHidden_priv_insert_; ?>" > <?php echo $this->nm_new_label['priv_insert_'] ?><br /><input type="checkbox" id="sc-ui-checkbox-priv_insert_-control" /> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_delete_']) && $this->nmgp_cmp_hidden['priv_delete_'] == 'off') { $sStyleHidden_priv_delete_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['priv_delete_'])) {
          $this->nm_new_label['priv_delete_'] = "Priv Delete"; } ?>

    <TD class="scFormLabelOddMult css_priv_delete__label" id="hidden_field_label_priv_delete_" style="<?php echo $sStyleHidden_priv_delete_; ?>" > <?php echo $this->nm_new_label['priv_delete_'] ?><br /><input type="checkbox" id="sc-ui-checkbox-priv_delete_-control" /> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_update_']) && $this->nmgp_cmp_hidden['priv_update_'] == 'off') { $sStyleHidden_priv_update_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['priv_update_'])) {
          $this->nm_new_label['priv_update_'] = "Priv Update"; } ?>

    <TD class="scFormLabelOddMult css_priv_update__label" id="hidden_field_label_priv_update_" style="<?php echo $sStyleHidden_priv_update_; ?>" > <?php echo $this->nm_new_label['priv_update_'] ?><br /><input type="checkbox" id="sc-ui-checkbox-priv_update_-control" /> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_export_']) && $this->nmgp_cmp_hidden['priv_export_'] == 'off') { $sStyleHidden_priv_export_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['priv_export_'])) {
          $this->nm_new_label['priv_export_'] = "Priv Export"; } ?>

    <TD class="scFormLabelOddMult css_priv_export__label" id="hidden_field_label_priv_export_" style="<?php echo $sStyleHidden_priv_export_; ?>" > <?php echo $this->nm_new_label['priv_export_'] ?><br /><input type="checkbox" id="sc-ui-checkbox-priv_export_-control" /> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_print_']) && $this->nmgp_cmp_hidden['priv_print_'] == 'off') { $sStyleHidden_priv_print_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['priv_print_'])) {
          $this->nm_new_label['priv_print_'] = "Priv Print"; } ?>

    <TD class="scFormLabelOddMult css_priv_print__label" id="hidden_field_label_priv_print_" style="<?php echo $sStyleHidden_priv_print_; ?>" > <?php echo $this->nm_new_label['priv_print_'] ?><br /><input type="checkbox" id="sc-ui-checkbox-priv_print_-control" /> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_app_form_sec_users_apps);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_app_form_sec_users_apps = $this->form_vert_app_form_sec_users_apps;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_app_form_sec_users_apps))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_app_form_sec_users_apps as $sc_seq_vert => $sc_lixo)
   {
       $this->login_ = $this->form_vert_app_form_sec_users_apps[$sc_seq_vert]['login_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->app_name_ = $this->form_vert_app_form_sec_users_apps[$sc_seq_vert]['app_name_']; 
       ...
       $this->priv_access_ = $this->form_vert_app_form_sec_users_apps[$sc_seq_vert]['priv_access_']; 
       ...
       $this->priv_insert_ = $this->form_vert_app_form_sec_users_apps[$sc_seq_vert]['priv_insert_']; 
       ...
       $this->priv_delete_ = $this->form_vert_app_form_sec_users_apps[$sc_seq_vert]['priv_delete_']; 
       ...
       $this->priv_update_ = $this->form_vert_app_form_sec_users_apps[$sc_seq_vert]['priv_update_']; 
       ...
       $this->priv_export_ = $this->form_vert_app_form_sec_users_apps[$sc_seq_vert]['priv_export_']; 
       ...
       $this->priv_print_ = $this->form_vert_app_form_sec_users_apps[$sc_seq_vert]['priv_print_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_app_form_sec_users_apps_add_new_line(" . $sc_seq_vert . ")", "do_ajax_app_form_sec_users_apps_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_app_form_sec_users_apps_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_app_form_sec_users_apps_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_app_form_sec_users_apps_cancel_update(" . $sc_seq_vert . ")", "do_ajax_app_form_sec_users_apps_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['Lookup_priv_access_'][] = 'Y'; ?>
...
$priv_insert__look = "";
 if ($this->priv_insert_ == "Y") { $priv_insert__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "" ;} 
 if (empty($priv_insert__look)) { $priv_insert__look = $this->priv_insert_; }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['Lookup_priv_insert_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['Lookup_priv_delete_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['Lookup_priv_update_'][] = 'Y'; ?>
...
$priv_export__look = "";
 if ($this->priv_export_ == "Y") { $priv_export__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "" ;} 
 if (empty($priv_export__look)) { $priv_export__look = $this->priv_export_; }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['Lookup_priv_export_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['Lookup_priv_print_'][] = 'Y'; ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_app_form_sec_users_apps = $guarda_form_vert_app_form_sec_users_apps;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("app_form_sec_users_apps");
 parent.scAjaxDetailHeight("app_form_sec_users_apps", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
