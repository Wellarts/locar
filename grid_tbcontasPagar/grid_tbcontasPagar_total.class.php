...
class grid_tbcontasPagar_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //----- 
   function grid_tbcontasPagar_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("pt_br");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_tbcontasPagar']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_tbcontasPagar']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $idfkcredorcontaspagar;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['tot_geral'] = array() ;  
      $nm_comando = "select count(*), sum(valorContasPagar) as sum_valorcontaspagar, sum(valorPagoContasPagar) as sum_valorpagocontaspagar from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['tot_geral'][3] = $rt->fields[2]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcontasPagar']['contr_total_geral'] = "OK";
   } 
