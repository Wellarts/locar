  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbcredores" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idcredor
  function do_ajax_form_tbcredores_validate_idcredor()
  {
    var nomeCampo_idcredor = "idcredor";
    var var_idcredor = scAjaxGetFieldHidden(nomeCampo_idcredor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbcredores_validate_idcredor(var_idcredor, var_script_case_init, do_ajax_form_tbcredores_validate_idcredor_cb);
  } // do_ajax_form_tbcredores_validate_idcredor

  function do_ajax_form_tbcredores_validate_idcredor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbcredores_validate_idcredor_cb

  // ---------- Validate nomecredor
  function do_ajax_form_tbcredores_validate_nomecredor()
  {
    var nomeCampo_nomecredor = "nomecredor";
    var var_nomecredor = scAjaxGetFieldText(nomeCampo_nomecredor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbcredores_validate_nomecredor(var_nomecredor, var_script_case_init, do_ajax_form_tbcredores_validate_nomecredor_cb);
  } // do_ajax_form_tbcredores_validate_nomecredor

  function do_ajax_form_tbcredores_validate_nomecredor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbcredores_validate_nomecredor_cb
  // ---------- Form
  function do_ajax_form_tbcredores_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbcredores_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbcredores_submit_form(var_idcredor, var_nomecredor, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbcredores_submit_form_cb);
  } // do_ajax_form_tbcredores_submit_form

  function do_ajax_form_tbcredores_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbcredores_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbcredores_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbcredores_navigate_form(var_idcredor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbcredores_navigate_form_cb);
  } // do_ajax_form_tbcredores_navigate_form

  function do_ajax_form_tbcredores_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_tbcredores_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbcredores_navigate_form_cb
  function sc_hide_form_tbcredores_form()
  {
