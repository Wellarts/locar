...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - "); } else { echo strip_tags("Locar@Veículos"); } ?></TITLE>
...
<?php
$str_iframe_body = 'margin-top: 350px;';
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<TR align="center">
 <TD colspan="3">
     <table  style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%" cellpadding="0" cellspacing="0">
       <tr valign="middle">
         <td align="left" ><span class="scFormHeaderFont"> <?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - "; } else { echo "Locar@Veículos"; } ?> </span></td>
...
<input type="hidden" name="links" value = "">
 ...
 <a href="javascript:nm_menu_link_links('app_retrieve_pswd')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_subject_mail'] ?></a>
<br>
<?php  } ?>
 </TD>
   <?php }?>
...
<table style="border-collapse: collapse; border-width: 0px">
 ...
 ?>
<img id="id_captcha_img" src="app_Login_mob_captcha_show.php?sid=<?php echo md5(uniqid(time())); ?>" /></td>
